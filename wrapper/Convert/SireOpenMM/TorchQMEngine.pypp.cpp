...
void register_TorchQMEngine_class()
{
    ...
    { //::SireOpenMM::TorchQMEngine
        typedef bp::class_<SireOpenMM::TorchQMEngine, bp::bases<SireOpenMM::QMEngine, SireBase::Property>> TorchQMEngine_exposer_t;
        ...
        { //::SireOpenMM::TorchQMEngine::getModulePath
            ...
            TorchQMEngine_exposer.def(
                "getModulePath", getModulePath_function_value, bp::release_gil_policy(), "Get the path to the serialised TorchScript module.\n");
        }
        ...
        { //::SireOpenMM::TorchQMEngine::setModulePath
            ...
            TorchQMEngine_exposer.def(
                "setModulePath", setModulePath_function_value, (bp::arg("module_path")), bp::release_gil_policy(), "Set the path to the serialised TorchScript module.\n");
        }
        { //::SireOpenMM::TorchQMEngine::setAtoms
            ...
            TorchQMEngine_exposer.def(
                "setAtoms", setAtoms_function_value, (bp::arg("atoms")), bp::release_gil_policy(), "Set the list of atom indices for the QM region.\nPar:am atoms\nA vector of atom indices for the QM region.\n");
        }
        { //::SireOpenMM::TorchQMEngine::setCharges
            ...
            TorchQMEngine_exposer.def(
                "setCharges", setCharges_function_value, (bp::arg("charges")), bp::release_gil_policy(), "Set the atomic charges of all atoms in the system.\nPar:am charges\nA vector of atomic charges for all atoms in the system.\n");
        }
        { //::SireOpenMM::TorchQMEngine::setCutoff
            ...
            TorchQMEngine_exposer.def(
                "setCutoff", setCutoff_function_value, (bp::arg("cutoff")), bp::release_gil_policy(), "Set the QM cutoff distance.\nPar:am cutoff\nThe QM cutoff distance.\n");
        }
        { //::SireOpenMM::TorchQMEngine::setIsMechanical
            ...
            TorchQMEngine_exposer.def(
                "setIsMechanical", setIsMechanical_function_value, (bp::arg("is_mechanical")), bp::release_gil_policy(), "Set the mechanical embedding flag.\nPar:am is_mechanical\nA flag to indicate if mechanical embedding is being used.\n");
        }
        ...
        { //::SireOpenMM::TorchQMEngine::setLinkAtoms
            ...
            TorchQMEngine_exposer.def(
                "setLinkAtoms", setLinkAtoms_function_value, (bp::arg("mm1_to_qm"), bp::arg("mm1_to_mm2"), bp::arg("bond_scale_factors")), bp::release_gil_policy(), "Set the link atoms associated with each QM atom.\nPar:am mm1_to_qm\nA dictionary mapping link atom (MM1) indices to the QM atoms to\nwhich they are bonded.\n\nPar:am mm1_to_mm2\nA dictionary of link atoms indices (MM1) to a list of the MM\natoms to which they are bonded (MM2).\n\nPar:am bond_scale_factors\nA dictionary of link atom indices (MM1) to a list of the bond\nlength scale factors between the QM and MM1 atoms. The scale\nfactors are the ratio of the equilibrium bond lengths for the\nQM-L (QM-link) atom and QM-MM1 atom, i.e. R0(QM-L)  R0(QM-MM1),\ntaken from the MM force field parameters for the molecule.\n\n");
        }
        { //::SireOpenMM::TorchQMEngine::setNeighbourListFrequency
            ...
            TorchQMEngine_exposer.def(
                "setNeighbourListFrequency", setNeighbourListFrequency_function_value, (bp::arg("neighbour_list_frequency")), bp::release_gil_policy(), "Set the neighbour list frequency.\nPar:am neighbour_list_frequency\nThe neighbour list frequency.\n");
        }
        { //::SireOpenMM::TorchQMEngine::setNumbers
            ...
            TorchQMEngine_exposer.def(
                "setNumbers", setNumbers_function_value, (bp::arg("numbers")), bp::release_gil_policy(), "Set the atomic numbers for the atoms in the QM region.\nPar:am numbers\nA vector of atomic numbers for the atoms in the QM region.\n");
        }
        { //::SireOpenMM::TorchQMEngine::getSwitchWidth

            typedef double (::SireOpenMM::TorchQMEngine::*getSwitchWidth_function_type)() const;
            getSwitchWidth_function_type getSwitchWidth_function_value(&::SireOpenMM::TorchQMEngine::getSwitchWidth);

            TorchQMEngine_exposer.def(
                "getSwitchWidth", getSwitchWidth_function_value, bp::release_gil_policy(), "Get the switch width as a fraction of the cutoff.\n");
        }
        { //::SireOpenMM::TorchQMEngine::setSwitchWidth

            typedef void (::SireOpenMM::TorchQMEngine::*setSwitchWidth_function_type)(double);
            setSwitchWidth_function_type setSwitchWidth_function_value(&::SireOpenMM::TorchQMEngine::setSwitchWidth);

            TorchQMEngine_exposer.def(
                "setSwitchWidth", setSwitchWidth_function_value, (bp::arg("switch_width")), bp::release_gil_policy(), "Set the switch width as a fraction of the cutoff (0 to 1).\n");
        }
        { //::SireOpenMM::TorchQMEngine::getUseSwitch

            typedef bool (::SireOpenMM::TorchQMEngine::*getUseSwitch_function_type)() const;
            getUseSwitch_function_type getUseSwitch_function_value(&::SireOpenMM::TorchQMEngine::getUseSwitch);

            TorchQMEngine_exposer.def(
                "getUseSwitch", getUseSwitch_function_value, bp::release_gil_policy(), "Get whether a switching function is used.\n");
        }
        { //::SireOpenMM::TorchQMEngine::setUseSwitch

            typedef void (::SireOpenMM::TorchQMEngine::*setUseSwitch_function_type)(bool);
            setUseSwitch_function_type setUseSwitch_function_value(&::SireOpenMM::TorchQMEngine::setUseSwitch);

            TorchQMEngine_exposer.def(
                "setUseSwitch", setUseSwitch_function_value, (bp::arg("use_switch")), bp::release_gil_policy(), "Set whether to use a switching function.\n");
        }

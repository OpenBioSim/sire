...
void register_QMEngine_class()
{
    ...
    { //::SireOpenMM::QMEngine
        typedef bp::class_<SireOpenMM::QMEngine, bp::bases<SireBase::Property>, boost::noncopyable> QMEngine_exposer_t;
        ...
        { //::SireOpenMM::QMEngine::null
            ...
            QMEngine_exposer.def(
                "null", null_function_value, bp::return_value_policy<bp::copy_const_reference>(), "Get a null QM engine.");
        }

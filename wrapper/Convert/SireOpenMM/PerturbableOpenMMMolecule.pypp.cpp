...
void register_PerturbableOpenMMMolecule_class()
{
    ...
    { //::SireOpenMM::PerturbableOpenMMMolecule
        typedef bp::class_<SireOpenMM::PerturbableOpenMMMolecule, bp::bases<SireBase::Property>> PerturbableOpenMMMolecule_exposer_t;
        ...
        { //::SireOpenMM::PerturbableOpenMMMolecule::angles
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "angles", angles_function_value, bp::release_gil_policy(), "Return the angles which are perturbed, in the order they are\n  set in this perturbation\n");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::atoms
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "atoms", atoms_function_value, bp::release_gil_policy(), "Return the atoms which are perturbed, in the order they are\n  set in this perturbation\n");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::bonds
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "bonds", bonds_function_value, bp::release_gil_policy(), "Return the bonds which are perturbed, in the order they are\n  set in this perturbation\n");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getAlphas0
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getAlphas0", getAlphas0_function_value, bp::release_gil_policy(), "Return the alpha parameters of the reference state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getAlphas1
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getAlphas1", getAlphas1_function_value, bp::release_gil_policy(), "Return the alpha parameters of the perturbed state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getAngleKs0
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getAngleKs0", getAngleKs0_function_value, bp::release_gil_policy(), "Return the angle k parameters of the reference state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getAngleKs1
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getAngleKs1", getAngleKs1_function_value, bp::release_gil_policy(), "Return the angle k parameters of the perturbed state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getAngleSizes0
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getAngleSizes0", getAngleSizes0_function_value, bp::release_gil_policy(), "Return the angle size parameters of the reference state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getAngleSizes1
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getAngleSizes1", getAngleSizes1_function_value, bp::release_gil_policy(), "Return the angle size parameters of the perturbed state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getBondKs0
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getBondKs0", getBondKs0_function_value, bp::release_gil_policy(), "Return the bond k parameters of the reference state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getBondKs1
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getBondKs1", getBondKs1_function_value, bp::release_gil_policy(), "Return the bond k parameters of the perturbed state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getBondLengths0
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getBondLengths0", getBondLengths0_function_value, bp::release_gil_policy(), "Return the bond length parameters of the reference state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getBondLengths1
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getBondLengths1", getBondLengths1_function_value, bp::release_gil_policy(), "Return the bond length parameters of the perturbed state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getChargeScales0
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getChargeScales0", getChargeScales0_function_value, bp::release_gil_policy(), "Return the coulomb intramolecular scale factors of the reference state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getChargeScales1
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getChargeScales1", getChargeScales1_function_value, bp::release_gil_policy(), "Return the coulomb intramolecular scale factors of the perturbed state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getCharges0
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getCharges0", getCharges0_function_value, bp::release_gil_policy(), "Return the atom charges of the reference state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getCharges1
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getCharges1", getCharges1_function_value, bp::release_gil_policy(), "Return the atom charges of the perturbed state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getConstraintIndicies
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getConstraintIndicies", getConstraintIndicies_function_value, bp::release_gil_policy(), "Return the indicies of the perturbable constraints");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getEpsilons0
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getEpsilons0", getEpsilons0_function_value, bp::release_gil_policy(), "Return the LJ epsilon parameters of the reference state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getEpsilons1
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getEpsilons1", getEpsilons1_function_value, bp::release_gil_policy(), "Return the LJ epsilon parameters of the perturbed state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getExceptionAtoms
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getExceptionAtoms", getExceptionAtoms_function_value, bp::release_gil_policy(), "Return the indices of the atoms in the exceptions");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getExceptionIndicies
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getExceptionIndicies", getExceptionIndicies_function_value, (bp::arg("name")), bp::release_gil_policy(), "Return the global indexes of the exceptions in the non-bonded and\n  ghost-14 forces\n");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getFromGhostIdxs
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getFromGhostIdxs", getFromGhostIdxs_function_value, bp::release_gil_policy(), "Return the indexes of the atoms that were ghosts in the\n  reference state\n");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getKappas0
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getKappas0", getKappas0_function_value, bp::release_gil_policy(), "Return the kappa parameters of the reference state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getKappas1
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getKappas1", getKappas1_function_value, bp::release_gil_policy(), "Return the kappa parameters of the perturbed state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getLJScales0
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getLJScales0", getLJScales0_function_value, bp::release_gil_policy(), "Return the LJ intramolecular scale factors of the reference state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getLJScales1
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getLJScales1", getLJScales1_function_value, bp::release_gil_policy(), "Return the LJ intramolecular scale factors of the perturbed state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getPerturbableConstraints
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getPerturbableConstraints", getPerturbableConstraints_function_value, bp::release_gil_policy(), "Return three arrays containing the constraint indexes, and the\n  reference and perturbed values of the constraint lengths\n");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getPerturbableConstraintsWithAtoms
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getPerturbableConstraintsWithAtoms", getPerturbableConstraintsWithAtoms_function_value, bp::release_gil_policy(), "Return the atom indexes of all of the constraints, with\n  the constraint lengths at the two end states, in the order\n  they appear in this molecule\n");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getSigmas0
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getSigmas0", getSigmas0_function_value, bp::release_gil_policy(), "Return the LJ sigma parameters of the reference state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getSigmas1
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getSigmas1", getSigmas1_function_value, bp::release_gil_policy(), "Return the LJ sigma parameters of the perturbed state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getToGhostIdxs
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getToGhostIdxs", getToGhostIdxs_function_value, bp::release_gil_policy(), "Return the indexes of the atoms that are to be ghosted in the\n  perturbed state\n");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getTorsionKs0
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getTorsionKs0", getTorsionKs0_function_value, bp::release_gil_policy(), "Return the torsion k parameters of the reference state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getTorsionKs1
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getTorsionKs1", getTorsionKs1_function_value, bp::release_gil_policy(), "Return the torsion k parameters of the perturbed state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getTorsionPeriodicities0
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getTorsionPeriodicities0", getTorsionPeriodicities0_function_value, bp::release_gil_policy(), "Return the torsion periodicity parameters of the reference state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getTorsionPeriodicities1
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getTorsionPeriodicities1", getTorsionPeriodicities1_function_value, bp::release_gil_policy(), "Return the torsion periodicity parameters of the perturbed state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getTorsionPhases0
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getTorsionPhases0", getTorsionPhases0_function_value, bp::release_gil_policy(), "Return the torsion phase parameters of the reference state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getTorsionPhases1
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getTorsionPhases1", getTorsionPhases1_function_value, bp::release_gil_policy(), "Return the torsion phase parameters of the perturbed state");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::getCMAPGrids0
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getCMAPGrids0", getCMAPGrids0_function_value, bp::return_value_policy<bp::copy_const_reference>(), "Return the flat concatenated CMAP grid values (column-major, kJ/mol) "
        ...
        { //::SireOpenMM::PerturbableOpenMMMolecule::getCMAPGrids1
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getCMAPGrids1", getCMAPGrids1_function_value, bp::return_value_policy<bp::copy_const_reference>(), "Return the flat concatenated CMAP grid values (column-major, kJ/mol) "
        ...
        { //::SireOpenMM::PerturbableOpenMMMolecule::getCMAPGridSizes
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "getCMAPGridSizes", getCMAPGridSizes_function_value, bp::return_value_policy<bp::copy_const_reference>(), "Return the grid dimension N for each CMAP torsion (grid is N x N). "
        ...
        { //::SireOpenMM::PerturbableOpenMMMolecule::getCMAPAtoms
            ...
            typedef ::QVector<boost::tuples::tuple<int, int, int, int, int,
                                                   ...
                                                   boost::tuples::null_type, boost::tuples::null_type>> (::SireOpenMM::PerturbableOpenMMMolecule::*getCMAPAtoms_function_type)() const;
            getCMAPAtoms_function_type getCMAPAtoms_function_value(&::SireOpenMM::PerturbableOpenMMMolecule::getCMAPAtoms);

            PerturbableOpenMMMolecule_exposer.def(
                "getCMAPAtoms", getCMAPAtoms_function_value, bp::release_gil_policy(), "Return the molecule-local 5-atom indices for each CMAP torsion, "
        ...
        { //::SireOpenMM::PerturbableOpenMMMolecule::isGhostAtom
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "isGhostAtom", isGhostAtom_function_value, (bp::arg("atom")), bp::release_gil_policy(), "Return true if the atom is a ghost atom in the\n  referenece or perturbed states");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::isNull
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "isNull", isNull_function_value, bp::release_gil_policy(), "Return whether or not this is null");
        }
        ...
        { //::SireOpenMM::PerturbableOpenMMMolecule::setConstraintIndicies
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "setConstraintIndicies", setConstraintIndicies_function_value, (bp::arg("constraint_idxs")), bp::release_gil_policy(), "Set the indexes of perturbable constraints in the System");
        }
        { //::SireOpenMM::PerturbableOpenMMMolecule::setExceptionIndicies
            ...
            PerturbableOpenMMMolecule_exposer.def(
                "setExceptionIndicies", setExceptionIndicies_function_value, (bp::arg("name"), bp::arg("exception_idxs")), bp::release_gil_policy(), "Set the global indexes of the exceptions in the non-bonded and\n  ghost-14 forces\n");
        }

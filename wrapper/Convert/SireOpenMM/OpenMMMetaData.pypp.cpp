    ...
    { //::SireOpenMM::OpenMMMetaData
        ...
        { //::SireOpenMM::OpenMMMetaData::boxVectors
            ...
            OpenMMMetaData_exposer.def(
                "boxVectors", boxVectors_function_value, bp::return_value_policy<bp::copy_const_reference>(), "");
        }
        { //::SireOpenMM::OpenMMMetaData::coordinates
            ...
            OpenMMMetaData_exposer.def(
                "coordinates", coordinates_function_value, bp::return_value_policy<bp::copy_const_reference>(), "");
        }
        { //::SireOpenMM::OpenMMMetaData::hasBoxVectors
            ...
            OpenMMMetaData_exposer.def(
                "hasBoxVectors", hasBoxVectors_function_value, bp::release_gil_policy(), "");
        }
        { //::SireOpenMM::OpenMMMetaData::hasCoordinates
            ...
            OpenMMMetaData_exposer.def(
                "hasCoordinates", hasCoordinates_function_value, bp::release_gil_policy(), "");
        }
        { //::SireOpenMM::OpenMMMetaData::hasVelocities
            ...
            OpenMMMetaData_exposer.def(
                "hasVelocities", hasVelocities_function_value, bp::release_gil_policy(), "");
        }
        { //::SireOpenMM::OpenMMMetaData::index
            ...
            OpenMMMetaData_exposer.def(
                "index", index_function_value, bp::release_gil_policy(), "");
        }
        { //::SireOpenMM::OpenMMMetaData::lambdaLever
            ...
            OpenMMMetaData_exposer.def(
                "lambdaLever", lambdaLever_function_value, bp::release_gil_policy(), "");
        }
        ...
        { //::SireOpenMM::OpenMMMetaData::velocities
            ...
            OpenMMMetaData_exposer.def(
                "velocities", velocities_function_value, bp::return_value_policy<bp::copy_const_reference>(), "");
        }

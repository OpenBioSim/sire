...
namespace SireOpenMM
{
    ...
    SelectorM<Atom> extract_coordinates(const OpenMM::State &state,
                                        const SireMol::SelectorM<Atom> &atoms,
    ...
    SelectorM<Atom> extract_coordinates_and_velocities(const OpenMM::State &state,
                                                       const SireMol::SelectorM<Atom> &atoms,
                                                       const QHash<SireMol::MolNum, SireBase::PropertyMap> &perturbable_maps,
                                                       const SireBase::PropertyMap &map)
    {

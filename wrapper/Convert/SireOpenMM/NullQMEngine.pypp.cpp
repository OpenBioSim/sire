...
void register_NullQMEngine_class()
{
    ...
    { //::SireOpenMM::NullQMEngine
        typedef bp::class_<SireOpenMM::NullQMEngine, bp::bases<SireOpenMM::QMEngine, SireBase::Property>, boost::noncopyable> NullQMEngine_exposer_t;
        ...
        { //::SireOpenMM::NullQMEngine::typeName
            ...
            NullQMEngine_exposer.def(
                "typeName", typeName_function_value, bp::release_gil_policy(), "Get the name of the QM engine.");
        }
        { //::SireOpenMM::NullQMEngine::what
            ...
            NullQMEngine_exposer.def(
                "what", what_function_value, bp::release_gil_policy(), "Get the name of the QM engine.");
        }

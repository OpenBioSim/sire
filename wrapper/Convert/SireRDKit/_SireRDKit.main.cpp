...
{
    typedef SireMol::SelectorMol (*rdkit_to_sire_function_type)(QList<RDKit::ROMol> const &, SireBase::PropertyMap const &);
    typedef QList<RDKit::ROMol> (*sire_to_rdkit_function_type)(SireMol::SelectorMol const &, SireBase::PropertyMap const &);

...
void register_Matrix_class()
{
    ...
    { //::SireMaths::Matrix
        ...
        { //::SireMaths::Matrix::at
            ...
            Matrix_exposer.def(
                "at", at_function_value, (bp::arg("i"), bp::arg("j")), bp::release_gil_policy(), "Return the element at index i,j");
        }
        { //::SireMaths::Matrix::checkedOffset
            ...
            Matrix_exposer.def(
                "checkedOffset", checkedOffset_function_value, (bp::arg("i"), bp::arg("j")), bp::release_gil_policy(), "Return the offset into the array of the value at index [i,j]\nThrow: SireError::invalid_index\n");
        }
        { //::SireMaths::Matrix::column0
            ...
            Matrix_exposer.def(
                "column0", column0_function_value, bp::release_gil_policy(), "Return each column");
        }
        { //::SireMaths::Matrix::column1
            ...
            Matrix_exposer.def(
                "column1", column1_function_value, bp::release_gil_policy(), "Return each column");
        }
        { //::SireMaths::Matrix::column2
            ...
            Matrix_exposer.def(
                "column2", column2_function_value, bp::release_gil_policy(), "Return each column");
        }
        { //::SireMaths::Matrix::covariance
            ...
            Matrix_exposer.def(
                "covariance", covariance_function_value, (bp::arg("p"), bp::arg("q"), bp::arg("n") = (int)(-1)), "Return the covariance matrix of the passed arrays of points. This\nmatches point p[i] against point q[i], and only calculates up to either\nthe specified number of points, if n > 0, or to min(len(p),len(q))");
        }
        { //::SireMaths::Matrix::determinant
            ...
            Matrix_exposer.def(
                "determinant", determinant_function_value, bp::release_gil_policy(), "Return the determinant of the matrix");
        }
        { //::SireMaths::Matrix::diagonal
            ...
            Matrix_exposer.def(
                "diagonal", diagonal_function_value, bp::release_gil_policy(), "Return the diagonal of this matrix");
        }
        { //::SireMaths::Matrix::diagonalise
            ...
            Matrix_exposer.def(
                "diagonalise", diagonalise_function_value, bp::release_gil_policy(), "Return the eigenvectors and eigenvalues of this matrix");
        }
        ...
        { //::SireMaths::Matrix::identity
            ...
            Matrix_exposer.def(
                "identity", identity_function_value, bp::release_gil_policy(), "Return the identity matrix");
        }
        { //::SireMaths::Matrix::inverse
            ...
            Matrix_exposer.def(
                "inverse", inverse_function_value, bp::release_gil_policy(), "Return the inverse of this matrix. Throws a math_error if this\nmatrix cannot be inverted.");
        }
        { //::SireMaths::Matrix::isDiagonal
            ...
            Matrix_exposer.def(
                "isDiagonal", isDiagonal_function_value, bp::release_gil_policy(), "Return whether or not this is a diagonal matrix");
        }
        { //::SireMaths::Matrix::isIdentity
            ...
            Matrix_exposer.def(
                "isIdentity", isIdentity_function_value, bp::release_gil_policy(), "Return whether or not this matrix is equal to the identity matrix");
        }
        { //::SireMaths::Matrix::isSymmetric
            ...
            Matrix_exposer.def(
                "isSymmetric", isSymmetric_function_value, bp::release_gil_policy(), "Return whether or not this is a symmetric matrix");
        }
        { //::SireMaths::Matrix::isZero
            ...
            Matrix_exposer.def(
                "isZero", isZero_function_value, bp::release_gil_policy(), "Return whether or not this matrix is all zero");
        }
        { //::SireMaths::Matrix::offset
            ...
            Matrix_exposer.def(
                "offset", offset_function_value, (bp::arg("i"), bp::arg("j")), bp::release_gil_policy(), "");
        }
        ...
        { //::SireMaths::Matrix::operator()
            ...
            Matrix_exposer.def(
                "__call__", __call___function_value, (bp::arg("i"), bp::arg("j")), bp::return_value_policy<bp::copy_const_reference>(), "");
        }
        { //::SireMaths::Matrix::operator=
        ...
        { //::SireMaths::Matrix::row0
            ...
            Matrix_exposer.def(
                "row0", row0_function_value, bp::release_gil_policy(), "Return each row");
        }
        { //::SireMaths::Matrix::row1
            ...
            Matrix_exposer.def(
                "row1", row1_function_value, bp::release_gil_policy(), "Return each row");
        }
        { //::SireMaths::Matrix::row2
            ...
            Matrix_exposer.def(
                "row2", row2_function_value, bp::release_gil_policy(), "Return each row");
        }
        { //::SireMaths::Matrix::setToIdentity
            ...
            Matrix_exposer.def(
                "setToIdentity", setToIdentity_function_value, bp::release_gil_policy(), "Set the matrix to identity");
        }
        { //::SireMaths::Matrix::singleValueDecomposition
            ...
            Matrix_exposer.def(
                "singleValueDecomposition", singleValueDecomposition_function_value, bp::release_gil_policy(), "Return the single value decomposition of this matrix.\nThis calculates the decomposition of this matrix\ninto U S V^T, returning U, S and V in the tuple\n");
        }
        { //::SireMaths::Matrix::svd
            ...
            Matrix_exposer.def(
                "svd", svd_function_value, bp::release_gil_policy(), "Return the single value decomposition of this matrix.\nThis calculates the decomposition of this matrix\ninto U S V^T, returning U, S and V in the tuple\n");
        }
        { //::SireMaths::Matrix::toString
            ...
            Matrix_exposer.def(
                "toString", toString_function_value, bp::release_gil_policy(), "Return a QString representation of the matrix");
        }
        { //::SireMaths::Matrix::trace
            ...
            Matrix_exposer.def(
                "trace", trace_function_value, bp::release_gil_policy(), "Return the trace of the matrix");
        }
        { //::SireMaths::Matrix::transpose
            ...
            Matrix_exposer.def(
                "transpose", transpose_function_value, bp::release_gil_policy(), "Return the transpose of the matrix");
        }
        ...
        { //::SireMaths::Matrix::xx
            ...
            Matrix_exposer.def(
                "xx", xx_function_value, bp::release_gil_policy(), "");
        }
        { //::SireMaths::Matrix::xy
            ...
            Matrix_exposer.def(
                "xy", xy_function_value, bp::release_gil_policy(), "");
        }
        { //::SireMaths::Matrix::xz
            ...
            Matrix_exposer.def(
                "xz", xz_function_value, bp::release_gil_policy(), "");
        }
        { //::SireMaths::Matrix::yx
            ...
            Matrix_exposer.def(
                "yx", yx_function_value, bp::release_gil_policy(), "");
        }
        { //::SireMaths::Matrix::yy
            ...
            Matrix_exposer.def(
                "yy", yy_function_value, bp::release_gil_policy(), "");
        }
        { //::SireMaths::Matrix::yz
            ...
            Matrix_exposer.def(
                "yz", yz_function_value, bp::release_gil_policy(), "");
        }
        { //::SireMaths::Matrix::zero
            ...
            Matrix_exposer.def(
                "zero", zero_function_value, bp::release_gil_policy(), "Return the null matrix");
        }
        { //::SireMaths::Matrix::zx
            ...
            Matrix_exposer.def(
                "zx", zx_function_value, bp::release_gil_policy(), "");
        }
        { //::SireMaths::Matrix::zy
            ...
            Matrix_exposer.def(
                "zy", zy_function_value, bp::release_gil_policy(), "");
        }
        { //::SireMaths::Matrix::zz
            ...
            Matrix_exposer.def(
                "zz", zz_function_value, bp::release_gil_policy(), "");
        }

...
void register_Vector_class(){
    ...
    { //::SireMaths::Vector
        ...
        Vector_exposer.def( bp::init< SireUnits::Dimension::Length >(( bp::arg("val") ), "Construct from a single, repeated length") );
        Vector_exposer.def( bp::init< double, double, double >(( bp::arg("xpos"), bp::arg("ypos"), bp::arg("zpos") ), "Construct from lengths") );
        Vector_exposer.def( bp::init< SireUnits::Dimension::Length, SireUnits::Dimension::Length, SireUnits::Dimension::Length >(( bp::arg("xpos"), bp::arg("ypos"), bp::arg("zpos") ), "Construct from lengths") );
        ...
        Vector_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMaths::Vector >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        Vector_exposer.def_pickle(sire_pickle_suite< ::SireMaths::Vector >());

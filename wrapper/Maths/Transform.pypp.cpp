    ...
    { //::SireMaths::Transform
        ...
        { //::SireMaths::Transform::apply
            ...
            Transform_exposer.def(
                "apply", apply_function_value, (bp::arg("point")), bp::release_gil_policy(), "Apply this transformation to the passed point, returning the result");
        }
        { //::SireMaths::Transform::apply
            ...
            Transform_exposer.def(
                "apply", apply_function_value, (bp::arg("points")), bp::release_gil_policy(), "Apply this transformation to all of the passed points, returning the results");
        }
        { //::SireMaths::Transform::inverse
            ...
            Transform_exposer.def(
                "inverse", inverse_function_value, bp::release_gil_policy(), "Return the inverse of this transformation");
        }
        { //::SireMaths::Transform::isNull
            ...
            Transform_exposer.def(
                "isNull", isNull_function_value, bp::release_gil_policy(), "Return whether this is null (has no transformation)");
        }
        { //::SireMaths::Transform::isZero
            ...
            Transform_exposer.def(
                "isZero", isZero_function_value, bp::release_gil_policy(), "Return whether this is zero (has no transformation)");
        }
        ...
        { //::SireMaths::Transform::operator()
            ...
            Transform_exposer.def(
                "__call__", __call___function_value, (bp::arg("point")), "");
        }
        { //::SireMaths::Transform::operator()
        ...
        { //::SireMaths::Transform::reverse
            ...
            Transform_exposer.def(
                "reverse", reverse_function_value, (bp::arg("point")), bp::release_gil_policy(), "Apply the inverse of this transformation to the passed point, returning the result");
        }
        { //::SireMaths::Transform::reverse
            ...
            Transform_exposer.def(
                "reverse", reverse_function_value, (bp::arg("points")), bp::release_gil_policy(), "Apply this transformation to all of the passed points, returning the results");
        }
        { //::SireMaths::Transform::rotationCenter
            ...
            Transform_exposer.def(
                "rotationCenter", rotationCenter_function_value, bp::release_gil_policy(), "Return the center of rotation");
        }
        { //::SireMaths::Transform::rotationMatrix
            ...
            Transform_exposer.def(
                "rotationMatrix", rotationMatrix_function_value, bp::release_gil_policy(), "Return the rotation matrix");
        }
        { //::SireMaths::Transform::rotationQuaternion
            ...
            Transform_exposer.def(
                "rotationQuaternion", rotationQuaternion_function_value, bp::release_gil_policy(), "Return the rotation matrix as a quaternion");
        }
        ...
        { //::SireMaths::Transform::translationDelta
            ...
            Transform_exposer.def(
                "translationDelta", translationDelta_function_value, bp::release_gil_policy(), "Return the amount by which to translate");
        }

...
parser = argparse.ArgumentParser(
    description="Calculate QM/MM to MM correction free "
    ...
    "https://sire.openbiosim.org/waterswap",
    prog="quantomm",
)
...
print(
    "\nRunning a quantomm calculation using files %s and %s."
    % (top_file, coord_file)
)
...
if ligand:
    print(
        "The MM to QM/MM correction free energy of the molecule containing "
        "residue %s will be calculated.\n" % (ligand)
    )

else:
    print(
        "The MM to QM/MM correction free energy of the first non-protein, non-solvent "

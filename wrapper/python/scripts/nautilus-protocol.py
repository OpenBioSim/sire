...
parser = argparse.ArgumentParser(
    description="Nautilus protocol is run with default settings.  Default settings are controlled within the nautilus-protocol.cfg file",
...
if args.version:
    print(
        "nautilus-protocol -- from Sire release version <%s>"
        % Sire.__version__
    )
    print(
...
# clustergrid
cmd = """ %s/bin/nautilus-clustergrids -C %s """ % (
    params["sire"],
    args.config,
)
print(cmd)

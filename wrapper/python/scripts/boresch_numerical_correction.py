...
parser = argparse.ArgumentParser(
    description="An app to calculate the correction for releasing Boresch restraints "
...
if args.version:
    print(
        "boresch_numerical_correction -- from Sire release version <%s>"
        % Sire.__version__
    )
    print(
...
if args.config:
    ...
    if not os.path.exists(config_file):
        ...
        print(
            "Loading temperature and restraints information from file %s"
            % args.config
        )

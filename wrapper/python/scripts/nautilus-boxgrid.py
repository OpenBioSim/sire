...
parser = argparse.ArgumentParser(
    description=" With given center and length of an edge (in Ang) look at grid points of interest "
...
parser.add_argument("-c", "--center", nargs="?", help="")
...
if args.version:
    print(
        "nautilus-boxgrid -- from Sire release version <%s>" % Sire.__version__
    )
    print(

...
parser = argparse.ArgumentParser(
    description="avggrids averages grids in dx format.  Grids must be of identical dimensions and grid density",
...
parser.add_argument("-a", "--avgdx", nargs="?", help="Name of average dx file")
...
if args.version:
    print(
        "nautilus-avggrids -- from Sire release version <%s>"
        % Sire.__version__
    )
    print(

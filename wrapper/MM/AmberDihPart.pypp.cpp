...
SireMM::AmberDihPart __copy__(const SireMM::AmberDihPart &other)
{
    return SireMM::AmberDihPart(other);
}
    ...
    { //::SireMM::AmberDihPart
        ...
        { //::SireMM::AmberDihPart::energy
            ...
            AmberDihPart_exposer.def(
                "energy", energy_function_value, (bp::arg("phi")), bp::release_gil_policy(), "");
        }
        { //::SireMM::AmberDihPart::hash
            ...
            AmberDihPart_exposer.def(
                "hash", hash_function_value, bp::release_gil_policy(), "");
        }
        { //::SireMM::AmberDihPart::k
            ...
            AmberDihPart_exposer.def(
                "k", k_function_value, bp::release_gil_policy(), "");
        }
        ...
        { //::SireMM::AmberDihPart::operator[]
            ...
            AmberDihPart_exposer.def(
                "__getitem__", __getitem___function_value, (bp::arg("i")), "");
        }
        { //::SireMM::AmberDihPart::periodicity
            ...
            AmberDihPart_exposer.def(
                "periodicity", periodicity_function_value, bp::release_gil_policy(), "");
        }
        { //::SireMM::AmberDihPart::phase
            ...
            AmberDihPart_exposer.def(
                "phase", phase_function_value, bp::release_gil_policy(), "");
        }

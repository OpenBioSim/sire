...
void register_CoulombComponent_class(){
    ...
    { //::SireMM::CoulombComponent
        ...
        CoulombComponent_exposer.def( bp::init< SireMM::CoulombComponent const & >(( bp::arg("other") ), "Copy constructor") );
        ...
        CoulombComponent_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMM::CoulombComponent >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        CoulombComponent_exposer.def_pickle(sire_pickle_suite< ::SireMM::CoulombComponent >());
        ...
        CoulombComponent_exposer.def( "__hash__", &::SireMM::CoulombComponent::hash );
    }

...
void register_InterLJFF_class(){
    ...
    { //::SireFF::Inter2B3DFF< SireMM::LJPotentialInterface< SireMM::InterLJPotential > >
        typedef bp::class_< SireFF::Inter2B3DFF< SireMM::LJPotentialInterface< SireMM::InterLJPotential > >, bp::bases< SireFF::FF3D, SireMM::LJPotentialInterface<SireMM::InterLJPotential>, SireFF::G1FF, SireFF::FF, SireMol::MolGroupsBase, SireBase::Property > > InterLJFF_exposer_t;

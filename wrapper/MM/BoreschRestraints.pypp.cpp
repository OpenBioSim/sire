    ...
    { //::SireMM::BoreschRestraints
        ...
        { //::SireMM::BoreschRestraints::add
            ...
            BoreschRestraints_exposer.def(
                "add", add_function_value, (bp::arg("restraint")), bp::release_gil_policy(), "Add a restraint onto the list");
        }
        { //::SireMM::BoreschRestraints::add
            ...
            BoreschRestraints_exposer.def(
                "add", add_function_value, (bp::arg("restraints")), bp::release_gil_policy(), "Add a restraint onto the list");
        }
        { //::SireMM::BoreschRestraints::at
            ...
            BoreschRestraints_exposer.def(
                "at", at_function_value, (bp::arg("i")), bp::return_value_policy<bp::clone_const_reference, bp::release_gil_policy>(), "Return the ith restraint");
        }
        { //::SireMM::BoreschRestraints::count
            ...
            BoreschRestraints_exposer.def(
                "count", count_function_value, bp::release_gil_policy(), "Return the number of restraints");
        }
        { //::SireMM::BoreschRestraints::usesPbc
            ...
            BoreschRestraints_exposer.def(
                "usesPbc", usesPbc_function_value, bp::release_gil_policy(), "Return whether or not periodic boundary conditions are to be used");
        }
        { //::SireMM::BoreschRestraints::anglePotential

            typedef ::QString (::SireMM::BoreschRestraints::*anglePotential_function_type)() const;
            anglePotential_function_type anglePotential_function_value(&::SireMM::BoreschRestraints::anglePotential);
        ...
        { //::SireMM::BoreschRestraints::isEmpty
            ...
            BoreschRestraints_exposer.def(
                "isEmpty", isEmpty_function_value, bp::release_gil_policy(), "Return whether or not this is empty");
        }
        { //::SireMM::BoreschRestraints::isNull
            ...
            BoreschRestraints_exposer.def(
                "isNull", isNull_function_value, bp::release_gil_policy(), "Return whether or not this is empty");
        }
        { //::SireMM::BoreschRestraints::nRestraints
            ...
            BoreschRestraints_exposer.def(
                "nRestraints", nRestraints_function_value, bp::release_gil_policy(), "Return the number of restraints");
        }
        ...
        { //::SireMM::BoreschRestraints::operator[]
            ...
            BoreschRestraints_exposer.def(
                "__getitem__", __getitem___function_value, (bp::arg("i")), bp::return_value_policy<bp::clone_const_reference, bp::release_gil_policy>(), "");
        }
        { //::SireMM::BoreschRestraints::restraints
            ...
            BoreschRestraints_exposer.def(
                "restraints", restraints_function_value, bp::release_gil_policy(), "Return all of the restraints");
        }
        ...
        { //::SireMM::BoreschRestraints::setAnglePotential

            typedef void (::SireMM::BoreschRestraints::*setAnglePotential_function_type)(::QString const &);
            setAnglePotential_function_type setAnglePotential_function_value(&::SireMM::BoreschRestraints::setAnglePotential);
        ...
        { //::SireMM::BoreschRestraints::size
            ...
            BoreschRestraints_exposer.def(
                "size", size_function_value, bp::release_gil_policy(), "Return the number of restraints");
        }

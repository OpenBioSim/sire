...
void register_Select_class(){
    ...
    { //::SireMol::Select
        ...
        Select_exposer.def( "__copy__", &__copy__<SireMol::Select>);
        Select_exposer.def( "__deepcopy__", &__copy__<SireMol::Select>);
        Select_exposer.def( "clone", &__copy__<SireMol::Select>);

...
void register_IDOrSet_ResID__class(){
    ...
    { //::SireID::IDOrSet< SireMol::ResID >
        ...
        IDOrSet_ResID__exposer.def( "__copy__", &__copy__<SireID::IDOrSet<SireMol::ResID>>);
        IDOrSet_ResID__exposer.def( "__deepcopy__", &__copy__<SireID::IDOrSet<SireMol::ResID>>);
        IDOrSet_ResID__exposer.def( "clone", &__copy__<SireID::IDOrSet<SireMol::ResID>>);

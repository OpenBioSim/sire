...
void register_NullBondHunter_class(){
    ...
    { //::SireMol::NullBondHunter
        ...
        NullBondHunter_exposer.def( "__copy__", &__copy__<SireMol::NullBondHunter>);
        NullBondHunter_exposer.def( "__deepcopy__", &__copy__<SireMol::NullBondHunter>);
        NullBondHunter_exposer.def( "clone", &__copy__<SireMol::NullBondHunter>);

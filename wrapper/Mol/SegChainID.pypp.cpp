...
void register_SegChainID_class(){
    ...
    { //::SireMol::GroupGroupID< SireMol::SegID, SireMol::ChainID >
        ...
        SegChainID_exposer.def( "__copy__", &__copy__<SireMol::GroupGroupID<SireMol::SegID, SireMol::ChainID>>);
        SegChainID_exposer.def( "__deepcopy__", &__copy__<SireMol::GroupGroupID<SireMol::SegID, SireMol::ChainID>>);
        SegChainID_exposer.def( "clone", &__copy__<SireMol::GroupGroupID<SireMol::SegID, SireMol::ChainID>>);
        ...
        SegChainID_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::GroupGroupID<SireMol::SegID, SireMol::ChainID> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        SegChainID_exposer.def_pickle(sire_pickle_suite< ::SireMol::GroupGroupID<SireMol::SegID, SireMol::ChainID> >());

...
void register_InvertMatch_ResID__class(){
    ...
    { //::SireID::InvertMatch< SireMol::ResID >
        ...
        InvertMatch_ResID__exposer.def( "__copy__", &__copy__<SireID::InvertMatch<SireMol::ResID>>);
        InvertMatch_ResID__exposer.def( "__deepcopy__", &__copy__<SireID::InvertMatch<SireMol::ResID>>);
        InvertMatch_ResID__exposer.def( "clone", &__copy__<SireID::InvertMatch<SireMol::ResID>>);
        ...
        InvertMatch_ResID__exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireID::InvertMatch<SireMol::ResID> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        InvertMatch_ResID__exposer.def_pickle(sire_pickle_suite< ::SireID::InvertMatch<SireMol::ResID> >());

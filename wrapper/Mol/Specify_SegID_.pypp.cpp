...
void register_Specify_SegID__class(){
    ...
    { //::SireID::Specify< SireMol::SegID >
        ...
        Specify_SegID__exposer.def( "__copy__", &__copy__<SireID::Specify<SireMol::SegID>>);
        Specify_SegID__exposer.def( "__deepcopy__", &__copy__<SireID::Specify<SireMol::SegID>>);
        Specify_SegID__exposer.def( "clone", &__copy__<SireID::Specify<SireMol::SegID>>);

...
void register_MolResID_class(){
    ...
    { //::SireMol::MolResID
        ...
        MolResID_exposer.def( "__copy__", &__copy__<SireMol::MolResID>);
        MolResID_exposer.def( "__deepcopy__", &__copy__<SireMol::MolResID>);
        MolResID_exposer.def( "clone", &__copy__<SireMol::MolResID>);

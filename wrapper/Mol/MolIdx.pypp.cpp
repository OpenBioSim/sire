...
void register_MolIdx_class(){
    ...
    { //::SireMol::MolIdx
        ...
        MolIdx_exposer.def( "__copy__", &__copy__<SireMol::MolIdx>);
        MolIdx_exposer.def( "__deepcopy__", &__copy__<SireMol::MolIdx>);
        MolIdx_exposer.def( "clone", &__copy__<SireMol::MolIdx>);

...
void register_CGChainID_class(){
    ...
    { //::SireMol::GroupGroupID< SireMol::CGID, SireMol::ChainID >
        ...
        CGChainID_exposer.def( "__copy__", &__copy__<SireMol::GroupGroupID<SireMol::CGID, SireMol::ChainID>>);
        CGChainID_exposer.def( "__deepcopy__", &__copy__<SireMol::GroupGroupID<SireMol::CGID, SireMol::ChainID>>);
        CGChainID_exposer.def( "clone", &__copy__<SireMol::GroupGroupID<SireMol::CGID, SireMol::ChainID>>);
        ...
        CGChainID_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::GroupGroupID<SireMol::CGID, SireMol::ChainID> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        CGChainID_exposer.def_pickle(sire_pickle_suite< ::SireMol::GroupGroupID<SireMol::CGID, SireMol::ChainID> >());

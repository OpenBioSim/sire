...
void register_AtomSelection_class(){
    ...
    { //::SireMol::AtomSelection
        ...
        AtomSelection_exposer.def( "__copy__", &__copy__<SireMol::AtomSelection>);
        AtomSelection_exposer.def( "__deepcopy__", &__copy__<SireMol::AtomSelection>);
        AtomSelection_exposer.def( "clone", &__copy__<SireMol::AtomSelection>);

...
void register_IDAndSet_CGID__class(){
    ...
    { //::SireID::IDAndSet< SireMol::CGID >
        ...
        IDAndSet_CGID__exposer.def( "__copy__", &__copy__<SireID::IDAndSet<SireMol::CGID>>);
        IDAndSet_CGID__exposer.def( "__deepcopy__", &__copy__<SireID::IDAndSet<SireMol::CGID>>);
        IDAndSet_CGID__exposer.def( "clone", &__copy__<SireID::IDAndSet<SireMol::CGID>>);

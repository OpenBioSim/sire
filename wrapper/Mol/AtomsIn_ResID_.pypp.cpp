...
void register_AtomsIn_ResID__class(){
    ...
    { //::SireMol::AtomsIn< SireMol::ResID >
        ...
        AtomsIn_ResID__exposer.def( "__copy__", &__copy__<SireMol::AtomsIn<SireMol::ResID>>);
        AtomsIn_ResID__exposer.def( "__deepcopy__", &__copy__<SireMol::AtomsIn<SireMol::ResID>>);
        AtomsIn_ResID__exposer.def( "clone", &__copy__<SireMol::AtomsIn<SireMol::ResID>>);
        ...
        AtomsIn_ResID__exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::AtomsIn<SireMol::ResID> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AtomsIn_ResID__exposer.def_pickle(sire_pickle_suite< ::SireMol::AtomsIn<SireMol::ResID> >());

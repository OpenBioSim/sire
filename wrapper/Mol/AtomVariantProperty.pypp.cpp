...
void register_AtomVariantProperty_class(){
    ...
    { //::SireMol::AtomProperty< QVariant >
        ...
        AtomVariantProperty_exposer.def( "__copy__", &__copy__<SireMol::AtomProperty<QVariant>>);
        AtomVariantProperty_exposer.def( "__deepcopy__", &__copy__<SireMol::AtomProperty<QVariant>>);
        AtomVariantProperty_exposer.def( "clone", &__copy__<SireMol::AtomProperty<QVariant>>);

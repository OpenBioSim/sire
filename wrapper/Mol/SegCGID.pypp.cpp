...
void register_SegCGID_class(){
    ...
    { //::SireMol::GroupGroupID< SireMol::SegID, SireMol::CGID >
        ...
        SegCGID_exposer.def( "__copy__", &__copy__<SireMol::GroupGroupID<SireMol::SegID, SireMol::CGID>>);
        SegCGID_exposer.def( "__deepcopy__", &__copy__<SireMol::GroupGroupID<SireMol::SegID, SireMol::CGID>>);
        SegCGID_exposer.def( "clone", &__copy__<SireMol::GroupGroupID<SireMol::SegID, SireMol::CGID>>);

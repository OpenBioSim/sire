...
void register_Molecule_class(){
    ...
    { //::SireMol::Molecule
        ...
        Molecule_exposer.def( "__copy__", &__copy__<SireMol::Molecule>);
        Molecule_exposer.def( "__deepcopy__", &__copy__<SireMol::Molecule>);
        Molecule_exposer.def( "clone", &__copy__<SireMol::Molecule>);

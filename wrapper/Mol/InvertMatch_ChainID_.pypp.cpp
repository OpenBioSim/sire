...
void register_InvertMatch_ChainID__class(){
    ...
    { //::SireID::InvertMatch< SireMol::ChainID >
        ...
        InvertMatch_ChainID__exposer.def( "__copy__", &__copy__<SireID::InvertMatch<SireMol::ChainID>>);
        InvertMatch_ChainID__exposer.def( "__deepcopy__", &__copy__<SireID::InvertMatch<SireMol::ChainID>>);
        InvertMatch_ChainID__exposer.def( "clone", &__copy__<SireID::InvertMatch<SireMol::ChainID>>);

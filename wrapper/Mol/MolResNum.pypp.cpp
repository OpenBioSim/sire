...
void register_MolResNum_class(){
    ...
    { //::SireMol::MolResNum
        ...
        MolResNum_exposer.def( "__copy__", &__copy__<SireMol::MolResNum>);
        MolResNum_exposer.def( "__deepcopy__", &__copy__<SireMol::MolResNum>);
        MolResNum_exposer.def( "clone", &__copy__<SireMol::MolResNum>);

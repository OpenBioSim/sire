...
void register_ChainPropertyProperty_class(){
    ...
    { //::SireMol::ChainProperty< SireBase::PropPtr< SireBase::Property > >
        ...
        { //::SireMol::ChainProperty< SireBase::PropPtr< SireBase::Property > >::merge
        
            typedef SireMol::ChainProperty< SireBase::PropPtr< SireBase::Property > > exported_class_t;
            typedef ::SireBase::PropertyList ( ::SireMol::ChainProperty< SireBase::PropPtr< SireBase::Property > >::*merge_function_type)( ::SireMol::MolViewProperty const &,::SireMol::AtomIdxMapping const &,::QString const &,::SireBase::PropertyMap const & ) const;
            merge_function_type merge_function_value( &::SireMol::ChainProperty< SireBase::PropPtr< SireBase::Property > >::merge );
        ...
        ChainPropertyProperty_exposer.def( "__copy__", &__copy__<SireMol::ChainProperty<SireBase::PropPtr<SireBase::Property> >>);
        ChainPropertyProperty_exposer.def( "__deepcopy__", &__copy__<SireMol::ChainProperty<SireBase::PropPtr<SireBase::Property> >>);
        ChainPropertyProperty_exposer.def( "clone", &__copy__<SireMol::ChainProperty<SireBase::PropPtr<SireBase::Property> >>);

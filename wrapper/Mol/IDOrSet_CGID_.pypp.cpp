...
void register_IDOrSet_CGID__class(){
    ...
    { //::SireID::IDOrSet< SireMol::CGID >
        ...
        IDOrSet_CGID__exposer.def( "__copy__", &__copy__<SireID::IDOrSet<SireMol::CGID>>);
        IDOrSet_CGID__exposer.def( "__deepcopy__", &__copy__<SireID::IDOrSet<SireMol::CGID>>);
        IDOrSet_CGID__exposer.def( "clone", &__copy__<SireID::IDOrSet<SireMol::CGID>>);

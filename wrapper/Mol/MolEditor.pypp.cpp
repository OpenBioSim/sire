...
void register_MolEditor_class(){
    ...
    { //::SireMol::MolEditor
        ...
        MolEditor_exposer.def( "__copy__", &__copy__<SireMol::MolEditor>);
        MolEditor_exposer.def( "__deepcopy__", &__copy__<SireMol::MolEditor>);
        MolEditor_exposer.def( "clone", &__copy__<SireMol::MolEditor>);

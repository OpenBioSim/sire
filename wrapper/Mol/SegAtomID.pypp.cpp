...
void register_SegAtomID_class(){
    ...
    { //::SireMol::GroupAtomID< SireMol::SegID, SireMol::AtomID >
        ...
        SegAtomID_exposer.def( "__copy__", &__copy__<SireMol::GroupAtomID<SireMol::SegID, SireMol::AtomID>>);
        SegAtomID_exposer.def( "__deepcopy__", &__copy__<SireMol::GroupAtomID<SireMol::SegID, SireMol::AtomID>>);
        SegAtomID_exposer.def( "clone", &__copy__<SireMol::GroupAtomID<SireMol::SegID, SireMol::AtomID>>);
        ...
        SegAtomID_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::GroupAtomID<SireMol::SegID, SireMol::AtomID> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        SegAtomID_exposer.def_pickle(sire_pickle_suite< ::SireMol::GroupAtomID<SireMol::SegID, SireMol::AtomID> >());

...
void register_IDOrSet_MGID__class(){
    ...
    { //::SireID::IDOrSet< SireMol::MGID >
        ...
        IDOrSet_MGID__exposer.def( "__copy__", &__copy__<SireID::IDOrSet<SireMol::MGID>>);
        IDOrSet_MGID__exposer.def( "__deepcopy__", &__copy__<SireID::IDOrSet<SireMol::MGID>>);
        IDOrSet_MGID__exposer.def( "clone", &__copy__<SireID::IDOrSet<SireMol::MGID>>);

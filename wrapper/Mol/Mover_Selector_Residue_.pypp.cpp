...
void register_Mover_Selector_Residue__class(){
    ...
    { //::SireMol::Mover< SireMol::Selector< SireMol::Residue > >
        ...
        Mover_Selector_Residue__exposer.def( "__copy__", &__copy__<SireMol::Mover<SireMol::Selector<SireMol::Residue> >>);
        Mover_Selector_Residue__exposer.def( "__deepcopy__", &__copy__<SireMol::Mover<SireMol::Selector<SireMol::Residue> >>);
        Mover_Selector_Residue__exposer.def( "clone", &__copy__<SireMol::Mover<SireMol::Selector<SireMol::Residue> >>);

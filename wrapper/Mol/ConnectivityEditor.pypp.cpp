    ...
    { //::SireMol::ConnectivityEditor
        ...
        { //::SireMol::ConnectivityEditor::commit
            ...
            ConnectivityEditor_exposer.def(
                "commit", commit_function_value, bp::release_gil_policy(), "Return the editied connectivity");
        }
        { //::SireMol::ConnectivityEditor::connect
            ...
            ConnectivityEditor_exposer.def(
                "connect", connect_function_value, (bp::arg("atom0"), bp::arg("atom1")), bp::return_self<>(), "Record the connection between the atoms at indicies atom0\nand atom1\nThrow: SireError::invalid_index\n");
        }
        { //::SireMol::ConnectivityEditor::connect
            ...
            ConnectivityEditor_exposer.def(
                "connect", connect_function_value, (bp::arg("atom0"), bp::arg("atom1")), bp::return_self<>(), "Record a connection between the atom identified by atom0 and\nthe atom identified by atom1\nThrow: SireMol::missing_atom\nThrow: SireMol::duplicate_atom\nThrow: SireError::invalid_index\n");
        }
        { //::SireMol::ConnectivityEditor::disconnect
            ...
            ConnectivityEditor_exposer.def(
                "disconnect", disconnect_function_value, (bp::arg("atom0"), bp::arg("atom1")), bp::return_self<>(), "Remove the connection between the atoms at indicies atom0\nand atom1 - this does nothing if there isnt already a connection\nThrow: SireError::invalid_index\n");
        }
        { //::SireMol::ConnectivityEditor::disconnect
            ...
            ConnectivityEditor_exposer.def(
                "disconnect", disconnect_function_value, (bp::arg("atom0"), bp::arg("atom1")), bp::return_self<>(), "Disconnect the atoms that are identified by atom0 and atom1 -\nthis does nothing if there isnt a connection between these atoms\nThrow: SireMol::missing_atom\nThrow: SireMol::duplicate_atom\nThrow: SireError::invalid_index\n");
        }
        { //::SireMol::ConnectivityEditor::disconnectAll
            ...
            ConnectivityEditor_exposer.def(
                "disconnectAll", disconnectAll_function_value, (bp::arg("atomidx")), bp::return_self<>(), "Remove all of the connections to the atom at index atomidx\nThrow: SireError::invalid_index\n");
        }
        { //::SireMol::ConnectivityEditor::disconnectAll
            ...
            ConnectivityEditor_exposer.def(
                "disconnectAll", disconnectAll_function_value, (bp::arg("residx")), bp::return_self<>(), "Remove all of the connections that involve any of the atoms\nin the residue at index residx\nThrow: SireError::invalid_index\n");
        }
        { //::SireMol::ConnectivityEditor::disconnectAll
            ...
            ConnectivityEditor_exposer.def(
                "disconnectAll", disconnectAll_function_value, (bp::arg("atomid")), bp::return_self<>(), "Remove all of the connections to the atom identified by atomid\nThrow: SireMol::missing_atom\nThrow: SireMol::duplicate_atom\nThrow: SireError::invalid_index\n");
        }
        { //::SireMol::ConnectivityEditor::disconnectAll
            ...
            ConnectivityEditor_exposer.def(
                "disconnectAll", disconnectAll_function_value, (bp::arg("resid")), bp::return_self<>(), "Remove all of the connections that involve any of the atoms\nin the residue identified by resid\nThrow: SireMol::missing_residue\nThrow: SireMol::duplicate_residue\nThrow: SireError::invalid_index\n");
        }
        { //::SireMol::ConnectivityEditor::disconnectAll
            ...
            ConnectivityEditor_exposer.def(
                "disconnectAll", disconnectAll_function_value, bp::return_self<>(), "Remove all bonds from this molecule");
        }
        ...
        { //::SireMol::ConnectivityEditor::removeProperty
            ...
            ConnectivityEditor_exposer.def(
                "removeProperty", removeProperty_function_value, (bp::arg("key")), bp::return_self<>(), "Remove the specified property from all bonds");
        }
        { //::SireMol::ConnectivityEditor::removeProperty
            ...
            ConnectivityEditor_exposer.def(
                "removeProperty", removeProperty_function_value, (bp::arg("bond"), bp::arg("key")), bp::return_self<>(), "Remove the specified property from the specified bond");
        }
        { //::SireMol::ConnectivityEditor::removeProperty
            ...
            ConnectivityEditor_exposer.def(
                "removeProperty", removeProperty_function_value, (bp::arg("ang"), bp::arg("key")), bp::return_self<>(), "Remove the specified property from the specified angle");
        }
        { //::SireMol::ConnectivityEditor::removeProperty
            ...
            ConnectivityEditor_exposer.def(
                "removeProperty", removeProperty_function_value, (bp::arg("dih"), bp::arg("key")), bp::return_self<>(), "Remove the specified property from the specified dihedral");
        }
        { //::SireMol::ConnectivityEditor::removeProperty
            ...
            ConnectivityEditor_exposer.def(
                "removeProperty", removeProperty_function_value, (bp::arg("imp"), bp::arg("key")), bp::return_self<>(), "Remove the specified property from the specified improper");
        }
        { //::SireMol::ConnectivityEditor::setProperty
            ...
            ConnectivityEditor_exposer.def(
                "setProperty", setProperty_function_value, (bp::arg("bond"), bp::arg("key"), bp::arg("value")), bp::return_self<>(), "Set the property for the specified bond, at the specified key, to value");
        }
        { //::SireMol::ConnectivityEditor::setProperty
            ...
            ConnectivityEditor_exposer.def(
                "setProperty", setProperty_function_value, (bp::arg("ang"), bp::arg("key"), bp::arg("value")), bp::return_self<>(), "Set the property for the specified angle, at the specified key, to value");
        }
        { //::SireMol::ConnectivityEditor::setProperty
            ...
            ConnectivityEditor_exposer.def(
                "setProperty", setProperty_function_value, (bp::arg("dih"), bp::arg("key"), bp::arg("value")), bp::return_self<>(), "Set the property for the specified dihedral, at the specified key, to value");
        }
        { //::SireMol::ConnectivityEditor::setProperty
            ...
            ConnectivityEditor_exposer.def(
                "setProperty", setProperty_function_value, (bp::arg("imp"), bp::arg("key"), bp::arg("value")), bp::return_self<>(), "Set the property for the specified improper, at the specified key, to value");
        }
        { //::SireMol::ConnectivityEditor::takeProperty
            ...
            ConnectivityEditor_exposer.def(
                "takeProperty", takeProperty_function_value, (bp::arg("bond"), bp::arg("key")), bp::release_gil_policy(), "Take the specified property from the specified bond - this removes\nand returns the property if it exists. If it doesnt, then\na NullProperty is returned\n");
        }
        { //::SireMol::ConnectivityEditor::takeProperty
            ...
            ConnectivityEditor_exposer.def(
                "takeProperty", takeProperty_function_value, (bp::arg("ang"), bp::arg("key")), bp::release_gil_policy(), "Take the specified property from the specified angle - this removes\nand returns the property if it exists. If it doesnt, then\na NullProperty is returned\n");
        }
        { //::SireMol::ConnectivityEditor::takeProperty
            ...
            ConnectivityEditor_exposer.def(
                "takeProperty", takeProperty_function_value, (bp::arg("dih"), bp::arg("key")), bp::release_gil_policy(), "Take the specified property from the specified dihedral - this removes\nand returns the property if it exists. If it doesnt, then\na NullProperty is returned\n");
        }
        { //::SireMol::ConnectivityEditor::takeProperty
            ...
            ConnectivityEditor_exposer.def(
                "takeProperty", takeProperty_function_value, (bp::arg("imp"), bp::arg("key")), bp::release_gil_policy(), "Take the specified property from the specified improper - this removes\nand returns the property if it exists. If it doesnt, then\na NullProperty is returned\n");
        }

...
void register_PartialMolecule_class(){
    ...
    { //::SireMol::PartialMolecule
        ...
        PartialMolecule_exposer.def( "__copy__", &__copy__<SireMol::PartialMolecule>);
        PartialMolecule_exposer.def( "__deepcopy__", &__copy__<SireMol::PartialMolecule>);
        PartialMolecule_exposer.def( "clone", &__copy__<SireMol::PartialMolecule>);

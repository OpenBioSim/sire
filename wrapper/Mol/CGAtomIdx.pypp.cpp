...
void register_CGAtomIdx_class(){
    ...
    { //::SireMol::CGAtomIdx
        ...
        CGAtomIdx_exposer.def( "__copy__", &__copy__<SireMol::CGAtomIdx>);
        CGAtomIdx_exposer.def( "__deepcopy__", &__copy__<SireMol::CGAtomIdx>);
        CGAtomIdx_exposer.def( "clone", &__copy__<SireMol::CGAtomIdx>);

...
void register_SelectResult_class(){
    ...
    { //::SireMol::SelectResult
        ...
        SelectResult_exposer.def( "__copy__", &__copy__<SireMol::SelectResult>);
        SelectResult_exposer.def( "__deepcopy__", &__copy__<SireMol::SelectResult>);
        SelectResult_exposer.def( "clone", &__copy__<SireMol::SelectResult>);

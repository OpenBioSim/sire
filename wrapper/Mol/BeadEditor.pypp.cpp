...
void register_BeadEditor_class(){
    ...
    { //::SireMol::BeadEditor
        ...
        BeadEditor_exposer.def( "__copy__", &__copy__<SireMol::BeadEditor>);
        BeadEditor_exposer.def( "__deepcopy__", &__copy__<SireMol::BeadEditor>);
        BeadEditor_exposer.def( "clone", &__copy__<SireMol::BeadEditor>);

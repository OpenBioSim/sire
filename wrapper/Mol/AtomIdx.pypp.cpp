...
void register_AtomIdx_class(){
    ...
    { //::SireMol::AtomIdx
        ...
        AtomIdx_exposer.def( "__copy__", &__copy__<SireMol::AtomIdx>);
        AtomIdx_exposer.def( "__deepcopy__", &__copy__<SireMol::AtomIdx>);
        AtomIdx_exposer.def( "clone", &__copy__<SireMol::AtomIdx>);

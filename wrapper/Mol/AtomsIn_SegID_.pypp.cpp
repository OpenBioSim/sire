...
void register_AtomsIn_SegID__class(){
    ...
    { //::SireMol::AtomsIn< SireMol::SegID >
        ...
        AtomsIn_SegID__exposer.def( "__copy__", &__copy__<SireMol::AtomsIn<SireMol::SegID>>);
        AtomsIn_SegID__exposer.def( "__deepcopy__", &__copy__<SireMol::AtomsIn<SireMol::SegID>>);
        AtomsIn_SegID__exposer.def( "clone", &__copy__<SireMol::AtomsIn<SireMol::SegID>>);

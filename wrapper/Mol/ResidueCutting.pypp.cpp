...
void register_ResidueCutting_class(){
    ...
    { //::SireMol::ResidueCutting
        ...
        ResidueCutting_exposer.def( "__copy__", &__copy__<SireMol::ResidueCutting>);
        ResidueCutting_exposer.def( "__deepcopy__", &__copy__<SireMol::ResidueCutting>);
        ResidueCutting_exposer.def( "clone", &__copy__<SireMol::ResidueCutting>);

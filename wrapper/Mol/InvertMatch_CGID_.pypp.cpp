...
void register_InvertMatch_CGID__class(){
    ...
    { //::SireID::InvertMatch< SireMol::CGID >
        ...
        InvertMatch_CGID__exposer.def( "__copy__", &__copy__<SireID::InvertMatch<SireMol::CGID>>);
        InvertMatch_CGID__exposer.def( "__deepcopy__", &__copy__<SireID::InvertMatch<SireMol::CGID>>);
        InvertMatch_CGID__exposer.def( "clone", &__copy__<SireID::InvertMatch<SireMol::CGID>>);

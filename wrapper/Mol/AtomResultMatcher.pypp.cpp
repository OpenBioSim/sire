...
void register_AtomResultMatcher_class(){
    ...
    { //::SireMol::AtomResultMatcher
        ...
        AtomResultMatcher_exposer.def( "__copy__", &__copy__<SireMol::AtomResultMatcher>);
        AtomResultMatcher_exposer.def( "__deepcopy__", &__copy__<SireMol::AtomResultMatcher>);
        AtomResultMatcher_exposer.def( "clone", &__copy__<SireMol::AtomResultMatcher>);
        ...
        AtomResultMatcher_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireMol::AtomResultMatcher >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        AtomResultMatcher_exposer.def_pickle(sire_pickle_suite< ::SireMol::AtomResultMatcher >());

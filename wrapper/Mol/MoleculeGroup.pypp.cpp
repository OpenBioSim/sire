...
void register_MoleculeGroup_class(){
    ...
    { //::SireMol::MoleculeGroup
        ...
        MoleculeGroup_exposer.def( "__copy__", &__copy__<SireMol::MoleculeGroup>);
        MoleculeGroup_exposer.def( "__deepcopy__", &__copy__<SireMol::MoleculeGroup>);
        MoleculeGroup_exposer.def( "clone", &__copy__<SireMol::MoleculeGroup>);

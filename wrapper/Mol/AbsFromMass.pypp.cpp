...
void register_AbsFromMass_class(){
    ...
    { //::SireMol::AbsFromMass
        ...
        AbsFromMass_exposer.def( "__copy__", &__copy__<SireMol::AbsFromMass>);
        AbsFromMass_exposer.def( "__deepcopy__", &__copy__<SireMol::AbsFromMass>);
        AbsFromMass_exposer.def( "clone", &__copy__<SireMol::AbsFromMass>);

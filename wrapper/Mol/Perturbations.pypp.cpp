...
void register_Perturbations_class(){
    ...
    { //::SireMol::Perturbations
        ...
        Perturbations_exposer.def( "__copy__", &__copy__<SireMol::Perturbations>);
        Perturbations_exposer.def( "__deepcopy__", &__copy__<SireMol::Perturbations>);
        Perturbations_exposer.def( "clone", &__copy__<SireMol::Perturbations>);

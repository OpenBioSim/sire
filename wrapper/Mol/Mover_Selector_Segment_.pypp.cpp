...
void register_Mover_Selector_Segment__class(){
    ...
    { //::SireMol::Mover< SireMol::Selector< SireMol::Segment > >
        ...
        Mover_Selector_Segment__exposer.def( "__copy__", &__copy__<SireMol::Mover<SireMol::Selector<SireMol::Segment> >>);
        Mover_Selector_Segment__exposer.def( "__deepcopy__", &__copy__<SireMol::Mover<SireMol::Selector<SireMol::Segment> >>);
        Mover_Selector_Segment__exposer.def( "clone", &__copy__<SireMol::Mover<SireMol::Selector<SireMol::Segment> >>);

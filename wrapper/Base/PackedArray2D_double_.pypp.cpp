...
void register_PackedArray2D_double__class(){
    ...
    { //::SireBase::PackedArray2D< double >
        ...
        { //::SireBase::PackedArray2D< double >::detach
        
            typedef SireBase::PackedArray2D< double > exported_class_t;
            typedef void ( ::SireBase::PackedArray2D< double >::*detach_function_type)(  ) ;
            detach_function_type detach_function_value( &::SireBase::PackedArray2D< double >::detach );
        ...
        PackedArray2D_double__exposer.def( "__copy__", &__copy__<SireBase::PackedArray2D<double>>);
        PackedArray2D_double__exposer.def( "__deepcopy__", &__copy__<SireBase::PackedArray2D<double>>);
        PackedArray2D_double__exposer.def( "clone", &__copy__<SireBase::PackedArray2D<double>>);
        ...
        PackedArray2D_double__exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireBase::PackedArray2D<double> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        PackedArray2D_double__exposer.def_pickle(sire_pickle_suite< ::SireBase::PackedArray2D<double> >());

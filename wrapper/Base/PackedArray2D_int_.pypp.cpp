...
void register_PackedArray2D_int__class(){
    ...
    { //::SireBase::PackedArray2D< int >
        ...
        PackedArray2D_int__exposer.def( "__copy__", &__copy__<SireBase::PackedArray2D<int>>);
        PackedArray2D_int__exposer.def( "__deepcopy__", &__copy__<SireBase::PackedArray2D<int>>);
        PackedArray2D_int__exposer.def( "clone", &__copy__<SireBase::PackedArray2D<int>>);
        ...
        PackedArray2D_int__exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireBase::PackedArray2D<int> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        PackedArray2D_int__exposer.def_pickle(sire_pickle_suite< ::SireBase::PackedArray2D<int> >());

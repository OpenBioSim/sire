...
void register_NullProperty_class(){
    ...
    { //::SireBase::NullProperty
        ...
        NullProperty_exposer.def( "__copy__", &__copy__<SireBase::NullProperty>);
        NullProperty_exposer.def( "__deepcopy__", &__copy__<SireBase::NullProperty>);
        NullProperty_exposer.def( "clone", &__copy__<SireBase::NullProperty>);

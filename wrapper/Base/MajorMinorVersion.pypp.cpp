...
void register_MajorMinorVersion_class(){
    ...
    { //::SireBase::MajorMinorVersion
        ...
        MajorMinorVersion_exposer.def( bp::init< std::shared_ptr< SireBase::detail::MajorMinorVersionData > const & >(( bp::arg("other") ), "Construct from a raw data object - this should only be called by\nthe registry function") );

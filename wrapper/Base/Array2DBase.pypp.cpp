...
const char *pvt_get_name(const SireBase::Array2DBase &)
{
    ...
    { //::SireBase::Array2DBase
        ...
        { //::SireBase::Array2DBase::assertValidIndex
            ...
            Array2DBase_exposer.def(
                "assertValidIndex", assertValidIndex_function_value, (bp::arg("i"), bp::arg("j")), bp::release_gil_policy(), "");
        }
        { //::SireBase::Array2DBase::checkedOffset
            ...
            Array2DBase_exposer.def(
                "checkedOffset", checkedOffset_function_value, (bp::arg("i"), bp::arg("j")), bp::release_gil_policy(), "");
        }
        { //::SireBase::Array2DBase::map
            ...
            Array2DBase_exposer.def(
                "map", map_function_value, (bp::arg("i"), bp::arg("j")), bp::release_gil_policy(), "");
        }
        { //::SireBase::Array2DBase::nColumns
            ...
            Array2DBase_exposer.def(
                "nColumns", nColumns_function_value, bp::release_gil_policy(), "");
        }
        { //::SireBase::Array2DBase::nRows
            ...
            Array2DBase_exposer.def(
                "nRows", nRows_function_value, bp::release_gil_policy(), "");
        }

...
void register_PackedArray2D_PropertyList_Array_class(){
    ...
    { //::SireBase::detail::PackedArray2D_Array< SireBase::PropertyList >
        ...
        PackedArray2D_PropertyList_Array_exposer.def( "__copy__", &__copy__<SireBase::detail::PackedArray2D_Array<SireBase::PropertyList>>);
        PackedArray2D_PropertyList_Array_exposer.def( "__deepcopy__", &__copy__<SireBase::detail::PackedArray2D_Array<SireBase::PropertyList>>);
        PackedArray2D_PropertyList_Array_exposer.def( "clone", &__copy__<SireBase::detail::PackedArray2D_Array<SireBase::PropertyList>>);

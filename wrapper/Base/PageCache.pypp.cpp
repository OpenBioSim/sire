...
void register_PageCache_class(){
    ...
    { //::SireBase::PageCache
        ...
        { //::SireBase::PageCache::Handle
            ...
            Handle_exposer.def( "__copy__", &__copy__);
            Handle_exposer.def( "__deepcopy__", &__copy__);
            Handle_exposer.def( "clone", &__copy__);
        ...
        { //::SireBase::PageCache::Page
            ...
            Page_exposer.def( "__copy__", &__copy__);
            Page_exposer.def( "__deepcopy__", &__copy__);
            Page_exposer.def( "clone", &__copy__);
        ...
        PageCache_exposer.def( "__copy__", &__copy__);
        PageCache_exposer.def( "__deepcopy__", &__copy__);
        PageCache_exposer.def( "clone", &__copy__);

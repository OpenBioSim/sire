...
void register_PackedArray2D_double_Array_class(){
    ...
    { //::SireBase::detail::PackedArray2D_Array< double >
        ...
        PackedArray2D_double_Array_exposer.def( "__copy__", &__copy__<SireBase::detail::PackedArray2D_Array<double>>);
        PackedArray2D_double_Array_exposer.def( "__deepcopy__", &__copy__<SireBase::detail::PackedArray2D_Array<double>>);
        PackedArray2D_double_Array_exposer.def( "clone", &__copy__<SireBase::detail::PackedArray2D_Array<double>>);
        ...
        PackedArray2D_double_Array_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireBase::detail::PackedArray2D_Array<double> >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        PackedArray2D_double_Array_exposer.def_pickle(sire_pickle_suite< ::SireBase::detail::PackedArray2D_Array<double> >());

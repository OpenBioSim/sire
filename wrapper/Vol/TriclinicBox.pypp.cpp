...
SireVol::TriclinicBox __copy__(const SireVol::TriclinicBox &other)
{
    return SireVol::TriclinicBox(other);
}
    ...
    { //::SireVol::TriclinicBox
        ...
        { //::SireVol::TriclinicBox::alpha
            ...
            TriclinicBox_exposer.def(
                "alpha", alpha_function_value, bp::release_gil_policy(), "Return the angle between v1 and v2 in degrees.");
        }
        { //::SireVol::TriclinicBox::beta
            ...
            TriclinicBox_exposer.def(
                "beta", beta_function_value, bp::release_gil_policy(), "Return the angle between v0 and v2 in degrees.");
        }
        { //::SireVol::TriclinicBox::beyond
            ...
            TriclinicBox_exposer.def(
                "beyond", beyond_function_value, (bp::arg("dist"), bp::arg("aabox0"), bp::arg("aabox1")), bp::release_gil_policy(), "Return whether or not two groups enclosed by the AABoxes aabox0 and\naabox1 are definitely beyond the cutoff distance dist");
        }
        { //::SireVol::TriclinicBox::beyond
            ...
            TriclinicBox_exposer.def(
                "beyond", beyond_function_value, (bp::arg("dist"), bp::arg("group0"), bp::arg("group1")), bp::release_gil_policy(), "Return whether or not these two groups are definitely beyond the cutoff distance.");
        }
        { //::SireVol::TriclinicBox::boxMatrix
            ...
            TriclinicBox_exposer.def(
                "boxMatrix", boxMatrix_function_value, bp::release_gil_policy(), "");
        }
        { //::SireVol::TriclinicBox::calcAngle
            ...
            TriclinicBox_exposer.def(
                "calcAngle", calcAngle_function_value, (bp::arg("point0"), bp::arg("point1"), bp::arg("point2")), bp::release_gil_policy(), "Calculate the angle between the passed three points. This should return\nthe acute angle between the points, which should lie between 0 and 180 degrees");
        }
        { //::SireVol::TriclinicBox::calcDihedral
            ...
            TriclinicBox_exposer.def(
                "calcDihedral", calcDihedral_function_value, (bp::arg("point0"), bp::arg("point1"), bp::arg("point2"), bp::arg("point3")), bp::release_gil_policy(), "Calculate the torsion angle between the passed four points. This should\nreturn the torsion angle measured clockwise when looking down the\ntorsion from point0-point1-point2-point3. This will lie between 0 and 360\ndegrees");
        }
        ...
        { //::SireVol::TriclinicBox::calcDist
            ...
            TriclinicBox_exposer.def(
                "calcDist", calcDist_function_value, (bp::arg("group1"), bp::arg("group2"), bp::arg("distmat")), bp::release_gil_policy(), "Populate the matrix mat with the distances between all of the\natoms of the two CoordGroups. Return the shortest distance^2 between the two\nCoordGroups.");
        }
        { //::SireVol::TriclinicBox::calcDist
            ...
            TriclinicBox_exposer.def(
                "calcDist", calcDist_function_value, (bp::arg("group"), bp::arg("point"), bp::arg("mat")), bp::release_gil_policy(), "Populate the matrix mat with the distances between all of the\natoms of the passed CoordGroup to the passed point. Return the shortest\ndistance.");
        }
        ...
        { //::SireVol::TriclinicBox::calcDist2
            ...
            TriclinicBox_exposer.def(
                "calcDist2", calcDist2_function_value, (bp::arg("group"), bp::arg("point"), bp::arg("mat")), bp::release_gil_policy(), "Populate the matrix mat with the distances squared between all of the\natoms of the passed CoordGroup to the passed point. Return the shortest\ndistance.");
        }
        { //::SireVol::TriclinicBox::calcDist2
            ...
            TriclinicBox_exposer.def(
                "calcDist2", calcDist2_function_value, (bp::arg("group1"), bp::arg("group2"), bp::arg("distmat")), bp::release_gil_policy(), "Populate the matrix mat with the distances^2 between all of the\natoms of the two CoordGroups. Return the shortest distance between the\ntwo CoordGroups.");
        }
        { //::SireVol::TriclinicBox::calcDistVector
            ...
            TriclinicBox_exposer.def(
                "calcDistVector", calcDistVector_function_value, (bp::arg("point0"), bp::arg("point1")), bp::release_gil_policy(), "Calculate the distance vector between two points");
        }
        { //::SireVol::TriclinicBox::calcDistVectors
            ...
            TriclinicBox_exposer.def(
                "calcDistVectors", calcDistVectors_function_value, (bp::arg("group1"), bp::arg("group2"), bp::arg("distmat")), bp::release_gil_policy(), "Populate the matrix distmat between all the points of the two CoordGroups\ngroup1 and group2 - the returned matrix has the vectors pointing\nfrom each point in group1 to each point in group2. This returns\nthe shortest distance between two points in the group");
        }
        { //::SireVol::TriclinicBox::calcDistVectors
            ...
            TriclinicBox_exposer.def(
                "calcDistVectors", calcDistVectors_function_value, (bp::arg("group"), bp::arg("point"), bp::arg("distmat")), bp::release_gil_policy(), "Populate the matrix distmat between all the points passed CoordGroup\nto the point point - the returned matrix has the vectors pointing\nfrom the point to each point in group. This returns\nthe shortest distance.");
        }
        { //::SireVol::TriclinicBox::calcInvDist
            ...
            TriclinicBox_exposer.def(
                "calcInvDist", calcInvDist_function_value, (bp::arg("group1"), bp::arg("group2"), bp::arg("distmat")), bp::release_gil_policy(), "Populate the matrix mat with the inverse distances between all of the\natoms of the two CoordGroups. Return the shortest distance between the two CoordGroups.");
        }
        { //::SireVol::TriclinicBox::calcInvDist2
            ...
            TriclinicBox_exposer.def(
                "calcInvDist2", calcInvDist2_function_value, (bp::arg("group1"), bp::arg("group2"), bp::arg("distmat")), bp::release_gil_policy(), "Populate the matrix mat with the inverse distances^2 between all of the\natoms of the two CoordGroups. Return the shortest distance between the two CoordGroups.");
        }
        { //::SireVol::TriclinicBox::cellMatrix
            ...
            TriclinicBox_exposer.def(
                "cellMatrix", cellMatrix_function_value, bp::release_gil_policy(), "Return the cell matrix.");
        }
        { //::SireVol::TriclinicBox::cubic
            ...
            TriclinicBox_exposer.def(
                "cubic", cubic_function_value, (bp::arg("d")), bp::release_gil_policy(), "Return a cubic TriclinicBox with image distance d.");
        }
        { //::SireVol::TriclinicBox::gamma
            ...
            TriclinicBox_exposer.def(
                "gamma", gamma_function_value, bp::release_gil_policy(), "Return the angle between v1 and v0 in degrees.");
        }
        ...
        { //::SireVol::TriclinicBox::getBoxCenter
            ...
            TriclinicBox_exposer.def(
                "getBoxCenter", getBoxCenter_function_value, (bp::arg("p"), bp::arg("center")), bp::release_gil_policy(), "Return the center of the box that contains the point p assuming\nthat the center for the central box is located at center");
        }
        ...
        { //::SireVol::TriclinicBox::getImagesWithin
            ...
            TriclinicBox_exposer.def(
                "getImagesWithin", getImagesWithin_function_value, (bp::arg("point"), bp::arg("center"), bp::arg("dist")), bp::release_gil_policy(), "Return all periodic images of point with respect to center within\ndist distance of center");
        }
        { //::SireVol::TriclinicBox::getMinimumImage
            ...
            TriclinicBox_exposer.def(
                "getMinimumImage", getMinimumImage_function_value, (bp::arg("coords"), bp::arg("center")), bp::release_gil_policy(), "Return the copy of the point point which is the closest minimum image\nto center");
        }
        { //::SireVol::TriclinicBox::getMinimumImage
            ...
            TriclinicBox_exposer.def(
                "getMinimumImage", getMinimumImage_function_value, (bp::arg("point"), bp::arg("center")), bp::release_gil_policy(), "Return the copy of the point point which is the closest minimum image\nto center");
        }
        { //::SireVol::TriclinicBox::getMinimumImage
            ...
            TriclinicBox_exposer.def(
                "getMinimumImage", getMinimumImage_function_value, (bp::arg("group"), bp::arg("center")), bp::release_gil_policy(), "Return the closest periodic copy of group to the point point,\naccording to the minimum image convention. The effect of this is\nto move group into the box which is now centered on point");
        }
        { //::SireVol::TriclinicBox::getMinimumImage
        ...
        { //::SireVol::TriclinicBox::getMinimumImage
            ...
            TriclinicBox_exposer.def(
                "getMinimumImage", getMinimumImage_function_value, (bp::arg("aabox"), bp::arg("center")), bp::release_gil_policy(), "Return the copy of the triclinic box which is the closest minimum image\nto center");
        }
        { //::SireVol::TriclinicBox::getRandomPoint
            ...
            TriclinicBox_exposer.def(
                "getRandomPoint", getRandomPoint_function_value, (bp::arg("center"), bp::arg("generator")), bp::release_gil_policy(), "Return a random point within the box (placing the center of the box\nis at the center center)");
        }
        { //::SireVol::TriclinicBox::isCartesian
            ...
            TriclinicBox_exposer.def(
                "isCartesian", isCartesian_function_value, bp::release_gil_policy(), "In general, a triclinic box isnt Cartesian.");
        }
        { //::SireVol::TriclinicBox::isPeriodic
            ...
            TriclinicBox_exposer.def(
                "isPeriodic", isPeriodic_function_value, bp::release_gil_policy(), "A Triclinic box is periodic");
        }
        { //::SireVol::TriclinicBox::isRotated
            ...
            TriclinicBox_exposer.def(
                "isRotated", isRotated_function_value, bp::release_gil_policy(), "Whether the triclinic cell has been rotated to comply with the contraints\nof molecular dynamics engines, i.e. vector0 aligned with x axis, vector1\nin x-y plane, and vector2 with positive z component.\n");
        }
        { //::SireVol::TriclinicBox::minimumDistance
            ...
            TriclinicBox_exposer.def(
                "minimumDistance", minimumDistance_function_value, (bp::arg("group0"), bp::arg("group1")), bp::release_gil_policy(), "Return the minimum distance between the points in group0 and group1.\nIf this is a periodic space then this uses the minimum image convention\n(i.e. the minimum distance between the closest periodic replicas are\nused)");
        }
        { //::SireVol::TriclinicBox::minimumDistance
            ...
            TriclinicBox_exposer.def(
                "minimumDistance", minimumDistance_function_value, (bp::arg("box0"), bp::arg("box1")), bp::release_gil_policy(), "Return the minimum distance between the two boxes");
        }
        ...
        { //::SireVol::TriclinicBox::rhombicDodecahedronHexagon
            ...
            TriclinicBox_exposer.def(
                "rhombicDodecahedronHexagon", rhombicDodecahedronHexagon_function_value, (bp::arg("d")), bp::release_gil_policy(), "Return a hexagonal rhombic dodecahedron TriclinicBox with image distance d.");
        }
        { //::SireVol::TriclinicBox::rhombicDodecahedronSquare
            ...
            TriclinicBox_exposer.def(
                "rhombicDodecahedronSquare", rhombicDodecahedronSquare_function_value, (bp::arg("d")), bp::release_gil_policy(), "Return a square rhombic dodecahedron TriclinicBox with image distance d.");
        }
        { //::SireVol::TriclinicBox::rotationMatrix
            ...
            TriclinicBox_exposer.def(
                "rotationMatrix", rotationMatrix_function_value, bp::return_value_policy<bp::copy_const_reference>(), "Return the rotation matrix.");
        }
        { //::SireVol::TriclinicBox::setVolume
            ...
            TriclinicBox_exposer.def(
                "setVolume", setVolume_function_value, (bp::arg("volume")), bp::release_gil_policy(), "Set the volume of the triclinic box.");
        }
        { //::SireVol::TriclinicBox::toString
            ...
            TriclinicBox_exposer.def(
                "toString", toString_function_value, bp::release_gil_policy(), "Return a string representation of this space");
        }
        { //::SireVol::TriclinicBox::truncatedOctahedron
            ...
            TriclinicBox_exposer.def(
                "truncatedOctahedron", truncatedOctahedron_function_value, (bp::arg("d")), bp::release_gil_policy(), "Return a truncated octahedron with image distance d.");
        }
        ...
        { //::SireVol::TriclinicBox::vector0
            ...
            TriclinicBox_exposer.def(
                "vector0", vector0_function_value, bp::return_value_policy<bp::copy_const_reference>(), "Return the first box vector.");
        }
        { //::SireVol::TriclinicBox::vector1
            ...
            TriclinicBox_exposer.def(
                "vector1", vector1_function_value, bp::return_value_policy<bp::copy_const_reference>(), "Return the second box vector.");
        }
        { //::SireVol::TriclinicBox::vector2
            ...
            TriclinicBox_exposer.def(
                "vector2", vector2_function_value, bp::return_value_policy<bp::copy_const_reference>(), "Return the third box vector.");
        }
        { //::SireVol::TriclinicBox::volume
            ...
            TriclinicBox_exposer.def(
                "volume", volume_function_value, bp::release_gil_policy(), "Get the volume of the triclinic box.");
        }

...
void register_NullConstraint_class(){
    ...
    { //::SireSystem::NullConstraint
        ...
        NullConstraint_exposer.def( "__copy__", &__copy__<SireSystem::NullConstraint>);
        NullConstraint_exposer.def( "__deepcopy__", &__copy__<SireSystem::NullConstraint>);
        NullConstraint_exposer.def( "clone", &__copy__<SireSystem::NullConstraint>);

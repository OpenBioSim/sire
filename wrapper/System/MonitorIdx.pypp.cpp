...
void register_MonitorIdx_class(){
    ...
    { //::SireSystem::MonitorIdx
        ...
        MonitorIdx_exposer.def( "__copy__", &__copy__<SireSystem::MonitorIdx>);
        MonitorIdx_exposer.def( "__deepcopy__", &__copy__<SireSystem::MonitorIdx>);
        MonitorIdx_exposer.def( "clone", &__copy__<SireSystem::MonitorIdx>);

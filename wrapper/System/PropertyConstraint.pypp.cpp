...
void register_PropertyConstraint_class(){
    ...
    { //::SireSystem::PropertyConstraint
        ...
        PropertyConstraint_exposer.def( "__copy__", &__copy__<SireSystem::PropertyConstraint>);
        PropertyConstraint_exposer.def( "__deepcopy__", &__copy__<SireSystem::PropertyConstraint>);
        PropertyConstraint_exposer.def( "clone", &__copy__<SireSystem::PropertyConstraint>);

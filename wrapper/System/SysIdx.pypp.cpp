...
void register_SysIdx_class(){
    ...
    { //::SireSystem::SysIdx
        ...
        SysIdx_exposer.def( "__copy__", &__copy__<SireSystem::SysIdx>);
        SysIdx_exposer.def( "__deepcopy__", &__copy__<SireSystem::SysIdx>);
        SysIdx_exposer.def( "clone", &__copy__<SireSystem::SysIdx>);
        ...
        SysIdx_exposer.def( "__rrshift__", &__rrshift__QDataStream< ::SireSystem::SysIdx >,
                            bp::return_internal_reference<1, bp::with_custodian_and_ward<1,2> >() );
        SysIdx_exposer.def_pickle(sire_pickle_suite< ::SireSystem::SysIdx >());
        SysIdx_exposer.def( "__str__", &__str__< ::SireSystem::SysIdx > );
        SysIdx_exposer.def( "__repr__", &__str__< ::SireSystem::SysIdx > );
        SysIdx_exposer.def( "__hash__", &::SireSystem::SysIdx::hash );
    }

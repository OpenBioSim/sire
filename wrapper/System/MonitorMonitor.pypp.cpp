...
void register_MonitorMonitor_class(){
    ...
    { //::SireSystem::MonitorMonitor
        ...
        MonitorMonitor_exposer.def( "__copy__", &__copy__<SireSystem::MonitorMonitor>);
        MonitorMonitor_exposer.def( "__deepcopy__", &__copy__<SireSystem::MonitorMonitor>);
        MonitorMonitor_exposer.def( "clone", &__copy__<SireSystem::MonitorMonitor>);

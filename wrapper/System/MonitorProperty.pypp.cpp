...
void register_MonitorProperty_class(){
    ...
    { //::SireSystem::MonitorProperty
        ...
        MonitorProperty_exposer.def( "__copy__", &__copy__<SireSystem::MonitorProperty>);
        MonitorProperty_exposer.def( "__deepcopy__", &__copy__<SireSystem::MonitorProperty>);
        MonitorProperty_exposer.def( "clone", &__copy__<SireSystem::MonitorProperty>);

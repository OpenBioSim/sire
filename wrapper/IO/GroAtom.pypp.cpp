...
void register_GroAtom_class(){
    ...
    { //::SireIO::GroAtom
        ...
        GroAtom_exposer.def( "__copy__", &__copy__<SireIO::GroAtom>);
        GroAtom_exposer.def( "__deepcopy__", &__copy__<SireIO::GroAtom>);
        GroAtom_exposer.def( "clone", &__copy__<SireIO::GroAtom>);

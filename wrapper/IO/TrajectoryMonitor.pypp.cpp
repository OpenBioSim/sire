...
void register_TrajectoryMonitor_class(){
    ...
    { //::SireIO::TrajectoryMonitor
        ...
        TrajectoryMonitor_exposer.def( "__copy__", &__copy__<SireIO::TrajectoryMonitor>);
        TrajectoryMonitor_exposer.def( "__deepcopy__", &__copy__<SireIO::TrajectoryMonitor>);
        TrajectoryMonitor_exposer.def( "clone", &__copy__<SireIO::TrajectoryMonitor>);

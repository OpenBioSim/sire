...
void register_Tinker_class(){
    ...
    { //::SireIO::Tinker
        ...
        Tinker_exposer.def( "__copy__", &__copy__<SireIO::Tinker>);
        Tinker_exposer.def( "__deepcopy__", &__copy__<SireIO::Tinker>);
        Tinker_exposer.def( "clone", &__copy__<SireIO::Tinker>);

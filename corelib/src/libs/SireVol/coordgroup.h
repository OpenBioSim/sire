...
namespace SireVol
{
    ...
    */
    ...
    public:
        ...
        CoordGroupEditor &changeFrame(const SireMaths::AxisSet &from_frame, const SireMaths::AxisSet &to_frame);

        CoordGroupEditor &changeFrame(quint32 i, const SireMaths::AxisSet &from_frame, const SireMaths::AxisSet &to_frame);
    ...
    */
    ...
    public:
        ...
        CoordGroupArray(const CoordGroupArray &array0, const CoordGroupArray &array1);
        ...
        void changeFrame(quint32 i, const AxisSet &from_frame, const AxisSet &to_frame);
    ...
    */
    ...
    public:
        ...
        void rotate(quint32 i, quint32 j, const Quaternion &quat, const Vector &point);
        void rotate(quint32 i, quint32 j, const Matrix &rotmat, const Vector &point);
        ...
        void changeFrame(const AxisSet &from_frame, const AxisSet &to_frame);
        void changeFrame(quint32 i, const AxisSet &from_frame, const AxisSet &to_frame);
        void changeFrame(quint32 i, quint32 j, const AxisSet &from_frame, const AxisSet &to_frame);

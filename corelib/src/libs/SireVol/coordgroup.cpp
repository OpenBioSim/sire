...
quint32 CGMemory::getSize(quint32 narrays, quint32 ngroups, quint32 ncoords)
{
    ...
    return sizeof(CGArrayArrayData) + narrays * sizeof(CoordGroupArray) + narrays * sizeof(CGArrayData) +
           ngroups * sizeof(CoordGroup) + ngroups * sizeof(CGData) + ngroups * sizeof(AABox) +
           ncoords * sizeof(Vector) + 16; // allow 16 extra bytes for spacing
}
...
char *CGMemory::create(quint32 narrays, quint32 ncgroups, quint32 ncoords)
{
    ...
    try
    {
        ...
        CGArrayArrayData *cgarrayarray = new (storage) CGArrayArrayData(narrays, ncgroups, ncoords);
        ...
        if (narrays > 0)
        {
            ...
            BOOST_ASSERT(idx == cgarrayarray->cgarray0 + narrays * sizeof(CoordGroupArray));
        ...
        if (ncgroups > 0)
        {
            ...
            BOOST_ASSERT(idx == cgarrayarray->cgroup0 + ncgroups * sizeof(CoordGroup));
...
char *CGMemory::detach(char *this_ptr, quint32 this_idx)
{
    ...
    else
    {
        ...
        int sz = getSize(cgarrayarray->nCGArrays(), cgarrayarray->nCGroups(), cgarrayarray->nCoords());
...
CGArrayArrayData::CGArrayArrayData()
    : RefCountData(), cgarray0(0), cgarraydata0(0), ncgarrays(0), cgroup0(0), cgdata0(0), aabox0(0), ncgroups(0),
      coords0(0), ncoords(0)
{
}

/** Construct metadata for the specified number of subgroups */
CGArrayArrayData::CGArrayArrayData(quint32 narray, quint32 ngroup, quint32 ncoord)
    : RefCountData(), cgarray0(0), cgarraydata0(0), ncgarrays(narray), cgroup0(0), cgdata0(0), aabox0(0),
      ncgroups(ngroup), coords0(0), ncoords(ncoord)
{
}

/** Copy constructor */
CGArrayArrayData::CGArrayArrayData(const CGArrayArrayData &other)
    : RefCountData(), cgarray0(other.cgarray0), cgarraydata0(other.cgarraydata0), ncgarrays(other.ncgarrays),
      cgroup0(other.cgroup0), cgdata0(other.cgdata0), aabox0(other.aabox0), ncgroups(other.ncgroups),
...
/** Null constructor */
CGArrayData::CGArrayData() : this_cgarray(0), cgroup0(0), aabox0(0), ncgroups(0), coords0(0), ncoords(0)
{
}

/** Construct, telling this array that it is at index 'this_idx' */
CGArrayData::CGArrayData(quint32 this_idx)
    : this_cgarray(this_idx), cgroup0(0), aabox0(0), ncgroups(0), coords0(0), ncoords(0)
{
}

/** Copy constructor */
CGArrayData::CGArrayData(const CGArrayData &other)
    : this_cgarray(other.this_cgarray), cgroup0(other.cgroup0), aabox0(other.aabox0), ncgroups(other.ncgroups),
      coords0(other.coords0), ncoords(other.ncoords)
{
}
...
CGArrayArrayData *CGArrayData::extract() const
{
    ...
    try
    {
        ...
        // copy the AABoxes
        AABox *output = quickCopy<AABox>(new_array->aaBoxData(), this->aaBoxData(), this->nCGroups());

        BOOST_ASSERT(output == new_array->aaBoxData());

        // copy the coordinates
        Vector *out2 = quickCopy<Vector>(new_array->coordsData(), this->coordsData(), this->nCoords());
...
/** Null constructor */
CGData::CGData() : this_cgroup(0), coords0(0), ncoords(0), aabox(0)
{
}

/** Construct the data, telling it that it is at
    index 'this_idx' in the memory storage array */
CGData::CGData(quint32 this_idx) : this_cgroup(this_idx), coords0(0), ncoords(0), aabox(0)
{
}

/** Copy constructor */
CGData::CGData(const CGData &other)
    : this_cgroup(other.this_cgroup), coords0(other.coords0), ncoords(other.ncoords), aabox(other.aabox)
{
}
...
CGArrayArrayData *CGData::extract() const
{
    ...
    try
    {
        ...
        // copy the coordinates
        Vector *output = quickCopy<Vector>(new_array->coordsData(), this->coordsData(), this->nCoords());
...
/** Null constructor */
CoordGroupBase::CoordGroupBase() : d(::getSharedNullCoordGroup())
{
}
...
CoordGroupBase::CoordGroupBase(quint32 size, const Vector &value) : d(createCoordGroup(size))
{
...
CoordGroupBase::CoordGroupBase(quint32 size, const Vector *values) : d(createCoordGroup(size))
{
    if (size > 0)
    {
        Vector *coords = d->coordsData();
...
CoordGroupBase::CoordGroupBase(const CoordGroupArray &cgarray) : d(getSharedNullCoordGroup())
{
    ...
    else if (cgarray.nCoords() > 0)
    {
        ...
        Vector *coords = d->coordsData();
        Vector *output = quickCopy<Vector>(coords, cgarray.constCoordsData(), cgarray.nCoords());
...
CoordGroupBase::CoordGroupBase(const CoordGroupArrayArray &cgarrays) : d(getSharedNullCoordGroup())
{
    ...
    else if (cgarrays.nCoords() > 0)
    {
        ...
        Vector *coords = d->coordsData();
        Vector *output = quickCopy<Vector>(coords, cgarrays.constCoordsData(), cgarrays.nCoords());
...
CoordGroupBase::CoordGroupBase(const QVector<Vector> &coordinates) : d(createCoordGroup(coordinates.count()))
{
    ...
    if (ncoords > 0)
    {
        ...
        Vector *output = quickCopy<Vector>(coords, coordinates.constData(), ncoords);
...
/** Copy constructor - this is fast as CoordGroupBase is implicitly
    shared */
CoordGroupBase::CoordGroupBase(const CoordGroupBase &other) : d(other.d)
{
}
...
{
    if (sz != other)
        throw SireError::incompatible_error(QObject::tr("The number of coordinates in this group is %1, while "
...
void CoordGroupBase::assertValidIndex(quint32 i) const
{
    if (i >= quint32(this->size()))
        throw SireError::invalid_index(QObject::tr("Invalid index: %1 - maximum index == %2.").arg(i).arg(this->size()),
                                       CODELOC);
}
...
QDataStream &operator<<(QDataStream &ds, const CoordGroup &cgroup)
{
...
QDataStream &operator>>(QDataStream &ds, CoordGroup &cgroup)
{
...
CoordGroup::CoordGroup(quint32 size) : CoordGroupBase(size)
{
}

/** Construct a CoordGroup that holds 'size' coordinates,
    all of which have the value 'value' */
CoordGroup::CoordGroup(quint32 size, const Vector &value) : CoordGroupBase(size, value)
{
}

/** Construct a CoordGroup that holds the 'size' points
    copied from the array 'values' */
CoordGroup::CoordGroup(quint32 size, const Vector *values) : CoordGroupBase(size, values)
{
}

/** Construct a CoordGroup from all of the coordinates contained
    in the passed CoordGroup array */
CoordGroup::CoordGroup(const CoordGroupArray &cgarray) : CoordGroupBase(cgarray)
{
}

/** Construct a CoordGroup from all of the coordinates in the
    passed collection of CoordGroup arrays */
CoordGroup::CoordGroup(const CoordGroupArrayArray &cgarrays) : CoordGroupBase(cgarrays)
{
}

/** Construct a CoordGroup from the array of passed coordinates */
CoordGroup::CoordGroup(const QVector<Vector> &points) : CoordGroupBase(points)
{
}
...
CoordGroup::CoordGroup(const CoordGroupEditor &editor) : CoordGroupBase(editor)
{
}

/** Copy constructor */
CoordGroup::CoordGroup(const CoordGroup &other) : CoordGroupBase(other)
{
}
...
{
    throw SireError::invalid_state(QObject::tr("You can only split a CoordGroup into groups if the total number "
...
/** Null constructor */
CoordGroupEditor::CoordGroupEditor() : CoordGroupBase(), needsupdate(false)
{
}

/** Construct from a CoordGroup */
CoordGroupEditor::CoordGroupEditor(const CoordGroup &other) : CoordGroupBase(other), needsupdate(false)
{
    if (other.count() != 0)
...
CoordGroupEditor &CoordGroupEditor::setCoordinates(quint32 i, const Vector &newcoords)
{
    if (i >= quint32(this->count()))
        throw SireError::invalid_index(QObject::tr("Cannot update the coordinates of point %1 as the number "
...
CoordGroupEditor &CoordGroupEditor::changeFrame(const AxisSet &from_frame, const AxisSet &to_frame)
{
    int sz = this->count();
...
/** Map the coordinates of the ith point from the frame
    ...
    \throw SireError::invalid_index
*/
CoordGroupEditor &CoordGroupEditor::changeFrame(quint32 i, const AxisSet &from_frame, const AxisSet &to_frame)
{
    if (i >= quint32(this->count()))
        throw SireError::invalid_index(QObject::tr("Cannot update the coordinates of point %1 as the number "
                                                   "of points available is just %2.")
...
/** Serialise to a binary datastream */
QDataStream &operator<<(QDataStream &ds, const CoordGroupArray &cgarray)
{
...
/** Extract from a binary datastream */
QDataStream &operator>>(QDataStream &ds, CoordGroupArray &cgarray)
{
...
/** Null constructor */
CoordGroupArray::CoordGroupArray() : d(::getSharedNullCGArray())
{
}
...
CoordGroupArray::CoordGroupArray(const QVector<CoordGroup> &cgroups)
{
    ...
    for (int i = 0; i < cgroups.count(); ++i)
    {
        ...
        // copy the coordinates
        Vector *output = quickCopy<Vector>(coords, cgroup.constData(), cgroup.count());
...
CoordGroupArray::CoordGroupArray(const CoordGroupArray &array0, const CoordGroupArray &array1)
{
    if (array0.isEmpty())
        d = array1.d;
    ...
    {
        // now create space for the CoordGroups
        d = ::createCGArray(array0.nCoordGroups() + array1.nCoordGroups(), array0.nCoords() + array1.nCoords());

        CGArrayArrayData *cgarrayarray = (CGArrayArrayData *)(d->memory());

        cgarrayarray->setNCGroupsInArray(0, array0.nCoordGroups() + array1.nCoordGroups());
        ...
        {
            cgarrayarray->setNPointsInCGroup(array0.nCoordGroups() + i, array1.constData()[i].count());
        }
        ...
        // copy the coordinates
        {
            Vector *output = quickCopy<Vector>(coords, array0.constCoordsData(), array0.nCoords());

            BOOST_ASSERT(output == coords);

            coords += array0.nCoords();

            output = quickCopy<Vector>(coords, array1.constCoordsData(), array1.nCoords());
        ...
        // copy the AABoxes
        {
            AABox *output = quickCopy<AABox>(aabox, array0.constAABoxData(), array0.nCoordGroups());

            BOOST_ASSERT(output == aabox);

            aabox += array0.nCoordGroups();

            output = quickCopy<AABox>(aabox, array1.constAABoxData(), array1.nCoordGroups());
...
/** Copy constructor */
CoordGroupArray::CoordGroupArray(const CoordGroupArray &other) : d(other.d)
{
}
...
{
    if (i >= d->nCGroups())
        throw SireError::invalid_index(QObject::tr("Cannot access the CoordGroup at index %1. The number "
...
{
    if (i >= d->nCoords())
        throw SireError::invalid_index(QObject::tr("Cannot access the coordinate at index %1. The number "
...
void CoordGroupArray::remove(quint32 start, int count)
{
    ...
    {
        throw SireError::invalid_index(QObject::tr("Cannot remove elements %1 to %2 as this is an invalid index "
                                                   "range for a CoordGroupArray of size %3.")
                                           .arg(start)
                                           .arg(start + count)
                                           .arg(this->nCoordGroups()),
                                       CODELOC);
    }
...
void CoordGroupArray::remove(const QVarLengthArray<quint32> &idxs)
{
    ...
    for (int i = 0; i < idxs.count(); ++i)
    {
        if (int(idxs[i]) >= this->nCoordGroups())
            throw SireError::invalid_index(QObject::tr("The list of indexes contains an invalid index (%1). "
...
void CoordGroupArray::update(quint32 i, const Vector *coords, int ncoords)
{
    ...
    if (cgdata->nCoords() != quint32(ncoords))
        throw SireError::incompatible_error(QObject::tr("Cannot update the CoordGroup at index %1 as this CoordGroup "
...
void CoordGroupArray::update(quint32 i, const CoordGroup &cgroup)
{
    ...
    Vector *output = quickCopy<Vector>(coords, cgroup.constData(), cgdata->nCoords());
...
void CoordGroupArray::rotate(const Matrix &rotmat, const Vector &point)
{
    ...
    for (quint32 i = 0; i < n; ++i)
    {
        *(const_cast<CGData *>(cgroups[i].d.constData())->aaBox()) = AABox(cgroups[i]);
    }
}
...
void CoordGroupArray::changeFrame(const AxisSet &from_frame, const AxisSet &to_frame)
{
    Vector *coords = d->coordsData();
    quint32 n = d.constData()->nCoords();
...
/** Change all of the coordinates in the ith CoordGroup from
    ...
    \throw SireError::invalid_index
*/
void CoordGroupArray::changeFrame(quint32 i, const AxisSet &from_frame, const AxisSet &to_frame)
{
    this->assertValidCoordGroup(i);
...
QDataStream &operator<<(QDataStream &ds, const CGSharedPtr<CGArrayArrayData> &d)
{
    const CGArrayArrayData &array = *d;

    // serialise the prime metadata
    ds << quint32(array.nCGArrays()) << quint32(array.nCGroups()) << quint32(array.nCoords());
...
static CGSharedPtr<CGArrayArrayData> createCGArrayArray(quint32 narrays, quint32 ngroups, quint32 ncoords)
{
    if (narrays == 0)
...
QDataStream &operator>>(QDataStream &ds, CGSharedPtr<CGArrayArrayData> &d)
{
    ...
    CGSharedPtr<CGArrayArrayData> d2 = createCGArrayArray(ncgarrays, ncgroups, ncoords);
...
SharedDataStream &operator<<(SharedDataStream &sds, const CGSharedPtr<CGArrayArrayData> &d)
{
...
SharedDataStream &operator>>(SharedDataStream &sds, CGSharedPtr<CGArrayArrayData> &d)
{
...
/** Serialise to a binary datastream */
QDataStream &operator<<(QDataStream &ds, const CoordGroupArrayArray &cgarray)
{
...
/** Extract from a binary datastream */
QDataStream &operator>>(QDataStream &ds, CoordGroupArrayArray &cgarray)
{
...
CoordGroupArrayArray::CoordGroupArrayArray() : d(::getSharedNull())
{
}

/** Construct an array that contains just the CoordGroup 'cgroup'
    (in a single array that contains this group) */
CoordGroupArrayArray::CoordGroupArrayArray(const CoordGroup &cgroup) : d(cgroup.d->extract())
{
}

/** Construct an array that contains just the CoordGroupArray 'cgarray' */
CoordGroupArrayArray::CoordGroupArrayArray(const CoordGroupArray &cgarray) : d(cgarray.d->extract())
{
}
...
CoordGroupArrayArray::CoordGroupArrayArray(const QVector<CoordGroupArray> &cgarrays)
{
    ...
    for (quint32 i = 0; i < narrays; ++i)
    {
        ...
        {
            Vector *output = quickCopy<Vector>(coords, cgarray.coordsData(), cgarray.nCoords());
        ...
        {
            AABox *output = quickCopy<AABox>(aaboxes, cgarray.aaBoxData(), cgarray.nCoordGroups());
...
CoordGroupArrayArray::CoordGroupArrayArray(const QVector<QVector<CoordGroup>> &cgarrays)
{
    // count the number of arrays, groups and coords
    quint32 narrays = cgarrays.count();
    quint32 ngroups = 0;
...
CoordGroupArrayArray::CoordGroupArrayArray(const QVector<QVector<QVector<Vector>>> &points)
{
    if (points.isEmpty())
        return;
...
/** Copy constructor */
CoordGroupArrayArray::CoordGroupArrayArray(const CoordGroupArrayArray &other) : d(other.d)
{
}
...
/** Copy assignment operator */
CoordGroupArrayArray &CoordGroupArrayArray::operator=(const CoordGroupArrayArray &other)
{
    d = other.d;
    return *this;
}
...
{
    if (i >= d->nCGArrays())
        throw SireError::invalid_index(QObject::tr("Cannot access the CoordGroupArray at index %1. The "
...
{
    if (i >= d->nCGroups())
        throw SireError::invalid_index(QObject::tr("Cannot access the CoordGroup at index %1. The "
...
{
    if (i >= d->nCoords())
        throw SireError::invalid_index(QObject::tr("Cannot access the coordinate at index %1. The "
...
void CoordGroupArrayArray::update(quint32 i, const CoordGroupArray &array)
{
    ...
    if (n != quint32(array.count()))
        throw SireError::incompatible_error(QObject::tr("Cannot update the CoordGroupArray at index %1 as "
    ...
    {
        if (cgarraydata->cGroupData()[j].count() != new_cgarray->cGroupData()[j].count())
        {
            throw SireError::incompatible_error(QObject::tr("Cannot update the CoordGroupArray at index %1 as "
                                                    ...
                                                    .arg(new_cgarray->cGroupData()[j].count()),
                                                CODELOC);
        }
    }
    ...
    AABox *output = quickCopy<AABox>(cgarraydata->aaBoxData(), new_cgarray->aaBoxData(), cgarraydata->nCGroups());

    BOOST_ASSERT(output == cgarraydata->aaBoxData());

    Vector *out2 = quickCopy<Vector>(cgarraydata->coordsData(), new_cgarray->coordsData(), cgarraydata->nCoords());
...
void CoordGroupArrayArray::update(quint32 i, quint32 j, const CoordGroup &cgroup)
{
    ...
    if (j >= cgarraydata->nCGroups())
        throw SireError::invalid_index(QObject::tr("There is no CoordGroup at index %1 in the array at "
                                                   "index %2. The number of CoordGroups in this array "
                                                   "is %3.")
                                           .arg(j)
                                           .arg(i)
                                           .arg(cgarraydata->nCGroups()),
                                       CODELOC);

    CGData *cgdata = const_cast<CGData *>(cgarraydata->cGroupData()[j].d.constData());

    if (cgdata->nCoords() != quint32(cgroup.count()))
        throw SireError::incompatible_error(QObject::tr("Cannot update the CoordGroup at index %1 in the array "
    ...
    *(cgdata->aaBox()) = cgroup.aaBox();
    ...
    Vector *output = quickCopy<Vector>(cgdata->coordsData(), cgroup.constData(), cgdata->nCoords());
...
void CoordGroupArrayArray::assertValidCoordGroup(quint32 i, quint32 j) const
{
    ...
    if (j >= quint32(d->cgArrayData()[i].nCoordGroups()))
        throw SireError::invalid_index(QObject::tr("There is no CoordGroup at index %1 in the CoordGroupArray "
                                                   "at index %2. The number of CoordGroups in this array is %3.")
                                           .arg(j)
                                           .arg(i)
                                           .arg(d->cgArrayData()[i].nCoordGroups()),
                                       CODELOC);
}
...
/** Rotate all of the points in the ith array using the matrix 'rotmat'
    ...
    \throw SireError::invalid_index
*/
void CoordGroupArrayArray::rotate(quint32 i, const Matrix &rotmat, const Vector &point)
{
    this->assertValidCoordGroupArray(i);
...
/** Rotate all of the points in the ith array using the quaternion 'quat'
    ...
    \throw SireError::invalid_index
*/
void CoordGroupArrayArray::rotate(quint32 i, const Quaternion &quat, const Vector &point)
{
    this->rotate(i, quat.toMatrix(), point);
}
...
/** Rotate all of the points in the jth CoordGroup in the
    ...
    \throw SireError::invalid_index
*/
void CoordGroupArrayArray::rotate(quint32 i, quint32 j, const Matrix &rotmat, const Vector &point)
{
    this->assertValidCoordGroup(i, j);
...
/** Rotate all of the points in the jth CoordGroup in the
    ...
    \throw SireError::invalid_index
*/
void CoordGroupArrayArray::rotate(quint32 i, quint32 j, const Quaternion &quat, const Vector &point)
{
...
void CoordGroupArrayArray::changeFrame(const AxisSet &from_frame, const AxisSet &to_frame)
{
    Vector *coords = d->coordsData();
    quint32 n = d.constData()->nCoords();
...
/** Map all of the points in this array from the coordinate frame
    ...
    \throw SireError::invalid_index
*/
void CoordGroupArrayArray::changeFrame(quint32 i, const AxisSet &from_frame, const AxisSet &to_frame)
{
    this->assertValidCoordGroupArray(i);
...
/** Map all of the points in the CoordGroup at index j in the
    ...
    \throw SireError::invalid_index
*/
void CoordGroupArrayArray::changeFrame(quint32 i, quint32 j, const AxisSet &from_frame, const AxisSet &to_frame)
{
    this->assertValidCoordGroup(i, j);

...
namespace SireVol
{
    ...
    */
    class SIREVOL_EXPORT CombinedSpace : public SireBase::ConcreteProperty<CombinedSpace, Space>
    {
    ...
    public:
        ...
        double calcDist(const CoordGroup &group, const Vector &point, DistMatrix &distmat) const;

        double calcDist2(const CoordGroup &group, const Vector &point, DistMatrix &distmat) const;

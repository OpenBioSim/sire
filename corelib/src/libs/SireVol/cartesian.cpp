...
{
    writeHeader(ds, r_cartesian, 1) << static_cast<const Space &>(cart);
...
/** Copy constructor */
Cartesian::Cartesian(const Cartesian &other) : ConcreteProperty<Cartesian, Space>(other)
{
}
...
{
    throw SireVol::incompatible_space(QObject::tr("It is not possible to calculate the volume of an infinite space!"),
                                      CODELOC);
...
{
    throw SireVol::incompatible_space(QObject::tr("It is not possible to change the volume of an infinite space!"),
                                      CODELOC);
...
/** Populate the matrix 'mat' with the distances between all of the
    ...
    CoordGroups. */
double Cartesian::calcDist(const CoordGroup &group0, const CoordGroup &group1, DistMatrix &mat) const
{
    double mindist(std::numeric_limits<double>::max());
...
double Cartesian::calcDist(const CoordGroup &group, const Vector &point, DistMatrix &mat) const
{
    double mindist(std::numeric_limits<double>::max());
...
/** Populate the matrix 'mat' with the distances squared between all of the
    points of the passed CoordGroup and 'point'. Returns the shortest distance. */
double Cartesian::calcDist2(const CoordGroup &group, const Vector &point, DistMatrix &mat) const
{
    double mindist2(std::numeric_limits<double>::max());
...
/** Populate the matrix 'mat' with the distances^2 between all of the
    ...
    two CoordGroups. */
double Cartesian::calcDist2(const CoordGroup &group0, const CoordGroup &group1, DistMatrix &mat) const
{
    double mindist2(std::numeric_limits<double>::max());
...
/** Populate the matrix 'mat' with the inverse distances between all of the
    ...
    the two CoordGroups. */
double Cartesian::calcInvDist(const CoordGroup &group0, const CoordGroup &group1, DistMatrix &mat) const
{
    double maxinvdist(0);
    double tmpdist;
...
/** Populate the matrix 'mat' with the inverse distances^2 between all of the
    points of the two CoordGroups. Return the shortest distance between
    the two CoordGroups. */
double Cartesian::calcInvDist2(const CoordGroup &group0, const CoordGroup &group1, DistMatrix &mat) const
{
...
DistVector Cartesian::calcDistVector(const Vector &point0, const Vector &point1) const
{
...
double Cartesian::calcDistVectors(const CoordGroup &group, DistVectorMatrix &mat) const
{
    double mindist = std::numeric_limits<double>::max();
...
double Cartesian::calcDistVectors(const CoordGroup &group0, const CoordGroup &group1, DistVectorMatrix &mat) const
{
    double mindist = std::numeric_limits<double>::max();
...
double Cartesian::calcDistVectors(const CoordGroup &group, const Vector &point, DistVectorMatrix &mat) const
{
    double mindist = std::numeric_limits<double>::max();
...
Angle Cartesian::calcAngle(const Vector &point0, const Vector &point1, const Vector &point2) const
{
...
/** Calculate the torsion angle between the passed four points. This should
    ...
    degrees */
Angle Cartesian::calcDihedral(const Vector &point0, const Vector &point1, const Vector &point2,
...
bool Cartesian::beyond(double dist, const CoordGroup &group0, const CoordGroup &group1) const
{
...
/** Return the minimum image copy of 'groups' with respect to 'center'.
    In this case, as this is not a periodic space, this just returns
    'groups' */
CoordGroupArray Cartesian::getMinimumImage(const CoordGroupArray &groups, const Vector &, bool) const
{
    return groups;
}
...
QVector<Vector> Cartesian::getImagesWithin(const Vector &point, const Vector &center, double dist) const
{
...
QList<tuple<double, CoordGroup>> Cartesian::getCopiesWithin(const CoordGroup &group, const CoordGroup &center,
                                                            double dist) const
{
...
Vector Cartesian::getRandomPoint(const Vector &, const RanGenerator &generator) const
{
    ...
    return Vector(generator.rand(min_rand, max_rand), generator.rand(min_rand, max_rand),

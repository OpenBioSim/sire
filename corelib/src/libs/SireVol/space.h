    ...
    */
    ...
    public:
        ...
        /** Populate the matrix 'mat' with the distances between all of the
            ...
            CoordGroups. */
        virtual double calcDist(const CoordGroup &group1, const CoordGroup &group2, DistMatrix &distmat) const = 0;
        ...
        virtual double calcDist(const CoordGroup &group, const Vector &point, DistMatrix &distmat) const = 0;

        /** Populate the matrix 'distmat' with the distances squared between all of the
            points in 'group' to the point 'point'. This returns the shortest
            distance between the group points and 'point' */
        virtual double calcDist2(const CoordGroup &group, const Vector &point, DistMatrix &distmat) const = 0;

        /** Populate the matrix 'mat' with the distances^2 between all of the
            points of the two CoordGroups. Return the shortest distance^2 between the
            two CoordGroups. */
        virtual double calcDist2(const CoordGroup &group1, const CoordGroup &group2, DistMatrix &distmat) const = 0;

        /** Populate the matrix 'mat' with the inverse distances between all of the
            points of the two CoordGroups. Return the largest inverse distance between the two
            CoordGroups. */
        virtual double calcInvDist(const CoordGroup &group1, const CoordGroup &group2, DistMatrix &distmat) const = 0;

        /** Populate the matrix 'mat' with the inverse distances^2 between all of the
            points of the two CoordGroups. Return the largest inverse distance^2 between the two
            CoordGroups. */
        virtual double calcInvDist2(const CoordGroup &group1, const CoordGroup &group2, DistMatrix &distmat) const = 0;

        /** Calculate the distance vector between two points */
        virtual DistVector calcDistVector(const Vector &point0, const Vector &point1) const = 0;
        ...
        virtual double calcDistVectors(const CoordGroup &group, DistVectorMatrix &distmat) const = 0;
        ...
        virtual double calcDistVectors(const CoordGroup &group1, const CoordGroup &group2,
                                       DistVectorMatrix &distmat) const = 0;

        /** Populate the matrix 'distmat' with the distances between all of the
            points in 'group' to the point 'point'. This returns the shortest
            distance between the group points and 'point' */
        virtual double calcDistVectors(const CoordGroup &group, const Vector &point, DistVectorMatrix &distmat) const = 0;
        ...
        virtual SireUnits::Dimension::Angle calcAngle(const Vector &point0, const Vector &point1,
        ...
        /** Calculate the torsion angle between the passed four points. This should
            ...
            degrees */
        virtual SireUnits::Dimension::Angle calcDihedral(const Vector &point0, const Vector &point1, const Vector &point2,
        ...
        */
        virtual bool beyond(double dist, const CoordGroup &group0, const CoordGroup &group1) const = 0;
        ...
        */
        ...
        virtual Vector getRandomPoint(const Vector &center, const RanGenerator &generator) const = 0;
        ...
        /** Return the minimum image copy of 'group' with respect to 'center'.
            ...
            has its center at 'center' (i.e. returns the closest copy of
            'group' to 'center' according to the minimum image convention) */
        virtual CoordGroup getMinimumImage(const CoordGroup &group, const Vector &center) const = 0;
        ...
        virtual CoordGroupArray getMinimumImage(const CoordGroupArray &groups, const Vector &center,
        ...
        */
        virtual QList<boost::tuple<double, CoordGroup>> getCopiesWithin(const CoordGroup &group, const CoordGroup &center,
                                                                        double dist) const = 0;

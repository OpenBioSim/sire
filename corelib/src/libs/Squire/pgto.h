...
namespace Squire
{
    ...
    public:
        PS_GTO();
        PS_GTO(const Vector &A, const S_GTO &a, const Vector &B, const P_GTO &b);
        PS_GTO(const Vector &A, const P_GTO &a, const Vector &B, const S_GTO &b);
    ...
    public:
        PP_GTO();
        PP_GTO(const Vector &A, const P_GTO &a, const Vector &B, const P_GTO &b);
    ...
    */
    ...
    public:
        ...
        PS_GTOs(const QVector<S_GTO> &s_gtos, const QVector<Vector> &s_centers, const QVector<P_GTO> &p_gtos,
                const QVector<Vector> &p_centers);

        PS_GTOs(const QVector<P_GTO> &p_gtos, const QVector<Vector> &p_centers, const QVector<S_GTO> &s_gtos,
    ...
    private:
        void _pvt_create(const QVector<S_GTO> &s_gtos, const QVector<Vector> &s_centers, const QVector<P_GTO> &p_gtos,
                         const QVector<Vector> &p_centers);
    ...
    public:
        ...
        PP_GTOs(const QVector<P_GTO> &p_gtos, const QVector<Vector> &p_centers);
    ...
    SQUIRE_EXPORT void electron_integral(const PP_GTO &P, const PS_GTO &Q, SireBase::Array2D<Vector> &matrix);

    SQUIRE_EXPORT void electron_integral(const PS_GTO &P, const PP_GTO &Q, SireBase::Array2D<Vector> &matrix);

    SQUIRE_EXPORT SireBase::Array2D<Matrix> electron_integral(const PP_GTO &P, const PP_GTO &Q);

    SQUIRE_EXPORT void electron_integral(const PP_GTO &P, const PP_GTO &Q, SireBase::Array2D<Matrix> &matrix);
    ...
    SQUIRE_EXPORT SireBase::Array2D<Vector> electron_integral(const PP_GTO &P, const PS_GTO &Q, int m);
    SQUIRE_EXPORT SireBase::Array2D<Vector> electron_integral(const PS_GTO &P, const PP_GTO &Q, int m);

    SQUIRE_EXPORT void electron_integral(const PP_GTO &P, const PS_GTO &Q, int m, SireBase::Array2D<Vector> &matrix);

    SQUIRE_EXPORT void electron_integral(const PS_GTO &P, const PP_GTO &Q, int m, SireBase::Array2D<Vector> &matrix);

    SQUIRE_EXPORT SireBase::Array2D<Matrix> electron_integral(const PP_GTO &P, const PP_GTO &Q, int m);

    SQUIRE_EXPORT void electron_integral(const PP_GTO &P, const PP_GTO &Q, int m, SireBase::Array2D<Matrix> &matrix);

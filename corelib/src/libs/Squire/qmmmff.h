...
namespace Squire
{
    ...
    /** This class provides the default names of the element,
        ...
        QMMMPotential
    */
    class SQUIRE_EXPORT ChargeElementParameterNames3D : public ElementParameterName,
                                                        public SireMM::ChargeParameterName,
                                                        public SireFF::detail::Coords3DParameterName
    {
    public:
        ChargeElementParameterNames3D()
            : ElementParameterName(), SireMM::ChargeParameterName(), SireFF::detail::Coords3DParameterName()
        {
        }
    ...
    */
    class SQUIRE_EXPORT QMMMFF : public SireBase::ConcreteProperty<QMMMFF, SireFF::G2FF>,
                                 public SireFF::FF3D,

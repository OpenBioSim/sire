...
namespace parser_idengine
{
    ...
    */
    ...
    private:
        ...
        SelectResult searchMolIdx(const SelectResult &mols, const SelectResult &context, bool use_parallel) const;
    ...
    */
    ...
    {
    public:
        static SelectEnginePtr construct(const IDObject &name, const QString &property, const IDComparison &compare,
                                         const QString &value);
    ...
    {
    public:
        static SelectEnginePtr construct(IDBondToken from_token, SelectEnginePtr from_value, IDBondToken to_token,
    ...
    */
    ...
    {
    public:
        static SelectEnginePtr construct(SelectEnginePtr part0, IDToken token, SelectEnginePtr part1);
        ~IDWithEngine();
    ...
    */
    ...
    {
    public:
        static SelectEnginePtr construct(SelectEnginePtr part0, SireUnits::Dimension::Length distance,
                                         SelectEnginePtr part1);

        static SelectEnginePtr construct(SelectEnginePtr part0, IDCoordType typ, SireUnits::Dimension::Length distance,
                                         SelectEnginePtr part1);
    ...
    */
    ...
    {
    public:
        static SelectEnginePtr construct(SelectEnginePtr value0, SireUnits::Dimension::Length distance,
                                         VectorValue position);

        static SelectEnginePtr construct(SelectEnginePtr value0, IDCoordType typ, SireUnits::Dimension::Length distance,
                                         VectorValue position);

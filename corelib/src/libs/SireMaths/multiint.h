...
#define MULTIINT_BINONE getBinaryOne()
...
#else
        return MultiInt(_mm_cmpeq_epi32(v.x[0], other.v.x[0]), _mm_cmpeq_epi32(v.x[1], other.v.x[1]));
#endif
#else
#ifdef MULTIFLOAT_SSE_IS_AVAILABLE
    ...
    MultiInt MultiInt::compareLess(const MultiInt &other) const
    {
        ...
        return ret;
#else
        return MultiInt(_mm_cmplt_epi32(v.x[0], other.v.x[0]), _mm_cmplt_epi32(v.x[1], other.v.x[1]));
#endif
#else
#ifdef MULTIFLOAT_SSE_IS_AVAILABLE
...
#else
        return MultiInt(_mm_cmpgt_epi32(v.x[0], other.v.x[0]), _mm_cmpgt_epi32(v.x[1], other.v.x[1]));
#endif
#else
#ifdef MULTIFLOAT_SSE_IS_AVAILABLE
...
#else
        return MultiInt(_mm_add_epi32(v.x[0], other.v.x[0]), _mm_add_epi32(v.x[1], other.v.x[1]));
#endif
#else
#ifdef MULTIFLOAT_SSE_IS_AVAILABLE
...
#else
        return MultiInt(_mm_sub_epi32(v.x[0], other.v.x[0]), _mm_sub_epi32(v.x[1], other.v.x[1]));
#endif
#else
#ifdef MULTIFLOAT_SSE_IS_AVAILABLE
...
#else
        return MultiInt(_mm_and_si128(v.x[0], other.v.x[0]), _mm_and_si128(v.x[1], other.v.x[1]));
#endif
#else
#ifdef MULTIFLOAT_SSE_IS_AVAILABLE
...
#ifdef MULTIFLOAT_AVX_IS_AVAILABLE
#ifdef MULTIFLOAT_AVX2_IS_AVAILABLE
        return MultiFloat(_mm256_and_ps(v.x, *(reinterpret_cast<const __m256 *>(&(other.v.x)))));
#else
        // allowable as other.v.x is 32bit aligned
        return MultiFloat(_mm256_and_ps(v.x, *(reinterpret_cast<const __m256 *>(&(other.v.x[0])))));
#endif
#else
#ifdef MULTIFLOAT_SSE_IS_AVAILABLE
...
#else
        return MultiInt(_mm_andnot_si128(v.x[0], other.v.x[0]), _mm_andnot_si128(v.x[1], other.v.x[1]));
#endif
#else
#ifdef MULTIFLOAT_SSE_IS_AVAILABLE
...
#else
        return MultiInt(_mm_or_si128(v.x[0], other.v.x[0]), _mm_or_si128(v.x[1], other.v.x[1]));
#endif
#else
#ifdef MULTIFLOAT_SSE_IS_AVAILABLE
...
#else
        return MultiInt(_mm_xor_si128(v.x[0], other.v.x[0]), _mm_xor_si128(v.x[1], other.v.x[1]));
#endif
#else
#ifdef MULTIFLOAT_SSE_IS_AVAILABLE

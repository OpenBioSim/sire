...
namespace SireMaths
{
    ...
    */
    class SIREMATHS_EXPORT FreeEnergyAverage : public SireBase::ConcreteProperty<FreeEnergyAverage, ExpAverage>
    {
    ...
    public:
        ...
        FreeEnergyAverage(const SireUnits::Dimension::Temperature &temperature, bool forwards_free_energy = true);

        FreeEnergyAverage(const SireUnits::Dimension::MolarEnergy &binwidth, bool forwards_free_energy = true);

        FreeEnergyAverage(const SireUnits::Dimension::Temperature &temperature,
                          const SireUnits::Dimension::MolarEnergy &binwidth, bool forwards_free_energy = true);
    ...
    */
    ...
    public:
        ...
        BennettsFreeEnergyAverage(const SireUnits::Dimension::Temperature &temperature, bool forwards_free_energy = true);

        BennettsFreeEnergyAverage(const SireUnits::Dimension::MolarEnergy &constant,
                                  const SireUnits::Dimension::Temperature &temperature, bool forwards_free_energy = true);

        BennettsFreeEnergyAverage(const SireUnits::Dimension::MolarEnergy &constant, bool forwards_free_energy = true);

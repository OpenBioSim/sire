...
#else
        return MultiUInt(_mm_cmpeq_epi32(v.x[0], other.v.x[0]), _mm_cmpeq_epi32(v.x[1], other.v.x[1]));
#endif
#else
#ifdef MULTIFLOAT_SSE_IS_AVAILABLE
...
#else
        return MultiUInt(_mm_add_epi32(v.x[0], other.v.x[0]), _mm_add_epi32(v.x[1], other.v.x[1]));
#endif
#else
#ifdef MULTIFLOAT_SSE_IS_AVAILABLE
...
#else
        return MultiUInt(_mm_sub_epi32(v.x[0], other.v.x[0]), _mm_sub_epi32(v.x[1], other.v.x[1]));
#endif
#else
#ifdef MULTIFLOAT_SSE_IS_AVAILABLE
...
#else
        return MultiUInt(_mm_and_si128(v.x[0], other.v.x[0]), _mm_and_si128(v.x[1], other.v.x[1]));
#endif
#else
#ifdef MULTIFLOAT_SSE_IS_AVAILABLE
...
#else
        return MultiUInt(_mm_andnot_si128(v.x[0], other.v.x[0]), _mm_andnot_si128(v.x[1], other.v.x[1]));
#endif
#else
#ifdef MULTIFLOAT_SSE_IS_AVAILABLE
...
#else
        return MultiUInt(_mm_or_si128(v.x[0], other.v.x[0]), _mm_or_si128(v.x[1], other.v.x[1]));
#endif
#else
#ifdef MULTIFLOAT_SSE_IS_AVAILABLE
...
#else
        return MultiUInt(_mm_xor_si128(v.x[0], other.v.x[0]), _mm_xor_si128(v.x[1], other.v.x[1]));
#endif
#else
#ifdef MULTIFLOAT_SSE_IS_AVAILABLE

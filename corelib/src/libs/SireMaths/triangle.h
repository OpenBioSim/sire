...
namespace SireMaths
{
    ...
    */
    ...
    SIRE_ALWAYS_INLINE int Triangle::count() const
    {
        return 3;
    }

    /** Return the i'th point */
    SIRE_ALWAYS_INLINE const Vector &Triangle::point(int i) const
    {
        return points[i % 3];
    }

    /** Return the i'th point */
    SIRE_ALWAYS_INLINE const Vector &Triangle::at(int i) const
    {
        return point(i);
    }

    /** Return the i'th point */
    SIRE_ALWAYS_INLINE const Vector &Triangle::operator[](int i) const
    {
        return point(i);
    }

    /** Return the line of the triangle opposite point0 (from point 1 -> 2) */
    SIRE_ALWAYS_INLINE Line Triangle::line0() const
    {
        return Line(points[1], points[2]);
    }

    /** Return the line of the triangle opposite point1 (from point 2 -> 0) */
    SIRE_ALWAYS_INLINE Line Triangle::line1() const
    {
        return Line(points[2], points[0]);
    }

    /** Return the line of the triangle opposite point2 (from point 0 -> 1) */
    SIRE_ALWAYS_INLINE Line Triangle::line2() const
    {
        return Line(points[0], points[1]);
    }

    /** Return the vector representing length0 */
    SIRE_ALWAYS_INLINE Vector Triangle::vector0() const
    {
        return line0().vector();
    }

    /** Return the vector representing length0 */
    SIRE_ALWAYS_INLINE Vector Triangle::vector1() const
    {
        return line1().vector();
    }

    /** Return the vector representing length0 */
    SIRE_ALWAYS_INLINE Vector Triangle::vector2() const
    {
        return line2().vector();
    }

    /** Return the vector that is perpendicular to the plane of this triangle */
    SIRE_ALWAYS_INLINE Vector Triangle::vector() const
    {
        return Vector::cross(vector0(), vector2());
    }

    /** Return the angle at point0 (i.e. the angle point2-point0-point1) (< 180 degrees) */
    SIRE_ALWAYS_INLINE Angle Triangle::angle0() const
    {
    ...
    SIRE_ALWAYS_INLINE Angle Triangle::angle1() const
    {
    ...
    SIRE_ALWAYS_INLINE Angle Triangle::angle2() const
    {
    ...
    SIRE_ALWAYS_INLINE Angle Triangle::angle() const
    {
        return this->angle1();
    }

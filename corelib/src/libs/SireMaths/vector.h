...
namespace SireMaths
{
    ...
    */
    ...
    public:
        ...
        static Angle dihedral(const Vector &v0, const Vector &v1, const Vector &v2, const Vector &v3);

        static Vector generate(double dst, const Vector &v1, const Angle &ang, const Vector &v2, const Angle &dih,
                               const Vector &v3);

        static Vector generate(Length dst, const Vector &v1, const Angle &ang, const Vector &v2, const Angle &dih,
                               const Vector &v3);
    ...
    SIRE_ALWAYS_INLINE bool Vector::operator!=(const Vector &other) const
    {
        return &other != this and (sc[0] != other.sc[0] or sc[1] != other.sc[1] or sc[2] != other.sc[2]);
    }

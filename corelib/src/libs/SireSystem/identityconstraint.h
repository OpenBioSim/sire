...
namespace SireSystem
{
    ...
    */
    class SIRESYSTEM_EXPORT IdentityConstraint : public SireBase::ConcreteProperty<IdentityConstraint, MoleculeConstraint>
    {
    ...
    public:
        ...
        IdentityConstraint(const MoleculeGroup &molgroup, const PropertyMap &map = PropertyMap());

        IdentityConstraint(const SireFF::PointRef &point, const MoleculeGroup &molgroup,
                           const PropertyMap &map = PropertyMap());

        IdentityConstraint(const QList<SireFF::PointPtr> &points, const MoleculeGroup &molgroup,
                           const PropertyMap &map = PropertyMap());

        IdentityConstraint(const QVector<SireFF::PointPtr> &points, const MoleculeGroup &molgroup,
                           const PropertyMap &map = PropertyMap());
        ...
        static SireMol::MolGroupPtr constrain(const MoleculeGroup &molgroup, const SireFF::PointRef &point,
                                              const PropertyMap &map = PropertyMap());

        static SireMol::MolGroupPtr constrain(const MoleculeGroup &molgroup, const QVector<SireFF::PointPtr> &points,
                                              const PropertyMap &map = PropertyMap());

        static SireMol::MolGroupPtr constrain(const MoleculeGroup &molgroup, const QList<SireFF::PointPtr> &points,
                                              const PropertyMap &map = PropertyMap());

...
namespace SireSystem
{
    ...
    */
    ...
    public:
        ...
        CloseMols(const SireFF::PointRef &point, const MoleculeGroup &molgroup, int nclosest = 1,
                  const PropertyMap &map = PropertyMap());

        CloseMols(const SireFF::PointRef &point, const MoleculeGroup &molgroup, const Space &space, int nclosest = 1,
                  const PropertyMap &map = PropertyMap());
    ...
    private:
        ...
        void updateData(const System &system, bool &point_changed, bool &space_changed, bool &molgroup_major_changed,

...
namespace SireSystem
{
    ...
    */
    class SIRESYSTEM_EXPORT EnergyMonitor : public SireBase::ConcreteProperty<EnergyMonitor, SystemMonitor>
    {
    ...
    public:
        EnergyMonitor();
        EnergyMonitor(const MoleculeGroup &group0, const MoleculeGroup &group1);

        EnergyMonitor(const MoleculeGroup &group0, const MoleculeGroup &group1, const SireMaths::Accumulator &accum);

        EnergyMonitor(const MoleculeGroup &group0, const IDAssigner &group1);

        EnergyMonitor(const MoleculeGroup &group0, const IDAssigner &group1, const SireMaths::Accumulator &accum);

        EnergyMonitor(const IDAssigner &group0, const MoleculeGroup &group1);

        EnergyMonitor(const IDAssigner &group0, const MoleculeGroup &group1, const SireMaths::Accumulator &accum);

        EnergyMonitor(const IDAssigner &group0, const IDAssigner &group1);

        EnergyMonitor(const IDAssigner &group0, const IDAssigner &group1, const SireMaths::Accumulator &accum);

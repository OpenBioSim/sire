...
namespace SireSystem
{
    ...
    */
    ...
    public:
        ...
        QList<MolNum> changedMoleculesSince(const Molecules &molecules, quint32 subversion) const;
        ...
        bool update(const QString &property, const QList<FFIdx> &ffidxs, const Property &value);

        bool update(const PropertyName &property, const Property &value);
        bool update(const PropertyName &property, const FFID &ffid, const Property &value);
        bool update(const PropertyName &property, const QList<FFIdx> &ffidxs, const Property &value);

...
namespace SireSystem
{
    ...
    */
    class SIRESYSTEM_EXPORT IDAssigner : public SireBase::ConcreteProperty<IDAssigner, SireBase::Property>
    {
    ...
    public:
        ...
        IDAssigner(const PointRef &point, const MoleculeGroup &molgroup, const PropertyMap &map = PropertyMap());

        IDAssigner(const QVector<SireFF::PointPtr> &points, const MoleculeGroup &molgroup,
                   const PropertyMap &map = PropertyMap());

        IDAssigner(const PointRef &point, const MoleculeGroup &molgroup, const SireVol::Space &space,
                   const PropertyMap &map = PropertyMap());

        IDAssigner(const QVector<SireFF::PointPtr> &points, const MoleculeGroup &molgroup, const SireVol::Space &space,
                   const PropertyMap &map = PropertyMap());

...
namespace SireSystem
{
    ...
    */
    class SIRESYSTEM_EXPORT MonitorComponents : public SireBase::ConcreteProperty<MonitorComponents, SystemMonitor>
    {
    ...
    public:
        ...
        MonitorComponents(const Symbol &component, const Accumulator &accumulator = Average());
        MonitorComponents(const Symbols &components, const Accumulator &accumulator = Average());

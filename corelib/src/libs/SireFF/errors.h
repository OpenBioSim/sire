...
namespace SireFF
{
    ...
    */
    ...
    public:
        ...
        missing_component(QString err, QString place = QString()) : sireff_error(err, place)
        {
        }
    ...
    */
    ...
    public:
        ...
        missing_function(QString err, QString place = QString()) : sireff_error(err, place)
        {
        }
    ...
    */
    ...
    public:
        ...
        missing_forcefield(QString err, QString place = QString()) : sireff_error(err, place)
        {
        }
    ...
    */
    ...
    public:
        ...
        missing_parameter(QString err, QString place = QString()) : sireff_error(err, place)
        {
        }
    ...
    */
    ...
    public:
        ...
        missing_derivative(QString err, QString place = QString()) : sireff_error(err, place)
        {
        }
    ...
    */
    ...
    public:
        ...
        duplicate_forcefield(QString err, QString place = QString()) : sireff_error(err, place)
        {
        }
    ...
    */
    ...
    public:
        ...
        duplicate_component(QString err, QString place = QString()) : sireff_error(err, place)
        {
        }
    ...
    */
    ...
    public:
        ...
        duplicate_function(QString err, QString place = QString()) : sireff_error(err, place)
        {
        }
    ...
    */
    ...
    public:
        ...
        invalid_group(QString err, QString place = QString()) : sireff_error(err, place)
        {
        }

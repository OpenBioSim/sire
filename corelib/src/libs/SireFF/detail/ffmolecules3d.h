...
namespace SireFF
{
    ...
    namespace detail
    {
        ...
        */
        ...
        /** Comparison operator */
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE bool FFMolecule3D<PTNL>::operator==(const FFMolecule3D<PTNL> &other) const
        {
        ...
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE const AABox &FFMolecule3D<PTNL>::aaBox() const
        {
            return aabox;
        }
        ...
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE const CoordGroupArray &FFMolecule3D<PTNL>::coordinates() const
        {
        ...
        */
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE bool FFMolecule3D<PTNL>::change(const SireMol::Molecule &molecule,
        ...
        */
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE bool FFMolecule3D<PTNL>::add(const AtomSelection &selected_atoms,
                                                             PTNL &forcefield, const PropertyMap &map)
        {
        ...
        */
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE bool FFMolecule3D<PTNL>::remove(const AtomSelection &selected_atoms,
                                                                PTNL &forcefield, const PropertyMap &map)
        {
        ...
        */
        ...
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE void FFMolecule3D<PTNL>::setCoordinates(const CoordGroupArray &coords)
        {
        ...
        /** Comparison operator */
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE bool FFMolecules3D<PTNL>::operator==(const FFMolecules3D<PTNL> &other) const
        {
        ...
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE const ChunkedVector<AABox> &FFMolecules3D<PTNL>::aaBoxesByIndex() const
        {
        ...
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE void FFMolecules3D<PTNL>::packCoordinates()
        {
        ...
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE void FFMolecules3D<PTNL>::updateAABox(MolNum molnum)
        {
        ...
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE void FFMolecules3D<PTNL>::updateAABoxes()
        {
            int nmols = this->mols_by_idx.count();
            ...
            for (int i = 0; i < nmols; ++i)
            {
                aaboxes_by_idx[i] = this->mols_by_idx[i].parameters().atomicCoordinates().aaBox();
            }
        }

    ...
    namespace detail
    {
        ...
        */
        ...
        SIRE_OUTOFLINE_TEMPLATE
            ...
            AtomicParameters3D<PARAM>::operator=(
        ...
        /** Comparison operator */
        template <class PARAM>
        SIRE_OUTOFLINE_TEMPLATE bool AtomicParameters3D<PARAM>::operator==(const AtomicParameters3D<PARAM> &other) const
        {
        ...
        /** Return whether or not all of the groups have changed parameters
            compared to 'params' */
        template <class PARAM>
        SIRE_OUTOFLINE_TEMPLATE bool AtomicParameters3D<PARAM>::changedAllGroups(
        ...
        template <class PARAM>
        SIRE_OUTOFLINE_TEMPLATE void AtomicParameters3D<PARAM>::addChangedGroups(
        ...
        SIRE_OUTOFLINE_TEMPLATE
            QSet<quint32>
            AtomicParameters3D<PARAM>::getChangedGroups(
        ...
        SIRE_OUTOFLINE_TEMPLATE
            AtomicParameters3D<PARAM>
            AtomicParameters3D<PARAM>::applyMask(
                const QSet<quint32> &idxs) const
        {
            ...
            else if (masked_coords.atomicCoordinates().count() == this->atomicCoordinates().count())
...
{
    ds >> static_cast<SireFF::detail::AtomicParameters<PARAM> &>(params) >> static_cast<SireFF::detail::AtomicCoords3D &>(params);

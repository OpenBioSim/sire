    ...
    namespace detail
    {
        ...
        */
        ...
        SIRE_OUTOFLINE_TEMPLATE
            ...
            AtomicParameters<PARAM>::operator=(
        ...
        /** Comparison operator */
        template <class PARAM>
        SIRE_OUTOFLINE_TEMPLATE bool AtomicParameters<PARAM>::operator==(const AtomicParameters<PARAM> &other) const
        {
        ...
        template <class PARAM>
        SIRE_OUTOFLINE_TEMPLATE int AtomicParameters<PARAM>::nGroups() const
        {
            return params.count();
        }
        ...
        template <class PARAM>
        SIRE_INLINE_TEMPLATE const typename AtomicParameters<PARAM>::Parameters &
        ...
        template <class PARAM>
        SIRE_OUTOFLINE_TEMPLATE void AtomicParameters<PARAM>::setAtomicParameters(const AtomicParameters<PARAM> &other)
        {
            params = other.params;
        }
        ...
        /** Return whether or not all of the groups have changed parameters
            compared to 'params' */
        template <class PARAM>
        SIRE_OUTOFLINE_TEMPLATE bool AtomicParameters<PARAM>::changedAllGroups(
        ...
        template <class PARAM>
        SIRE_OUTOFLINE_TEMPLATE void AtomicParameters<PARAM>::addChangedGroups(
            const AtomicParameters<PARAM> &other,
            QSet<quint32> &changed_groups) const
        {
            ...
            {
                if (not changed_groups.contains(i) and (this_array[i] != other_array[i]))
                {
        ...
        SIRE_OUTOFLINE_TEMPLATE
            QSet<quint32>
            AtomicParameters<PARAM>::getChangedGroups(
                const AtomicParameters<PARAM> &other) const
        {
        ...
        SIRE_OUTOFLINE_TEMPLATE
            AtomicParameters<PARAM>
            AtomicParameters<PARAM>::applyMask(

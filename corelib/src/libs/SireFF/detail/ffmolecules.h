...
namespace SireFF
{
    ...
    namespace detail
    {
        ...
        */
        ...
        /** Comparison operator */
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE bool FFMolecule<PTNL>::operator==(const FFMolecule<PTNL> &other) const
        {
        ...
        /** Return the parameters for this view of the molecule. These parameters
            ...
            that forcefield) */
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE const typename FFMolecule<PTNL>::Parameters &FFMolecule<PTNL>::parameters() const
        {
            return params;
        }
        ...
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE
            typename FFMolecule<PTNL>::Parameters &
            FFMolecule<PTNL>::_edit_parameters()
        {
            return params;
        }
        ...
        */
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE bool FFMolecule<PTNL>::change(const SireMol::Molecule &new_molecule,
        ...
        */
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE bool FFMolecule<PTNL>::add(const AtomSelection &added_atoms,
        ...
        */
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE bool FFMolecule<PTNL>::remove(const AtomSelection &removed_atoms,
                                                              PTNL &forcefield, const PropertyMap &map)
        {
            if (this->isEmpty())
                return false;
        ...
        */
        ...
        SIRE_OUTOFLINE_TEMPLATE
            FFMolecule<PTNL>
            FFMolecule<PTNL>::getDifferences(const FFMolecule<PTNL> &newmol) const
        {
        ...
        */
        ...
        /** Comparison operator */
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE bool FFMolecules<PTNL>::operator==(const FFMolecules<PTNL> &other) const
        {
        ...
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE void FFMolecules<PTNL>::clear()
        {
            mols_by_idx.clear();
        ...
        */
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE bool FFMolecules<PTNL>::wouldChangeProperties(MolNum molnum,
        ...
        template <class PTNL>
        SIRE_OUTOFLINE_TEMPLATE const ChunkedVector<typename FFMolecules<PTNL>::Molecule> &
        ...
        */
        ...
        template <class FFMOL>
        SIRE_OUTOFLINE_TEMPLATE
            ChangedMolecule<FFMOL> &
            ChangedMolecule<FFMOL>::operator=(
        ...
        /** Comparison operator */
        template <class FFMOL>
        SIRE_OUTOFLINE_TEMPLATE bool ChangedMolecule<FFMOL>::operator==(const ChangedMolecule<FFMOL> &other) const
        {
            return this == &other or
        ...
        SIRE_OUTOFLINE_TEMPLATE
            MolNum
            ChangedMolecule<FFMOL>::number() const
        {
        ...
        template <class FFMOL>
        SIRE_OUTOFLINE_TEMPLATE bool ChangedMolecule<FFMOL>::isEmpty() const
        {
        ...
        template <class FFMOL>
        SIRE_OUTOFLINE_TEMPLATE bool ChangedMolecule<FFMOL>::changedAll() const
        {
        ...
        template <class FFMOL>
        SIRE_OUTOFLINE_TEMPLATE bool ChangedMolecule<FFMOL>::nothingChanged() const
        {
        ...
        template <class FFMOL>
        SIRE_OUTOFLINE_TEMPLATE const FFMOL &ChangedMolecule<FFMOL>::oldMolecule() const
        {
            return old_molecule;
        }
        ...
        template <class FFMOL>
        SIRE_OUTOFLINE_TEMPLATE const FFMOL &ChangedMolecule<FFMOL>::newMolecule() const
        {
            return new_molecule;
        }
        ...
        template <class FFMOL>
        SIRE_OUTOFLINE_TEMPLATE const FFMOL &ChangedMolecule<FFMOL>::oldParts() const
        {
            return old_parts;
        }
        ...
        template <class FFMOL>
        SIRE_OUTOFLINE_TEMPLATE const FFMOL &ChangedMolecule<FFMOL>::newParts() const
        {
            return new_parts;
        }
        ...
        SIRE_OUTOFLINE_TEMPLATE
            ChangedMolecule<FFMOL>
            ChangedMolecule<FFMOL>::removeMolecule(const FFMOL &mol)
        {
                        ...
                        SireFF::detail::FFMolecule<PTNL> &ffmol)
{
    ...
    sds >> static_cast<SireFF::detail::FFMoleculeBase &>(ffmol) >> ffmol.params;
                        ...
                        SireFF::detail::FFMolecules<PTNL> &ffmols)
{
    ...
    sds >> static_cast<SireFF::detail::FFMoleculesBase &>(ffmols) >> ffmols.mols_by_idx;
                        ...
                        SireFF::detail::ChangedMolecule<FFMOL> &changedmol)
{
    ...
    sds >> changedmol.old_molecule >> changedmol.new_molecule >> changedmol.old_parts >> changedmol.new_parts;

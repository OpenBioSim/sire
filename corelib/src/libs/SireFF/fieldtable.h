...
SireFF::MolFieldTable operator+(const SireMaths::Vector &force, const SireFF::MolFieldTable &table);

SireFF::MolFieldTable operator*(double value, const SireFF::MolFieldTable &table);

SireFF::FieldTable operator+(const SireMaths::Vector &force, const SireFF::FieldTable &table);

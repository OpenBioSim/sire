    ...
    */
    ...
    public:
        ...
        /** Calculate all of the energies acting on all of the
            ...
            this forcefield */
        virtual void energy(EnergyTable &energytable, const SireCAS::Symbol &component, double scale_energy = 1) = 0;
        ...
        /** Calculate all of the forces acting on all of the
            ...
            specified component of the molecules' interactions in
            this forcefield */
        virtual void force(ForceTable &forcetable, const SireCAS::Symbol &component, double scale_force = 1) = 0;
        ...
        virtual void field(FieldTable &fieldtable, const SireCAS::Symbol &component, double scale_field = 1) = 0;

        /** Calculate the fields acting at all of the points
            in 'fieldtable' due to the molecules in this forcefield */
        virtual void field(FieldTable &fieldtable, const Probe &probe, double scale_field = 1) = 0;

        /** Calculate the fields acting at all of the points
            in 'fieldtable' due to the specified component 'component'
            from the molecules in this forcefield */
        virtual void field(FieldTable &fieldtable, const SireCAS::Symbol &component, const Probe &probe,
        ...
        /** Calculate the potential acting at the points in 'potentialtable'
            due to the molecules in this forcefield */
        virtual void potential(PotentialTable &potentialtable, const Probe &probe, double scale_potential = 1) = 0;

        /** Calculate the potential acting at the points in 'potentialtable'
            due to the specified component 'component' from the molecules in
            this table */
        virtual void potential(PotentialTable &potentialtable, const SireCAS::Symbol &component,
                               double scale_potential = 1) = 0;

        /** Calculate the potential acting at the points in 'potentialtable'
            due to the specified component 'component' from the molecules in
            this table */
        virtual void potential(PotentialTable &potentialtable, const SireCAS::Symbol &component, const Probe &probe,
                               double scale_potential = 1) = 0;
    };

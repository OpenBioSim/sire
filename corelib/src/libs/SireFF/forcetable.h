...
SireFF::MolForceTable operator+(const SireMaths::Vector &force, const SireFF::MolForceTable &table);

SireFF::MolForceTable operator*(double value, const SireFF::MolForceTable &table);

SireFF::ForceTable operator+(const SireMaths::Vector &force, const SireFF::ForceTable &table);

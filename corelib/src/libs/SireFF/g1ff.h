...
namespace SireFF
{
    ...
    */
    ...
    protected:
        ...
        ////
        virtual void _pvt_added(const PartialMolecule &mol, const PropertyMap &map) = 0;
        ...
        virtual bool _pvt_wouldChangeProperties(MolNum molnum, const PropertyMap &map) const = 0;

        ////
        //// Virtual functions that must be changed if this
        //// forcefield allows overlapping atoms (most don't!)
        ////
        virtual void _pvt_added(const ViewsOfMol &mol, const PropertyMap &map);

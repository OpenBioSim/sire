...
namespace SireFF
{
    ...
    */
    template <class T>
    class AtomicFFParameters : public SireBase::ConcreteProperty<AtomicFFParameters<T>, FFParameters>
    {
    ...
    */
    template <class T>
    class AtomicFFParametersArray : public SireBase::ConcreteProperty<AtomicFFParametersArray<T>, FFParametersArray>
    {
    ...
    public:
        ...
        void update(const QVarLengthArray<int> &idxs, const AtomicFFParametersArray<T> &params);
    ...
    /** Null constructor */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomicFFParameters<T>::AtomicFFParameters()
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomicFFParameters<T>::AtomicFFParameters(const QVector<T> &parameters)
        : SireBase::ConcreteProperty<AtomicFFParameters<T>, FFParameters>(), params(parameters)
    {
    }
    ...
    /** Copy constructor */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomicFFParameters<T>::AtomicFFParameters(const AtomicFFParameters<T> &other)
        : SireBase::ConcreteProperty<AtomicFFParameters<T>, FFParameters>(other), params(other.params)
    {
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const char *AtomicFFParameters<T>::typeName()
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomicFFParameters<T> &AtomicFFParameters<T>::operator=(const AtomicFFParameters<T> &other)
    {
        params = other.params;
    ...
    /** Comparison operator */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE bool AtomicFFParameters<T>::operator==(const AtomicFFParameters<T> &other) const
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE FFParametersArrayPtr AtomicFFParameters<T>::toArray() const
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE int AtomicFFParameters<T>::count() const
    {
        return params.count();
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T *AtomicFFParameters<T>::constData() const
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const typename SireBase::PackedArray2D<T>::Array &AtomicFFParameters<T>::array() const
    {
        return params;
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomicFFParameters<T>::operator typename SireBase::PackedArray2D<T>::Array() const
    {
        return params;
    }
    ...
    /** Null constructor */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomicFFParametersArray<T>::AtomicFFParametersArray()
    ...
    SIRE_OUTOFLINE_TEMPLATE AtomicFFParametersArray<T>::AtomicFFParametersArray(
        ...
        : SireBase::ConcreteProperty<AtomicFFParametersArray<T>, FFParametersArray>(), params(parameters)
    {
    }

    /** Construct to hold the passed parameters */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomicFFParametersArray<T>::AtomicFFParametersArray(const QVector<T> &parameters)
        : SireBase::ConcreteProperty<AtomicFFParametersArray<T>, FFParametersArray>(), params(parameters)
    {
    }
    ...
    /** Construct to hold the passed parameters */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomicFFParametersArray<T>::AtomicFFParametersArray(const QVector<QVector<T>> &parameters)
        : SireBase::ConcreteProperty<AtomicFFParametersArray<T>, FFParametersArray>(), params(parameters)
    {
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomicFFParametersArray<T>::AtomicFFParametersArray(const AtomicFFParameters<T> &prms)
        : SireBase::ConcreteProperty<AtomicFFParametersArray<T>, FFParametersArray>(), params(prms)
    {
    }

    /** Copy constructor */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomicFFParametersArray<T>::AtomicFFParametersArray(const AtomicFFParametersArray<T> &other)
        : SireBase::ConcreteProperty<AtomicFFParametersArray<T>, FFParametersArray>(other), params(other.params)
    {
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const char *AtomicFFParametersArray<T>::typeName()
    {
    ...
    /** Copy assignment operator */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomicFFParametersArray<T> &AtomicFFParametersArray<T>::operator=(
    ...
    /** Comparison operator */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE bool AtomicFFParametersArray<T>::operator==(const AtomicFFParametersArray<T> &other) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE FFParametersPtr AtomicFFParametersArray<T>::operator[](int i) const
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const SireBase::PackedArray2D<T> &AtomicFFParametersArray<T>::array() const
    {
        return params;
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const typename SireBase::PackedArray2D<T>::Array *AtomicFFParametersArray<T>::constData() const
    {
        return params.constData();
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE int AtomicFFParametersArray<T>::count() const
    {
        return params.count();
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE bool AtomicFFParametersArray<T>::isEmpty() const
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomicFFParametersArray<T>::operator SireBase::PackedArray2D<T>() const
    {
        return params;
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomicFFParametersArray<T>::append(const QVector<T> &parameters)
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomicFFParametersArray<T>::append(const QVector<QVector<T>> &parameters)
    {
        params.append(parameters);
    }
    ...
    /** Append the passed parameters onto the end of the array */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomicFFParametersArray<T>::append(const AtomicFFParameters<T> &parameters)
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomicFFParametersArray<T>::append(const AtomicFFParametersArray<T> &parameters)
    {
        params.append(parameters.array());
    }
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomicFFParametersArray<T>::append(const FFParameters &params)
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomicFFParametersArray<T>::append(const FFParametersArray &params)
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomicFFParametersArray<T>::update(int idx, const QVector<T> &parameters)
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomicFFParametersArray<T>::update(const QVarLengthArray<int> &idxs,
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomicFFParametersArray<T>::update(int idx, const AtomicFFParameters<T> &parameters)
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomicFFParametersArray<T>::update(int idx, const FFParameters &parameters)
    {
    ...
    */
    ...
    {
        AtomicFFParametersArray<T>::update(idxs, parameters.asA<AtomicFFParametersArray<T>>());
    }
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomicFFParametersArray<T>::remove(int idx)
    {
        params.remove(idx);
    }
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomicFFParametersArray<T>::remove(const QVarLengthArray<int> &idxs)
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomicFFParametersArray<T>::removeAll()
    {
    ...
    namespace detail
    {
        ...
        template <class T>
        const RegisterMetaType<SireFF::AtomicFFParameters<T>> AtomicFFParametersMT<T>::r_atomffparams;

        template <class T>
        const RegisterMetaType<SireFF::AtomicFFParametersArray<T>> AtomicFFParametersArrayMT<T>::r_atomffparams;
...
template <class T>
SIRE_OUTOFLINE_TEMPLATE QDataStream &operator<<(QDataStream &ds, const SireFF::AtomicFFParameters<T> &ffparams)
{
    SireStream::writeHeader(ds, SireFF::detail::AtomicFFParametersMT<T>::r_atomffparams, 1);
...
template <class T>
SIRE_OUTOFLINE_TEMPLATE QDataStream &operator>>(QDataStream &ds, SireFF::AtomicFFParameters<T> &ffparams)
{
    SireStream::VersionID v = SireStream::readHeader(ds, SireFF::detail::AtomicFFParametersMT<T>::r_atomffparams);
    ...
    if (v == 1)
    {
        ...
        throw SireStream::version_error(v, "1", SireFF::detail::AtomicFFParametersMT<T>::r_atomffparams, CODELOC);

    return ds;
}

template <class T>
SIRE_OUTOFLINE_TEMPLATE QDataStream &operator<<(QDataStream &ds, const SireFF::AtomicFFParametersArray<T> &ffparams)
{
    SireStream::writeHeader(ds, SireFF::detail::AtomicFFParametersArrayMT<T>::r_atomffparams, 1);
...
template <class T>
SIRE_OUTOFLINE_TEMPLATE QDataStream &operator>>(QDataStream &ds, SireFF::AtomicFFParametersArray<T> &ffparams)
{
    SireStream::VersionID v = SireStream::readHeader(ds, SireFF::detail::AtomicFFParametersArrayMT<T>::r_atomffparams);
    ...
    if (v == 1)
    {
        ...
        throw SireStream::version_error(v, "1", SireFF::detail::AtomicFFParametersArrayMT<T>::r_atomffparams, CODELOC);

...
namespace SireFF
{
    ...
    */
    ...
    class Intra2B3DFF : public SireBase::ConcreteProperty<Intra2B3DFF<Potential>, Intra2BFF<Potential>>, public FF3D
    {
    public:
    ...
    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE Intra2B3DFF<Potential>::Intra2B3DFF()
        : SireBase::ConcreteProperty<Intra2B3DFF<Potential>, Intra2BFF<Potential>>(), FF3D()
    {
    }

    /** Construct, giving this forcefield a name */
    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE Intra2B3DFF<Potential>::Intra2B3DFF(const QString &name)
        : SireBase::ConcreteProperty<Intra2B3DFF<Potential>, Intra2BFF<Potential>>(name), FF3D()
    {
    }

    /** Copy constructor */
    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE Intra2B3DFF<Potential>::Intra2B3DFF(const Intra2B3DFF<Potential> &other)
        : SireBase::ConcreteProperty<Intra2B3DFF<Potential>, Intra2BFF<Potential>>(other), FF3D(other)
    {
    }
    ...
    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE Intra2B3DFF<Potential> &Intra2B3DFF<Potential>::operator=(const Intra2B3DFF<Potential> &other)
    {
    ...
    /** Comparison operator */
    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE bool Intra2B3DFF<Potential>::operator==(const Intra2B3DFF<Potential> &other) const
    {
    ...
    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE const char *Intra2B3DFF<Potential>::typeName()
    {
        return QMetaType::typeName(qMetaTypeId<Intra2B3DFF<Potential>>());
    }

    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE const char *Intra2B3DFF<Potential>::what() const
    {
        return Intra2B3DFF<Potential>::typeName();
    }

    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE Intra2B3DFF<Potential> *Intra2B3DFF<Potential>::clone() const
    {
        return new Intra2B3DFF<Potential>(*this);
    }

    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE SireUnits::Dimension::MolarEnergy Intra2B3DFF<Potential>::energy()
    {
        return Intra2BFF<Potential>::energy();
    }

    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE SireUnits::Dimension::MolarEnergy Intra2B3DFF<Potential>::energy(const Symbol &component)
    {
        return Intra2BFF<Potential>::energy(component);
    }
    ...
    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE void Intra2B3DFF<Potential>::energy(EnergyTable &energytable, double scale_energy)
    {
        throw SireError::incomplete_code(QObject::tr("Intra2B3DFF does not yet support energy calculations!"), CODELOC);
    }
    ...
    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE void Intra2B3DFF<Potential>::energy(EnergyTable &energytable, const Symbol &symbol,
                                                                double scale_energy)
    {
        throw SireError::incomplete_code(QObject::tr("Intra2B3DFF does not yet support energy calculations!"), CODELOC);
    }
    ...
    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE void Intra2B3DFF<Potential>::force(ForceTable &forcetable, double scale_force)
    {
        if (scale_force == 0)
            return;
    ...
    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE void Intra2B3DFF<Potential>::force(ForceTable &forcetable, const Symbol &symbol,
                                                               double scale_force)
    {
        if (scale_force == 0)
            return;
        ...
        for (int i = 0; i < nforcemols; ++i)
        {
            ...
            Potential::calculateForce(mol, moltable, symbol, this->components(), workspace, scale_force);
        }
    }
    ...
    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE void Intra2B3DFF<Potential>::field(FieldTable &fieldtable, const Probe &prob,
                                                               double scale_field)
    {
        if (scale_field == 0)
            return;
    ...
    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE void Intra2B3DFF<Potential>::field(FieldTable &fieldtable, const Symbol &component,
                                                               const Probe &prob, double scale_field)
    {
        ...
        for (int i = 0; i < nfieldmols; ++i)
        {
            ...
            // calculate the intramolecular fields acting on this molecule
            Potential::calculateField(mol, probe, moltable, component, this->components(), workspace, scale_field);
        }
    ...
    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE void Intra2B3DFF<Potential>::potential(PotentialTable &potentialtable, const Probe &prob,
    ...
    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE void Intra2B3DFF<Potential>::potential(PotentialTable &potentialtable, const Symbol &component,
                                                                   const Probe &prob, double scale_potential)
    {
        ...
        for (int i = 0; i < npotentialmols; ++i)
        {
            ...
            // calculate the intramolecular potential acting on this molecule
            Potential::calculatePotential(mol, probe, moltable, component, this->components(), workspace, scale_potential);
        }
    ...
    /** Calculate the fields acting at the points in the passed fieldtable
        ...
        in the field table, multiplied by the passed (optional) scaling factor */
    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE void Intra2B3DFF<Potential>::field(FieldTable &fieldtable, double scale_field)
    {
    ...
    /** Calculate the potential acting at the points in the passed potentialtable
        ...
        in the potential table, multiplied by the passed (optional) scaling factor */
    template <class Potential>
    SIRE_OUTOFLINE_TEMPLATE void Intra2B3DFF<Potential>::potential(PotentialTable &potentialtable, double scale_potential)
    {
        typename Potential::Probe default_probe;
    ...
    {
        typename Potential::Probe default_probe;
        Intra2B3DFF<Potential>::potential(potentialtable, component, default_probe, scale_potential);
    }

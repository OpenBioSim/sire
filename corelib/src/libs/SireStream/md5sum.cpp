...
{
    return QString::asprintf("%02x%02x%02x%02x-%02x%02x%02x%02x-%02x%02x%02x%02x-%02x%02x%02x%02x", dgst[0], dgst[1],
                             dgst[2], dgst[3], dgst[4], dgst[5], dgst[6], dgst[7], dgst[8], dgst[9], dgst[10], dgst[11],
...
{
    return (dgst[0] == other.dgst[0] and dgst[1] == other.dgst[1] and dgst[2] == other.dgst[2] and
            dgst[3] == other.dgst[3] and dgst[4] == other.dgst[4] and dgst[5] == other.dgst[5] and
            dgst[6] == other.dgst[6] and dgst[7] == other.dgst[7] and dgst[8] == other.dgst[8] and
            dgst[9] == other.dgst[9] and dgst[10] == other.dgst[10] and dgst[11] == other.dgst[11] and
            dgst[12] == other.dgst[12] and dgst[13] == other.dgst[13] and dgst[14] == other.dgst[14] and
            dgst[15] == other.dgst[15]);
}

bool MD5Sum::operator!=(const MD5Sum &other) const
{
    return (dgst[0] != other.dgst[0] or dgst[1] != other.dgst[1] or dgst[2] != other.dgst[2] or
            dgst[3] != other.dgst[3] or dgst[4] != other.dgst[4] or dgst[5] != other.dgst[5] or
            dgst[6] != other.dgst[6] or dgst[7] != other.dgst[7] or dgst[8] != other.dgst[8] or
            dgst[9] != other.dgst[9] or dgst[10] != other.dgst[10] or dgst[11] != other.dgst[11] or
            dgst[12] != other.dgst[12] or dgst[13] != other.dgst[13] or dgst[14] != other.dgst[14] or
            dgst[15] != other.dgst[15]);
}

...
namespace SireMM
{
    ...
    namespace detail
    {
        ...
        public:
            ...
            GroupInternalNonPhysParameters &operator=(const GroupInternalNonPhysParameters &other);
        ...
        public:
            ...
            GroupInternalCrossParameters &operator=(const GroupInternalCrossParameters &other);
        ...
        public:
            ...
            GroupInternalParametersData &operator=(const GroupInternalParametersData &other);
    ...
    */
    ...
    public:
        ...
        bool isQuadrupleCutGroup(CGIdx cgidx0, CGIdx cgidx1, CGIdx cgidx2, CGIdx cgidx3) const;
    ...
    protected:
        ...
        void setBondPotential(const QVector<TwoAtomFunction> &potential, const QVector<TwoAtomFunction> &forces);

        void setAnglePotential(const QVector<ThreeAtomFunction> &potential, const QVector<ThreeAtomFunction> &forces);

        void setDihedralPotential(const QVector<FourAtomFunction> &potential, const QVector<FourAtomFunction> &forces);

        void setImproperPotential(const QVector<FourAtomFunction> &potential, const QVector<FourAtomFunction> &theta_forces,
                                  const QVector<FourAtomFunction> &phi_forces);

        void setUreyBradleyPotential(const QVector<TwoAtomFunction> &potential, const QVector<TwoAtomFunction> &forces);
    ...
    */
    ...
    public:
        ...
        InternalParameters(const PartialMolecule &molecule, const PropertyName &bond_params,
                           ...
                           const PropertyName &ss_params, const PropertyName &sb_params, const PropertyName &bb_params,
        ...
        void addChangedGroups(const InternalParameters &other, QSet<quint32> &changed_groups) const;
    ...
    private:
        ...
        qint32 getIndex(CGIdx cgidx0, CGIdx cgidx1, CGIdx cgidx2) const;
        qint32 getIndex(CGIdx cgidx0, CGIdx cgidx1, CGIdx cgidx2, CGIdx cgidx3) const;
        ...
        const GroupInternalParameters &getGroup(CGIdx cgidx0, CGIdx cgidx1, CGIdx cgidx2) const;
        const GroupInternalParameters &getGroup(CGIdx cgidx0, CGIdx cgidx1, CGIdx cgidx2, CGIdx cgidx3) const;

        qint32 addGroup(const detail::CGIDQuad &cgids);

        GroupInternalParameters &getGroup(const detail::CGIDQuad &cgids, QHash<detail::CGIDQuad, qint32> &cached_groups);

        void assertContainsOnly(const QSet<Symbol> &have_symbols, const QSet<Symbol> &test_symbols) const;

        void addBonds(const TwoAtomFunctions &bondparams, QHash<detail::CGIDQuad, qint32> &cached_groups);
        void addAngles(const ThreeAtomFunctions &angleparams, QHash<detail::CGIDQuad, qint32> &cached_groups);
        void addDihedrals(const FourAtomFunctions &dihedralparams, QHash<detail::CGIDQuad, qint32> &cached_groups);

        void addImpropers(const FourAtomFunctions &improperparams, QHash<detail::CGIDQuad, qint32> &cached_groups);
        void addUBs(const TwoAtomFunctions &ubparams, QHash<detail::CGIDQuad, qint32> &cached_groups);

        void addSSs(const ThreeAtomFunctions &ssparams, QHash<detail::CGIDQuad, qint32> &cached_groups);
        void addSBs(const ThreeAtomFunctions &sbparams, QHash<detail::CGIDQuad, qint32> &cached_groups);
        void addBBs(const FourAtomFunctions &bbparams, QHash<detail::CGIDQuad, qint32> &cached_groups);
        void addSBTs(const FourAtomFunctions &sbtparams, QHash<detail::CGIDQuad, qint32> &cached_groups);
    ...
    /** This class holds intramolecular bonding parameters for 3D molecules
        ...
        @author Christopher Woods
    */
    class SIREMM_EXPORT InternalParameters3D : public InternalParameters, protected SireFF::detail::AtomicCoords3D
    {
    ...
    public:
        ...
        InternalParameters3D(const PartialMolecule &molecule, const PropertyName &coords_property,
                             ...
                             const PropertyName &ub_params, const PropertyName &ss_params, const PropertyName &sb_params,
        ...
        void addChangedGroups(const InternalParameters3D &other, QSet<quint32> &changed_groups) const;
    ...
    private:
        InternalParameters3D(const AtomicCoords3D &coords, const InternalParameters &params);
    };

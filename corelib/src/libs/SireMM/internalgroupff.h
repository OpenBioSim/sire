...
namespace SireMM
{
    ...
    */
    class SIREMM_EXPORT InternalGroupFF : public SireBase::ConcreteProperty<InternalGroupFF, G2FF>,
                                          public FF3D,
    ...
    protected:
        ...
        void _pvt_added(quint32 group_id, const PartialMolecule &mol, const PropertyMap &map);
        ...
        bool _pvt_wouldChangeProperties(quint32 group_id, MolNum molnum, const PropertyMap &map) const;

        void _pvt_extractMoleculeData(MolNum molnum, const PropertyMap &map);

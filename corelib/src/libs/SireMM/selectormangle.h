...
namespace SireMM
{
    ...
    class SIREMM_EXPORT SelectorMAngle : public SireBase::ConcreteProperty<SelectorMAngle, SireBase::Property>
    {
    ...
    public:
        ...
        SelectorMAngle(const SireMol::Molecules &mols, const SireBase::PropertyMap &map = SireBase::PropertyMap());
        SelectorMAngle(const SireMol::MoleculeGroup &mols, const SireBase::PropertyMap &map = SireBase::PropertyMap());
        SelectorMAngle(const SireMol::MolGroupsBase &mols, const SireBase::PropertyMap &map = SireBase::PropertyMap());
        SelectorMAngle(const SireMol::SelectResult &mols, const SireBase::PropertyMap &map = SireBase::PropertyMap());
        SelectorMAngle(const SelectorAngle &angles);

        SelectorMAngle(const SireMol::SelectorMol &mols, const SireBase::PropertyMap &map = SireBase::PropertyMap());

        template <class U>
        SelectorMAngle(const SireMol::SelectorM<U> &other, const SireBase::PropertyMap &map = SireBase::PropertyMap());
        ...
        SelectorMAngle(const SireMol::SelectorM<SireMol::Atom> &atoms0, const SireMol::SelectorM<SireMol::Atom> &atoms1,
                       const SireBase::PropertyMap &map = SireBase::PropertyMap());
...
namespace SireMM
{
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE SelectorMAngle::SelectorMAngle(const SireMol::SelectorM<T> &other,

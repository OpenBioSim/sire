...
void AmberParams::_pvt_createFrom(const MoleculeData &moldata)
{
    ...
    {
        nb_functions.append([&]()
                            { getAmberNBsFrom(nbpairs, dihedrals); });
    }

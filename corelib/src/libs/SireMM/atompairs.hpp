...
namespace SireMM
{
    ...
    */
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE CGAtomPairs<T>::CGAtomPairs(const T &default_value) : data(default_value)
    {
    }
    ...
    template <class T>
    template <class U>
    SIRE_OUTOFLINE_TEMPLATE CGAtomPairs<T>::CGAtomPairs(const CGAtomPairs<U> &other)
    {
    ...
    /** Copy constructor */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE CGAtomPairs<T>::CGAtomPairs(const CGAtomPairs<T> &other) : data(other.data)
    {
    }

    /** Destructor */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE CGAtomPairs<T>::~CGAtomPairs()
    {
    }

    /** Copy assignment operator */
    template <class T>
    SIRE_INLINE_TEMPLATE CGAtomPairs<T> &CGAtomPairs<T>::operator=(const CGAtomPairs<T> &other)
    {
        data = other.data;
        return *this;
    }
    ...
    /** Comparison operator */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE bool CGAtomPairs<T>::operator==(const CGAtomPairs<T> &other) const
    {
    ...
    template <class T>
    SIRE_INLINE_TEMPLATE const T &CGAtomPairs<T>::operator()(quint32 atm0, quint32 atm1) const
    {
    ...
    template <class T>
    SIRE_INLINE_TEMPLATE const T &CGAtomPairs<T>::operator()(quint32 atm0) const
    {
    ...
    /** Return the object associated with the atom 'atm0' - this
        returns the default value if none has been provided */
    template <class T>
    SIRE_INLINE_TEMPLATE const T &CGAtomPairs<T>::get(quint32 atm0) const
    {
        return data(atm0, atm0);
    }
    ...
    /** Return the object associated with the atom pair between atoms
        ...
        value if there is no specified value associated with this pair */
    template <class T>
    SIRE_INLINE_TEMPLATE const T &CGAtomPairs<T>::get(quint32 atm0, quint32 atm1) const
    {
        return data(atm0, atm1);
    }
    ...
    template <class T>
    SIRE_INLINE_TEMPLATE void CGAtomPairs<T>::set(quint32 atm0, const T &value)
    {
    ...
    template <class T>
    SIRE_INLINE_TEMPLATE void CGAtomPairs<T>::set(quint32 atm0, quint32 atm1, const T &value)
    {
    ...
    /** Return whether all atom pairs have the default value - i.e. this
        matrix is empty */
    template <class T>
    SIRE_INLINE_TEMPLATE bool CGAtomPairs<T>::isEmpty() const
    {
        return data.isEmpty();
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void CGAtomPairs<T>::reserve(int dim_x, int dim_y)
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void CGAtomPairs<T>::squeeze()
    {
        data.commit();
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomPairs<T>::AtomPairs(const T &default_value)
        : molinfo(MoleculeInfoData::null()), cgpairs(CGAtomPairs<T>(default_value))
    {
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomPairs<T>::AtomPairs(const MoleculeInfoData &info, const T &default_value)
    ...
    /** Construct a set of AtomPairs for the passed molecule view, using the
        ...
        group */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomPairs<T>::AtomPairs(const MoleculeView &molview, const T &default_value)
        : molinfo(molview.data().info()), cgpairs(CGAtomPairs<T>(default_value))
    {
        if (default_value != T(0) and not molview.selectedAll())
        {
            ...
            throw SireError::incomplete_code(QObject::tr("The code to deal with partial molecule AtomPairs has yet to "
                                                         "be written."),
                                             CODELOC);
        }
    }
    ...
    template <class T>
    template <class U>
    SIRE_OUTOFLINE_TEMPLATE AtomPairs<T>::AtomPairs(const AtomPairs<U> &other)
    {
    ...
    /** Copy constructor */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomPairs<T>::AtomPairs(const AtomPairs &other) : molinfo(other.molinfo), cgpairs(other.cgpairs)
    {
    }

    /** Destructor */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomPairs<T>::~AtomPairs()
    {
    }

    /** Copy assignment operator */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE AtomPairs<T> &AtomPairs<T>::operator=(const AtomPairs &other)
    {
        if (&other != this)
        {
            molinfo = other.molinfo;
    ...
    /** Comparison operator */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE bool AtomPairs<T>::operator==(const AtomPairs<T> &other) const
    {
        return (this == &other) or
               ((molinfo == other.molinfo or *molinfo == *(other.molinfo)) and cgpairs == other.cgpairs);
    }
    ...
    template <class T>
    SIRE_INLINE_TEMPLATE const CGAtomPairs<T> &AtomPairs<T>::operator()(CGIdx cgid0, CGIdx cgid1) const
    {
        return cgpairs(cgid0.map(molinfo.read().nCutGroups()), cgid1.map(molinfo.read().nCutGroups()));
    }

    /** Return the objects associated with all of the atom pairs within the
        CutGroup at index cgid0 */
    template <class T>
    SIRE_INLINE_TEMPLATE const CGAtomPairs<T> &AtomPairs<T>::operator()(CGIdx cgid0) const
    {
        return cgpairs(cgid0.map(molinfo.read().nCutGroups()), cgid0.map(molinfo.read().nCutGroups()));
    }

    /** Return the objects associated with all of the atom pairs between
        the two CutGroups with IDs (cgid0,cgid1) */
    template <class T>
    SIRE_INLINE_TEMPLATE const CGAtomPairs<T> &AtomPairs<T>::operator()(const CGID &cgid0, const CGID &cgid1) const
    {
    ...
    template <class T>
    SIRE_INLINE_TEMPLATE const CGAtomPairs<T> &AtomPairs<T>::operator()(const CGID &cgid0) const
    {
    ...
    /** Return the objects associated with all of the atom pairs within the
        CutGroup at index 'cgid0' */
    template <class T>
    SIRE_INLINE_TEMPLATE const CGAtomPairs<T> &AtomPairs<T>::get(CGIdx cgid0) const
    {
    ...
    /** Return the objects associated with all of the atom pairs between
        the two CutGroups at indicies (cgid0,cgid1) */
    template <class T>
    SIRE_INLINE_TEMPLATE const CGAtomPairs<T> &AtomPairs<T>::get(CGIdx cgid0, CGIdx cgid1) const
    {
    ...
    /** Return the objects associated with all of the atom pairs within the
        CutGroup with ID 'cgid0' */
    template <class T>
    SIRE_INLINE_TEMPLATE const CGAtomPairs<T> &AtomPairs<T>::get(const CGID &cgid0) const
    {
        return this->operator()(cgid0);
    }
    ...
    template <class T>
    SIRE_INLINE_TEMPLATE const CGAtomPairs<T> &AtomPairs<T>::get(const CGID &cgid0, const CGID &cgid1) const
    {
        return this->operator()(cgid0, cgid1);
    }
    ...
    template <class T>
    SIRE_INLINE_TEMPLATE const T &AtomPairs<T>::operator()(const CGAtomIdx &atm0, const CGAtomIdx &atm1) const
    {
    ...
    template <class T>
    SIRE_INLINE_TEMPLATE const T &AtomPairs<T>::operator()(const CGAtomIdx &atm0) const
    {
        const quint32 cg0 = atm0.cutGroup().map(molinfo.read().nCutGroups());
        const quint32 atom0 = atm0.atom().map(molinfo.read().nAtoms(atm0.cutGroup()));
    ...
    /** Return the object associated with the atom 'atm0'. This returns the
        default object if nothing has been set for this atom */
    template <class T>
    SIRE_INLINE_TEMPLATE const T &AtomPairs<T>::get(const CGAtomIdx &atm0) const
    {
    ...
    /** Return the object associated with the atom pair (atm0,atm1). This returns the
        default object if nothing has been set for this pair */
    template <class T>
    SIRE_INLINE_TEMPLATE const T &AtomPairs<T>::get(const CGAtomIdx &atm0, const CGAtomIdx &atm1) const
    {
    ...
    /** Return the object associated with the atom 'atm0'. This returns the
        default object if nothing has been set for this atom */
    template <class T>
    SIRE_INLINE_TEMPLATE const T &AtomPairs<T>::operator()(const AtomID &atm0) const
    {
    ...
    /** Return the object associated with the atom pair (atm0,atm1). This returns the
        default object if nothing has been set for this pair */
    template <class T>
    SIRE_INLINE_TEMPLATE const T &AtomPairs<T>::operator()(const AtomID &atm0, const AtomID &atm1) const
    {
        return this->operator()(molinfo.read().cgAtomIdx(atm0), molinfo.read().cgAtomIdx(atm1));
    }

    /** Make sure that this container can hold dim_x by dim_y atom pairs */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomPairs<T>::reserve(int dim_x, int dim_y)
    {
    ...
    /** Minimise the memory usage of these pairs */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomPairs<T>::squeeze()
    {
    ...
    /** Return the object associated with the atom 'atm0'. This returns the
        default object if nothing has been set for this atom */
    template <class T>
    SIRE_INLINE_TEMPLATE const T &AtomPairs<T>::get(const AtomID &atm0) const
    {
        return this->operator()(atm0);
    }
    ...
    /** Return the object associated with the atom pair (atm0,atm1). This returns the
        default object if nothing has been set for this pair */
    template <class T>
    SIRE_INLINE_TEMPLATE const T &AtomPairs<T>::get(const AtomID &atm0, const AtomID &atm1) const
    {
        return this->operator()(atm0, atm1);
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomPairs<T>::set(const CGAtomIdx &atm0, const CGAtomIdx &atm1, const T &value)
    {
    ...
    template <class T>
    SIRE_INLINE_TEMPLATE void AtomPairs<T>::set(const CGAtomIdx &atm0, const T &value)
    {
    ...
    /** Set the value for the atom 'atm0' */
    template <class T>
    SIRE_INLINE_TEMPLATE void AtomPairs<T>::set(const AtomID &atm0, const T &value)
    {
    ...
    template <class T>
    SIRE_INLINE_TEMPLATE void AtomPairs<T>::set(const AtomID &atm0, const AtomID &atm1, const T &value)
    {
        this->set(molinfo.read().cgAtomIdx(atm0), molinfo.read().cgAtomIdx(atm1), value);
    }

    /** Set every single atom pair in this molecule to have the value 'value' */
    template <class T>
    SIRE_INLINE_TEMPLATE void AtomPairs<T>::setAll(const T &value)
    {
    ...
    /** Set every single atom pair in the CutGroup at index cgid0 to have
        the value 'value' */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomPairs<T>::setAll(CGIdx cgid0, const T &value)
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomPairs<T>::setAll(CGIdx cgid0, CGIdx cgid1, const T &value)
    {
        quint32 cg0 = cgid0.map(molinfo.read().nCutGroups());
    ...
    /** Set every single atom pair in the CutGroup with ID cgid0 to have
        the value 'value' */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomPairs<T>::setAll(const CGID &cgid0, const T &value)
    {
    ...
    /** Set every single atom pair between the CutGroups with IDs (cgid0,cgid1)
        to have the value 'value' */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void AtomPairs<T>::setAll(const CGID &cgid0, const CGID &cgid1, const T &value)
    {
    ...
    /** Return whether or not this is empty - all of the atom pairs have
        the default value. */
    template <class T>
    SIRE_INLINE_TEMPLATE bool AtomPairs<T>::isEmpty() const
    {
    ...
    /** Return the info object describing the molecule that contains
        all of the atoms */
    template <class T>
    SIRE_INLINE_TEMPLATE const MoleculeInfoData &AtomPairs<T>::info() const
    {
        return *molinfo;
    }
    ...
    /** Return the number of atoms in the molecule (hence the size of the
        square matrix) */
    template <class T>
    SIRE_INLINE_TEMPLATE int AtomPairs<T>::nAtoms() const
    {
    ...
    /** Return whether this object is compatible with a molecule with
        metadata in 'info' */
    template <class T>
    SIRE_INLINE_TEMPLATE bool AtomPairs<T>::isCompatibleWith(const MoleculeInfoData &info) const
    {
        return *molinfo == info;
    }
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE SireBase::PropertyPtr AtomPairs<T>::_pvt_makeCompatibleWith(
...
template <class T>
QDataStream &operator<<(QDataStream &ds, const SireMM::CGAtomPairs<T> &cgpairs)
{
    ds << cgpairs.data;
    return ds;
}
...
template <class T>
QDataStream &operator>>(QDataStream &ds, SireMM::CGAtomPairs<T> &cgpairs)
{
    ds >> cgpairs.data;
    return ds;
}
...
/** Serialise to a binary datastream */
template <class T>
QDataStream &operator<<(QDataStream &ds, const SireMM::AtomPairs<T> &atompairs)
{
...
/** Extract from a binary datastream */
template <class T>
QDataStream &operator>>(QDataStream &ds, SireMM::AtomPairs<T> &atompairs)
{
    SireStream::SharedDataStream sds(ds);

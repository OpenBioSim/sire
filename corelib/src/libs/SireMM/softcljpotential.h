...
namespace SireMM
{
    ...
    */
    ...
    public:
        ...
        InterSoftCLJPotential::Parameters getParameters(const PartialMolecule &molecule,
                                                        const PropertyMap &map = PropertyMap());

        InterSoftCLJPotential::Parameters updateParameters(const InterSoftCLJPotential::Parameters &old_params,
        ...
        InterSoftCLJPotential::Molecule parameterise(const PartialMolecule &molecule,
                                                     const PropertyMap &map = PropertyMap());

        InterSoftCLJPotential::Molecules parameterise(const MoleculeGroup &molecules,
                                                      const PropertyMap &map = PropertyMap());

        void calculateEnergy(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                             InterSoftCLJPotential::Energy &energy, InterSoftCLJPotential::EnergyWorkspace &workspace,
                             double scale_energy = 1) const;

        void calculateEnergy(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                             MolEnergyTable &energies0, InterSoftCLJPotential::EnergyWorkspace &workspace,
                             double scale_energy = 1) const;

        void calculateForce(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                            MolForceTable &forces0, InterSoftCLJPotential::ForceWorkspace &workspace,
                            double scale_force = 1) const;

        void calculateForce(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                            MolForceTable &forces0, const Symbol &symbol, const Components &components,
                            InterSoftCLJPotential::ForceWorkspace &workspace, double scale_force = 1) const;

        void calculateCoulombForce(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                                   MolForceTable &forces0, InterSoftCLJPotential::ForceWorkspace &workspace,
                                   double scale_force = 1) const;

        void calculateLJForce(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                              MolForceTable &forces0, InterSoftCLJPotential::ForceWorkspace &workspace,
                              double scale_force = 1) const;

        void calculateField(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                            const CLJProbe &probe, MolFieldTable &forces0, InterSoftCLJPotential::FieldWorkspace &workspace,
                            double scale_field = 1) const;

        void calculateField(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                            const CLJProbe &probe, MolFieldTable &forces0, const Symbol &symbol,
                            const Components &components, InterSoftCLJPotential::FieldWorkspace &workspace,
                            double scale_field = 1) const;

        void calculateField(const InterSoftCLJPotential::Molecule &mol0, const CLJProbe &probe, GridFieldTable &fields,
                            InterSoftCLJPotential::FieldWorkspace &workspace, double scale_field = 1) const;

        void calculateField(const InterSoftCLJPotential::Molecule &mol0, const CLJProbe &probe, GridFieldTable &fields,
                            const Symbol &symbol, const Components &components,
                            InterSoftCLJPotential::FieldWorkspace &workspace, double scale_field = 1) const;

        void calculateCoulombField(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                                   const CLJProbe &probe, MolFieldTable &fields0,
                                   InterSoftCLJPotential::FieldWorkspace &workspace, double scale_field = 1) const;

        void calculateCoulombField(const InterSoftCLJPotential::Molecule &mol0, const CLJProbe &probe,
                                   GridFieldTable &fields, InterSoftCLJPotential::FieldWorkspace &workspace,
                                   double scale_field = 1) const;

        void calculateLJField(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                              const CLJProbe &probe, MolFieldTable &fields0,
                              InterSoftCLJPotential::ForceWorkspace &workspace, double scale_field = 1) const;

        void calculateLJField(const InterSoftCLJPotential::Molecule &mol0, const CLJProbe &probe, GridFieldTable &fields,
                              InterSoftCLJPotential::ForceWorkspace &workspace, double scale_field = 1) const;

        void calculatePotential(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                                const CLJProbe &probe, MolPotentialTable &pots0,
                                InterSoftCLJPotential::PotentialWorkspace &workspace, double scale_potential = 1) const;

        void calculatePotential(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                                const CLJProbe &probe, MolPotentialTable &pots0, const Symbol &symbol,
                                const Components &components, InterSoftCLJPotential::PotentialWorkspace &workspace,
                                double scale_potential = 1) const;

        void calculatePotential(const InterSoftCLJPotential::Molecule &mol0, const CLJProbe &probe,
                                GridPotentialTable &pots, InterSoftCLJPotential::PotentialWorkspace &workspace,
                                double scale_potential = 1) const;

        void calculatePotential(const InterSoftCLJPotential::Molecule &mol0, const CLJProbe &probe,
                                GridPotentialTable &pots, const Symbol &symbol, const Components &components,
                                InterSoftCLJPotential::PotentialWorkspace &workspace, double scale_potential = 1) const;
        ...
        void calculateCoulombPotential(const InterSoftCLJPotential::Molecule &mol0,
                                       ...
                                       MolPotentialTable &pots0, InterSoftCLJPotential::PotentialWorkspace &workspace,
                                       double scale_potential = 1) const;

        void calculateCoulombPotential(const InterSoftCLJPotential::Molecule &mol0, const CLJProbe &probe,
                                       GridPotentialTable &pots, InterSoftCLJPotential::PotentialWorkspace &workspace,
                                       double scale_potential = 1) const;

        void calculateLJPotential(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                                  const CLJProbe &probe, MolPotentialTable &pots0,
                                  InterSoftCLJPotential::PotentialWorkspace &workspace, double scale_potential = 1) const;

        void calculateLJPotential(const InterSoftCLJPotential::Molecule &mol0, const CLJProbe &probe,
                                  GridPotentialTable &pots, InterSoftCLJPotential::PotentialWorkspace &workspace,
                                  double scale_potential = 1) const;
    ...
    private:
        ...
        void _pvt_calculateEnergy(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                                  InterSoftCLJPotential::Energy &energy, InterSoftCLJPotential::EnergyWorkspace &workspace,
                                  double scale_energy) const;

        void _pvt_calculateForce(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                                 MolForceTable &forces0, InterSoftCLJPotential::ForceWorkspace &workspace,
        ...
        void _pvt_calculateCoulombForce(const InterSoftCLJPotential::Molecule &mol0,
                                        ...
                                        InterSoftCLJPotential::ForceWorkspace &workspace, double scale_force) const;

        void _pvt_calculateLJForce(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                                   MolForceTable &forces0, InterSoftCLJPotential::ForceWorkspace &workspace,
                                   double scale_force) const;

        void _pvt_calculateField(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                                 const CLJProbe &probe, MolFieldTable &fields0,
                                 InterSoftCLJPotential::FieldWorkspace &workspace, double scale_field) const;

        void _pvt_calculateField(const InterSoftCLJPotential::Molecule &mol, const CLJProbe &probe, GridFieldTable &fields,
                                 InterSoftCLJPotential::FieldWorkspace &workspace, double scale_field) const;

        void _pvt_calculateCoulombField(const InterSoftCLJPotential::Molecule &mol0,
                                        const InterSoftCLJPotential::Molecule &mol1, const CLJProbe &probe,
                                        MolFieldTable &fields0, InterSoftCLJPotential::FieldWorkspace &workspace,
                                        double scale_field) const;

        void _pvt_calculateCoulombField(const InterSoftCLJPotential::Molecule &mol, const CLJProbe &probe,
                                        GridFieldTable &fields, InterSoftCLJPotential::FieldWorkspace &workspace,
                                        double scale_field) const;

        void _pvt_calculateLJField(const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1,
                                   const CLJProbe &probe, MolFieldTable &fields0,
                                   InterSoftCLJPotential::FieldWorkspace &workspace, double scale_field) const;

        void _pvt_calculateLJField(const InterSoftCLJPotential::Molecule &mol, const CLJProbe &probe,
                                   GridFieldTable &fields, InterSoftCLJPotential::FieldWorkspace &workspace,
                                   double scale_field) const;
        ...
        void _pvt_calculatePotential(const InterSoftCLJPotential::Molecule &mol, const CLJProbe &probe,
                                     GridPotentialTable &fields, InterSoftCLJPotential::PotentialWorkspace &workspace,
                                     double scale_potential) const;
        ...
        void _pvt_calculateCoulombPotential(const InterSoftCLJPotential::Molecule &mol, const CLJProbe &probe,
        ...
        void _pvt_calculateLJPotential(const InterSoftCLJPotential::Molecule &mol, const CLJProbe &probe,
                                       GridPotentialTable &fields, InterSoftCLJPotential::PotentialWorkspace &workspace,
                                       double scale_potential) const;
    };
    ...
    */
    ...
    public:
        ...
        IntraSoftCLJPotential::Parameters getParameters(const PartialMolecule &molecule,
                                                        const PropertyMap &map = PropertyMap());

        IntraSoftCLJPotential::Parameters updateParameters(const IntraSoftCLJPotential::Parameters &old_params,
                                                           const PartialMolecule &old_molecule,
                                                           const PartialMolecule &new_molecule,
                                                           const PropertyMap &map = PropertyMap());
        ...
        IntraSoftCLJPotential::Molecule parameterise(const PartialMolecule &molecule,
                                                     const PropertyMap &map = PropertyMap());

        IntraSoftCLJPotential::Molecules parameterise(const MoleculeGroup &molecules,
                                                      const PropertyMap &map = PropertyMap());

        void calculateEnergy(const IntraSoftCLJPotential::Molecule &mol, IntraSoftCLJPotential::Energy &energy,
                             IntraSoftCLJPotential::EnergyWorkspace &workspace, double scale_energy = 1) const;

        void calculateEnergy(const IntraSoftCLJPotential::Molecule &mol, const IntraSoftCLJPotential::Molecule &rest_of_mol,
                             IntraSoftCLJPotential::Energy &energy, IntraSoftCLJPotential::EnergyWorkspace &workspace,
                             double scale_energy = 1) const;

        void calculateForce(const IntraSoftCLJPotential::Molecule &mol, MolForceTable &forces,
                            IntraCLJPotential::ForceWorkspace &workspace, double scale_force = 1) const;

        void calculateForce(const IntraSoftCLJPotential::Molecule &mol, const IntraSoftCLJPotential::Molecule &rest_of_mol,
                            MolForceTable &forces, IntraSoftCLJPotential::ForceWorkspace &workspace,
                            double scale_force = 1) const;

        void calculateForce(const IntraSoftCLJPotential::Molecule &mol, MolForceTable &forces, const Symbol &symbol,
                            const Components &components, IntraSoftCLJPotential::ForceWorkspace &workspace,
                            double scale_force = 1) const;

        void calculateForce(const IntraSoftCLJPotential::Molecule &mol, const IntraSoftCLJPotential::Molecule &rest_of_mol,
                            MolForceTable &forces, const Symbol &symbol, const Components &components,
                            IntraSoftCLJPotential::ForceWorkspace &workspace, double scale_force = 1) const;

        void calculateField(const IntraSoftCLJPotential::Molecule &mol, const CLJProbe &probe, MolFieldTable &fields,
                            IntraSoftCLJPotential::FieldWorkspace &workspace, double scale_field = 1) const;

        void calculateField(const IntraSoftCLJPotential::Molecule &mol, const IntraSoftCLJPotential::Molecule &rest_of_mol,
                            const CLJProbe &probe, MolFieldTable &fields, IntraSoftCLJPotential::FieldWorkspace &workspace,
                            double scale_field = 1) const;
        ...
        void calculateField(const IntraSoftCLJPotential::Molecule &mol, const IntraSoftCLJPotential::Molecule &rest_of_mol,
                            ...
                            const Components &components, IntraSoftCLJPotential::FieldWorkspace &workspace,
                            double scale_field = 1) const;

        void calculateField(const IntraSoftCLJPotential::Molecule &mol, const CLJProbe &probe, GridFieldTable &fields,
                            IntraSoftCLJPotential::FieldWorkspace &workspace, double scale_field = 1) const;
        ...
        void calculatePotential(const IntraSoftCLJPotential::Molecule &mol, const CLJProbe &probe,
                                MolPotentialTable &potentials, IntraSoftCLJPotential::PotentialWorkspace &workspace,
                                double scale_potential = 1) const;
        ...
        void calculatePotential(const IntraSoftCLJPotential::Molecule &mol, const CLJProbe &probe,
                                ...
                                IntraSoftCLJPotential::PotentialWorkspace &workspace, double scale_potential = 1) const;
        ...
        void calculatePotential(const IntraSoftCLJPotential::Molecule &mol, const CLJProbe &probe,
                                GridPotentialTable &potentials, IntraSoftCLJPotential::PotentialWorkspace &workspace,
                                double scale_potential = 1) const;
    ...
    private:
        ...
        void _pvt_calculateEnergy(const CLJNBPairs::CGPairs &group_pairs, IntraSoftCLJPotential::EnergyWorkspace &workspace,
                                  const Parameter *params0_array, const Parameter *params1_array, const quint32 nats0,
                                  const quint32 nats1, double icnrg[], double iljnrg[], const double alfa[], double delta[],
                                  const int nalpha) const;

        void _pvt_calculateEnergy(const CLJNBPairs::CGPairs &group_pairs, const QSet<SireID::Index> &atoms0,
                                  const QSet<SireID::Index> &atoms1, IntraSoftCLJPotential::EnergyWorkspace &workspace,
                                  const Parameter *params0_array, const Parameter *params1_array, const quint32 nats0,
                                  const quint32 nats1, double icnrg[], double iljnrg[], const double alfa[], double delta[],
                                  const int nalpha) const;
    };
    ...
    */
    ...
    SIRE_ALWAYS_INLINE void InterSoftCLJPotential::calculateEnergy(const InterSoftCLJPotential::Molecule &mol0,
                                                                   ...
                                                                   double scale_energy) const
    {
        throw SireError::incomplete_code(
            QObject::tr("InterSoftCLJPotential does not yet support this energy calculations!"), CODELOC);
    }
    ...
    SIRE_ALWAYS_INLINE void InterSoftCLJPotential::calculateForce(const InterSoftCLJPotential::Molecule &mol0,
                                                                  const InterSoftCLJPotential::Molecule &mol1,
                                                                  MolForceTable &forces0,
                                                                  InterSoftCLJPotential::ForceWorkspace &workspace,
                                                                  double scale_force) const
    {
        if (scale_force != 0 and not(mol0.isEmpty() or mol1.isEmpty()) and
    ...
    /** Calculate the coulomb forces on the atoms between the passed pair
        ...
        the passed workspace to perform the calculation. The forces
        are scaled by the optional 'scaled_forces' */
    SIRE_ALWAYS_INLINE void InterSoftCLJPotential::calculateCoulombForce(const InterSoftCLJPotential::Molecule &mol0,
                                                                         const InterSoftCLJPotential::Molecule &mol1,
                                                                         MolForceTable &forces0,
                                                                         InterSoftCLJPotential::ForceWorkspace &workspace,
                                                                         double scale_force) const
    ...
    /** Calculate the LJ forces on the atoms between the passed pair
        ...
        the passed workspace to perform the calculation. The forces
        are scaled by the optional 'scaled_forces' */
    SIRE_ALWAYS_INLINE void InterSoftCLJPotential::calculateLJForce(const InterSoftCLJPotential::Molecule &mol0,
                                                                    const InterSoftCLJPotential::Molecule &mol1,
                                                                    MolForceTable &forces0,
                                                                    InterSoftCLJPotential::ForceWorkspace &workspace,
                                                                    double scale_force) const
    ...
    SIRE_ALWAYS_INLINE void InterSoftCLJPotential::calculateField(const InterSoftCLJPotential::Molecule &mol0,
                                                                  const InterSoftCLJPotential::Molecule &mol1,
                                                                  const CLJProbe &probe, MolFieldTable &fields0,
    ...
    /** Calculate the coulomb and LJ fields from the passed molecule
        ...
        the passed workspace to perform the calculation. The fields
        are scaled by the optional 'scaled_fields' */
    SIRE_ALWAYS_INLINE void InterSoftCLJPotential::calculateField(const InterSoftCLJPotential::Molecule &mol,
    ...
    /** Calculate the coulomb fields on the atoms between the passed pair
        ...
        the passed workspace to perform the calculation. The fields
        are scaled by the optional 'scaled_fields' */
    SIRE_ALWAYS_INLINE void InterSoftCLJPotential::calculateCoulombField(const InterSoftCLJPotential::Molecule &mol0,
                                                                         const InterSoftCLJPotential::Molecule &mol1,
                                                                         const CLJProbe &probe, MolFieldTable &fields0,
                                                                         InterSoftCLJPotential::FieldWorkspace &workspace,
                                                                         double scale_field) const
    ...
    /** Calculate the coulomb field from the passed molecule
        ...
        the passed workspace to perform the calculation. The fields
        are scaled by the optional 'scaled_fields' */
    SIRE_ALWAYS_INLINE void InterSoftCLJPotential::calculateCoulombField(const InterSoftCLJPotential::Molecule &mol,
                                                                         const CLJProbe &probe, GridFieldTable &fields,
                                                                         InterSoftCLJPotential::FieldWorkspace &workspace,
                                                                         double scale_field) const
    {
    ...
    /** Calculate the LJ fields on the atoms between the passed pair
        ...
        the passed workspace to perform the calculation. The fields
        are scaled by the optional 'scaled_fields' */
    SIRE_ALWAYS_INLINE void InterSoftCLJPotential::calculateLJField(const InterSoftCLJPotential::Molecule &mol0,
                                                                    const InterSoftCLJPotential::Molecule &mol1,
                                                                    const CLJProbe &probe, MolFieldTable &fields0,
                                                                    InterSoftCLJPotential::FieldWorkspace &workspace,
                                                                    double scale_field) const
    ...
    /** Calculate the LJ field from the passed molecule
        ...
        the passed workspace to perform the calculation. The fields
        are scaled by the optional 'scaled_fields' */
    SIRE_ALWAYS_INLINE void InterSoftCLJPotential::calculateLJField(const InterSoftCLJPotential::Molecule &mol,
                                                                    const CLJProbe &probe, GridFieldTable &fields,
                                                                    InterSoftCLJPotential::FieldWorkspace &workspace,
                                                                    double scale_field) const
    {
    ...
    /** Calculate the component of the field represented by 'symbol' between the
        ...
        are scaled by the optional 'scaled_fields' */
    SIRE_ALWAYS_INLINE void InterSoftCLJPotential::calculateField(
        const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1, const CLJProbe &probe,
        MolFieldTable &fields0, const Symbol &symbol, const InterSoftCLJPotential::Components &components,
        InterSoftCLJPotential::FieldWorkspace &workspace, double scale_field) const
    {
        if (symbol == components.total())
    ...
    SIRE_ALWAYS_INLINE void InterSoftCLJPotential::calculatePotential(const InterSoftCLJPotential::Molecule &mol0,
                                                                      const InterSoftCLJPotential::Molecule &mol1,
                                                                      const CLJProbe &probe, MolPotentialTable &pots0,
                                                                      InterSoftCLJPotential::PotentialWorkspace &workspace,
                                                                      double scale_potential) const
    ...
    /** Calculate the coulomb and LJ potentials from the passed molecule
        ...
        the passed workspace to perform the calculation. The potentials
        are scaled by the optional 'scaled_potential' */
    SIRE_ALWAYS_INLINE void InterSoftCLJPotential::calculatePotential(const InterSoftCLJPotential::Molecule &mol,
    ...
    /** Calculate the coulomb potential on the atoms between the passed pair
        ...
        the passed workspace to perform the calculation. The potentials
        are scaled by the optional 'scaled_potential' */
    SIRE_ALWAYS_INLINE void InterSoftCLJPotential::calculateCoulombPotential(
        const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1, const CLJProbe &probe,
        MolPotentialTable &pots, InterSoftCLJPotential::PotentialWorkspace &workspace, double scale_potential) const
    {
        if (scale_potential != 0 and
            // not (mol0.isEmpty() or mol1.isEmpty()) and
            not spce->beyond(switchfunc->cutoffDistance(), mol0.aaBox(), mol1.aaBox()))
    ...
    /** Calculate the coulomb potential from the passed molecule
        ...
        are scaled by the optional 'scaled_potential' */
    SIRE_ALWAYS_INLINE void InterSoftCLJPotential::calculateCoulombPotential(
        const InterSoftCLJPotential::Molecule &mol, const CLJProbe &probe, GridPotentialTable &pots,
        InterSoftCLJPotential::PotentialWorkspace &workspace, double scale_potential) const
    {
        if (scale_potential != 0 and
            // not (mol0.isEmpty() or mol1.isEmpty()) and
            not spce->beyond(switchfunc->cutoffDistance(), mol.aaBox(), pots.grid().aaBox()))
    ...
    /** Calculate the LJ potentials on the atoms between the passed pair
        ...
        the passed workspace to perform the calculation. The potentials
        are scaled by the optional 'scaled_potential' */
    SIRE_ALWAYS_INLINE void InterSoftCLJPotential::calculateLJPotential(
        const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1, const CLJProbe &probe,
        MolPotentialTable &pots, InterSoftCLJPotential::PotentialWorkspace &workspace, double scale_potential) const
    {
        if (scale_potential != 0 and
    ...
    /** Calculate the component of the potential represented by 'symbol' between the
        ...
        are scaled by the optional 'scaled_potential' */
    SIRE_ALWAYS_INLINE void InterSoftCLJPotential::calculatePotential(
        const InterSoftCLJPotential::Molecule &mol0, const InterSoftCLJPotential::Molecule &mol1, const CLJProbe &probe,
        MolPotentialTable &pots, const Symbol &symbol, const InterSoftCLJPotential::Components &components,
        InterSoftCLJPotential::PotentialWorkspace &workspace, double scale_potential) const
    {
        if (symbol == components.total())
    ...
    /** Calculate the forces represented by the symbol 'symbol' between the
        ...
        the passed workspace to perform the calculation */
    SIRE_ALWAYS_INLINE void IntraSoftCLJPotential::calculateForce(const IntraSoftCLJPotential::Molecule &mol,

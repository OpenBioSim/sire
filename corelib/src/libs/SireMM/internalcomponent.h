...
namespace SireMM
{
    ...
    public:
        ...
        InternalEnergy(double bondnrg = 0, double anglenrg = 0, double dihedralnrg = 0, double impropernrg = 0,
                       double ubnrg = 0, double ssnrg = 0, double sbnrg = 0, double bbnrg = 0, double sbtnrg = 0,
        ...
        {
            return InternalEnergy(ibndnrg + other.ibndnrg, iangnrg + other.iangnrg, idihnrg + other.idihnrg,
                                  iimpnrg + other.iimpnrg, iubnrg + other.iubnrg, issnrg + other.issnrg,
                                  isbnrg + other.isbnrg, ibbnrg + other.ibbnrg, isbtnrg + other.isbtnrg,
                                  i14nrg + other.i14nrg);
        }
        ...
        {
            return ibndnrg + iangnrg + idihnrg + iimpnrg + iubnrg + issnrg + isbnrg + ibbnrg + isbtnrg + i14nrg.total();
        }
    ...
    private:
        ...
        /** All of the component energies */
        double ibndnrg, iangnrg, idihnrg, iimpnrg, iubnrg, issnrg, isbnrg, ibbnrg, isbtnrg;
    };

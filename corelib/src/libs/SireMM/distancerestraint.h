...
namespace SireMM
{
    ...
    */
    class SIREMM_EXPORT DistanceRestraint : public SireBase::ConcreteProperty<DistanceRestraint, ExpressionRestraint3D>
    {
    ...
    public:
        ...
        DistanceRestraint(const PointRef &point0, const PointRef &point1, const Expression &restraint);
        ...
        static DistanceRestraint harmonic(const PointRef &point0, const PointRef &point1,
                                          const SireUnits::Dimension::HarmonicBondConstant &force_constant);

        static DistanceRestraint halfHarmonic(const PointRef &point0, const PointRef &point1,
                                              const SireUnits::Dimension::Length &distance,
                                              const SireUnits::Dimension::HarmonicBondConstant &force_constant);

    protected:
        DistanceRestraint(const PointRef &point0, const PointRef &point1, const Expression &nrg_restraint,
    ...
    */
    ...
    public:
        ...
        DoubleDistanceRestraint(const PointRef &point0, const PointRef &point1, const PointRef &point2,
    ...
    */
    ...
    public:
        ...
        TripleDistanceRestraint(const PointRef &point0, const PointRef &point1, const PointRef &point2,

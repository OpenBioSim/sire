...
namespace SireMM
{
    ...
    */
    ...
    public:
        ...
        CLJExtractor(const MoleculeView &mol, EXTRACT_SOURCE extract_source, const PropertyMap &map = PropertyMap());

        CLJExtractor(const MoleculeView &mol, CLJAtoms::ID_SOURCE id_source, const PropertyMap &map = PropertyMap());
        CLJExtractor(const MoleculeView &mol, CLJAtoms::ID_SOURCE id_source, EXTRACT_SOURCE extract_source,
        ...
        void updateSelection(const AtomSelection &selection, CLJBoxes &boxes, CLJWorkspace &workspace);

        void update(const MoleculeView &new_molecule, CLJBoxes &boxes, CLJWorkspace &workspace);

        void remove(const AtomSelection &new_selection, CLJBoxes &boxes, CLJWorkspace &workspace);
        void remove(const MoleculeView &new_molecule, CLJBoxes &boxes, CLJWorkspace &workspace);

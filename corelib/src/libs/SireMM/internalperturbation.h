...
namespace SireMM
{
    ...
    */
    ...
    public:
        ...
        InternalPerturbation(const SireCAS::Expression &initial_function, const SireCAS::Expression &final_function,
                             const SireCAS::Expression &mapping_function, const PropertyMap &map);

        InternalPerturbation(const SireCAS::Expression &base_expression, const SireCAS::Identities &initial_forms,
                             const SireCAS::Identities &final_forms, const SireCAS::Expression &mapping_function,
        ...
        SireMol::PerturbationPtr recreate(const SireCAS::Expression &expression, const PropertyMap &map) const;
    ...
    /** This class represents a perturbation that maps the two-atom potential
        ...
        @author Christopher Woods
    */
    class SIREMM_EXPORT TwoAtomPerturbation : public SireBase::ConcreteProperty<TwoAtomPerturbation, InternalPerturbation>
    {
    ...
    public:
        ...
        TwoAtomPerturbation(const AtomID &atom0, const AtomID &atom1, const SireCAS::Expression &initial_form,
                            const SireCAS::Expression &final_form, const PropertyMap &map = PropertyMap());
        TwoAtomPerturbation(const AtomID &atom0, const AtomID &atom1, const SireCAS::Expression &initial_form,
                            const SireCAS::Expression &final_form, const SireCAS::Expression &mapping_function,
                            const PropertyMap &map = PropertyMap());

        TwoAtomPerturbation(const AtomID &atom0, const AtomID &atom1, const SireCAS::Expression &base_expression,
                            const SireCAS::Identities &initial_forms, const SireCAS::Identities &final_forms,
                            const PropertyMap &map = PropertyMap());
        TwoAtomPerturbation(const AtomID &atom0, const AtomID &atom1, const SireCAS::Expression &base_expression,
                            const SireCAS::Identities &initial_forms, const SireCAS::Identities &final_forms,
    ...
    */
    ...
    public:
        ...
        ThreeAtomPerturbation(const AtomID &atom0, const AtomID &atom1, const AtomID &atom2,
                              const SireCAS::Expression &initial_form, const SireCAS::Expression &final_form,
                              const PropertyMap &map = PropertyMap());
        ThreeAtomPerturbation(const AtomID &atom0, const AtomID &atom1, const AtomID &atom2,
                              const SireCAS::Expression &initial_form, const SireCAS::Expression &final_form,
                              const SireCAS::Expression &mapping_function, const PropertyMap &map = PropertyMap());
        ...
        ThreeAtomPerturbation(const AtomID &atom0, const AtomID &atom1, const AtomID &atom2,
                              const SireCAS::Expression &base_expression, const SireCAS::Identities &initial_forms,
                              const SireCAS::Identities &final_forms, const PropertyMap &map = PropertyMap());
        ThreeAtomPerturbation(const AtomID &atom0, const AtomID &atom1, const AtomID &atom2,
                              const SireCAS::Expression &base_expression, const SireCAS::Identities &initial_forms,
                              const SireCAS::Identities &final_forms, const SireCAS::Expression &mapping_function,
                              const PropertyMap &map = PropertyMap());
    ...
    /** This class represents a perturbation that maps the four-atom potential
        ...
        @author Christopher Woods
    */
    class SIREMM_EXPORT FourAtomPerturbation : public SireBase::ConcreteProperty<FourAtomPerturbation, InternalPerturbation>
    {
    ...
    public:
        ...
        FourAtomPerturbation(const AtomID &atom0, const AtomID &atom1, const AtomID &atom2, const AtomID &atom3,
                             const SireCAS::Expression &initial_form, const SireCAS::Expression &final_form,
                             const PropertyMap &map = PropertyMap());
        FourAtomPerturbation(const AtomID &atom0, const AtomID &atom1, const AtomID &atom2, const AtomID &atom3,
                             const SireCAS::Expression &initial_form, const SireCAS::Expression &final_form,

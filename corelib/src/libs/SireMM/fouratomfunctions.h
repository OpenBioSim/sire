...
namespace SireMM
{
    ...
    public:
        FourAtomFunction();
        FourAtomFunction(const CGAtomIdx &atom0, const CGAtomIdx &atom1, const CGAtomIdx &atom2, const CGAtomIdx &atom3,
    ...
    namespace detail
    {
        ...
        {
        public:
            IDQuad(quint32 atom0 = 0, quint32 atom1 = 0, quint32 atom2 = 0, quint32 atom3 = 0);
        ...
        {
            return (idquad.atom0 << 24) | ((idquad.atom1 << 16) & 0x00FF0000) | ((idquad.atom2 << 8) & 0x0000FF00) |
    ...
    */
    class SIREMM_EXPORT FourAtomFunctions : public SireBase::ConcreteProperty<FourAtomFunctions, AtomFunctions>
    {
    ...
    public:
        ...
        Expression force(AtomIdx atom0, AtomIdx atom1, AtomIdx atom2, AtomIdx atom3, const Symbol &symbol) const;
        Expression force(const AtomID &atom0, const AtomID &atom1, const AtomID &atom2, const AtomID &atom3,

...
namespace SireMM
{
    namespace detail
    {
        ...
        template class IntraScaledAtomicParameters<AtomicParameters3D<LJParamID>, IntraScaledParameters<LJNBPairs>>;
    } // namespace detail
} // namespace SireMM
...
QDataStream &operator<<(QDataStream &ds, const SireMM::detail::LJParamID &ljparam)
{
    ds << LJParameterDB::getLJParameter(ljparam.ljid);
    return ds;
}

QDataStream &operator>>(QDataStream &ds, SireMM::detail::LJParamID &ljparam)
{
    LJParameter lj;
...
static PackedArray2D<LJParamID> getLJParamIDs(const PartialMolecule &molecule, const PropertyName &lj_property)
{
        ...
        if (selected_atoms.selectedAllCutGroups())
        {
            ...
            for (CGIdx i(0); i < ncg; ++i)
            {
                ...
                if (selected_atoms.selectedAll(i))
                {
                    ...
                    {
                        group_ljones_array[j].ljid = LJParameterDB::_locked_addLJParameter(group_ljs[j]);
                    }
                }
                else
                {
        ...
        else
        {
            foreach (CGIdx i, selected_atoms.selectedCutGroups())
            {
                ...
                if (selected_atoms.selectedAll(i))
                {
                    for (Index j(0); j < nats; ++j)
                    {
                        group_cljones_array[j].ljid = LJParameterDB::_locked_addLJParameter(group_ljs[j]);
                    }
                }
                else
                {
...
static const RegisterMetaType<LJPotential> r_ljpot(MAGIC_ONLY, NO_ROOT, "SireMM::LJPotential");

/** Serialise to a binary datastream */
QDataStream &operator<<(QDataStream &ds, const LJPotential &ljpot)
{
...
QDataStream &operator>>(QDataStream &ds, LJPotential &ljpot)
{
    ...
    if (v == 1)
    {
        ...
        ljpot.switchfunc = ljpot.props.property("switchingFunction").asA<SwitchingFunction>();

        ljpot.combining_rules = LJParameterDB::interpret(ljpot.props.property("combiningRules").asAString());
...
LJPotential::LJPotential()
    : spce(Space::null()), switchfunc(SwitchingFunction::null()),
      combining_rules(LJParameterDB::interpret("arithmetic")), need_update_ljpairs(true)
{
    // record the defaults
...
LJPotential::LJPotential(const LJPotential &other)
    : ljpairs(other.ljpairs), props(other.props), spce(other.spce), switchfunc(other.switchfunc),
      combining_rules(other.combining_rules), need_update_ljpairs(other.need_update_ljpairs)
{
}
...
static const RegisterMetaType<InterLJPotential> r_interlj(MAGIC_ONLY, NO_ROOT, InterLJPotential::typeName());

/** Serialise to a binary datastream */
QDataStream &operator<<(QDataStream &ds, const InterLJPotential &interlj)
{
...
/** Extract from a binary datastream */
QDataStream &operator>>(QDataStream &ds, InterLJPotential &interlj)
{
...
/** Copy constructor */
InterLJPotential::InterLJPotential(const InterLJPotential &other) : LJPotential(other)
{
}
...
*/
InterLJPotential::Parameters InterLJPotential::getParameters(const PartialMolecule &molecule, const PropertyMap &map)
{
    need_update_ljpairs = true;

    return Parameters(molecule, map[parameters().coordinates()], getLJParamIDs(molecule, map[parameters().lj()]));
}
...
/** Update the parameters for the molecule going from 'old_molecule' to
    ...
    \throw SireError::incompatible_error
*/
InterLJPotential::Parameters InterLJPotential::updateParameters(const InterLJPotential::Parameters &old_params,
                                                                ...
                                                                const PropertyMap &map)
{
    ...
    bool new_lj = (old_molecule.version(lj_property) != new_molecule.version(lj_property));
                                                                ...
                                                                const PropertyMap &old_map, const PropertyMap &new_map)
{
    ...
    bool changed_lj = (new_lj != old_lj) or (old_molecule.version(old_lj) != new_molecule.version(old_lj));
...
/** Return the InterLJPotential::Molecule representation of 'molecule',
    ...
    \throw SireError::incompatible_error
*/
InterLJPotential::Molecule InterLJPotential::parameterise(const PartialMolecule &molecule, const PropertyMap &map)
{
...
/** Convert the passed group of molecules into InterLJPotential::Molecules,
    ...
    \throw SireError::incompatible_error
*/
InterLJPotential::Molecules InterLJPotential::parameterise(const MoleculeGroup &molecules, const PropertyMap &map)
{
...
void InterLJPotential::_pvt_calculateEnergy(const InterLJPotential::Molecule &mol0,
                                            const InterLJPotential::Molecule &mol1, InterLJPotential::Energy &energy,
                                            InterLJPotential::EnergyWorkspace &distmat, double scale_energy) const
{
...
#ifdef SIRE_USE_SSE
            {
                ...
                for (quint32 i = 0; i < nats0; ++i)
                {
                    ...
                    for (quint32 j = 0; j < nats1 - 1; j += 2)
                    {
                        ...
                        __m128d sse_nrg = calcLJEnergy(distmat[j], distmat[j + 1], ljpair0, ljpair1);
...
#else
            {
                for (quint32 i = 0; i < nats0; ++i)
                {
                    ...
                    for (quint32 j = 0; j < nats1; ++j)
                    {
                        ...
                        iljnrg += calcLJEnergy(distmat[j], ljpairs.constData()[ljpairs.map(param0.ljid, param1.ljid)]);
                    }
                }
            }
#endif
...
/** Add to the forces in 'forces0' the forces acting on 'mol0' caused
    by 'mol1' */
void InterLJPotential::_pvt_calculateLJForce(const InterLJPotential::Molecule &mol0,
                                             const InterLJPotential::Molecule &mol1, MolForceTable &forces0,
                                             InterLJPotential::ForceWorkspace &distmat, double scale_force) const
{
...
/** Add to the potentials in 'pots0' the LJ potential acting on 'mol0' caused
    by 'mol1' */
void InterLJPotential::_pvt_calculateLJPotential(const InterLJPotential::Molecule &mol0,
                                                 const InterLJPotential::Molecule &mol1, const LJProbe &probe,
...
/** Add to the potentials in 'pots0' the potential on the passed
    grid caused by 'mol' */
void InterLJPotential::_pvt_calculateLJPotential(const InterLJPotential::Molecule &mol, const LJProbe &probe,
...
/** Calculate the field caused by the molecule 'mol' on the grid points in
    'fields' */
void InterLJPotential::_pvt_calculateLJField(const InterLJPotential::Molecule &mol, const LJProbe &probe,
                                             GridFieldTable &fields, InterLJPotential::FieldWorkspace &distmat,
...
void InterLJPotential::_pvt_calculateLJField(const InterLJPotential::Molecule &mol0,
                                             const InterLJPotential::Molecule &mol1, const LJProbe &probe,
                                             MolFieldTable &fields0, InterLJPotential::FieldWorkspace &distmat,
                                             double scale_field) const
{
...
static const RegisterMetaType<IntraLJPotential> r_intralj(MAGIC_ONLY, NO_ROOT, IntraLJPotential::typeName());

/** Serialise to a binary datastream */
QDataStream &operator<<(QDataStream &ds, const IntraLJPotential &intralj)
{
...
/** Extract from a binary datastream */
QDataStream &operator>>(QDataStream &ds, IntraLJPotential &intralj)
{
...
/** Copy constructor */
IntraLJPotential::IntraLJPotential(const IntraLJPotential &other) : LJPotential(other)
{
}
...
/** Return all of the parameters needed by this potential for
    ...
    \throw SireError::incompatible_error
*/
IntraLJPotential::Parameters IntraLJPotential::getParameters(const PartialMolecule &molecule, const PropertyMap &map)
{
    need_update_ljpairs = true;

    return Parameters(AtomicParameters3D<LJParamID>(molecule, map[parameters().coordinates()],
                                                    getLJParamIDs(molecule, map[parameters().lj()])),
                      IntraScaledParameters<LJNBPairs>(molecule, map[parameters().intraScaleFactors()]));
}
...
/** Update the parameters for the molecule going from 'old_molecule' to
    ...
    \throw SireError::incompatible_error
*/
IntraLJPotential::Parameters IntraLJPotential::updateParameters(const IntraLJPotential::Parameters &old_params,
                                                                const PartialMolecule &old_molecule,
                                                                const PartialMolecule &new_molecule,
                                                                const PropertyMap &map)
{
    ...
    if (new_scl)
        new_params.setIntraScaleFactors(IntraScaledParameters<LJNBPairs>(new_molecule, scl_property));
                                                                ...
                                                                const PropertyMap &old_map, const PropertyMap &new_map)
{
    ...
    if (changed_scl)
        new_params.setIntraScaleFactors(IntraScaledParameters<LJNBPairs>(new_molecule, new_scl));
...
/** Return the IntraLJPotential::Molecule representation of 'molecule',
    ...
    \throw SireError::incompatible_error
*/
IntraLJPotential::Molecule IntraLJPotential::parameterise(const PartialMolecule &molecule, const PropertyMap &map)
{
...
/** Concert the passed group of molecules into IntraLJPotential::Molecules,
    ...
    \throw SireError::incompatible_error
*/
IntraLJPotential::Molecules IntraLJPotential::parameterise(const MoleculeGroup &molecules, const PropertyMap &map)
{
...
void IntraLJPotential::calculateEnergy(const LJNBPairs::CGPairs &group_pairs,
                                       ...
                                       const IntraLJPotential::Parameter *params1_array, const quint32 nats0,
                                       const quint32 nats1, double &iljnrg) const
{
    ...
    else
    {
        ...
        for (quint32 i = 0; i < nats0; ++i)
        {
            ...
            for (quint32 j = 0; j < nats1; ++j)
            {
                ...
                {
                    iljnrg += ljscl.lj() *
                              calcLJEnergy(distmat[j], ljpairs.constData()[ljpairs.map(param0.ljid, param1.ljid)]);
                }
            }
        }
    }
...
void IntraLJPotential::calculateEnergy(const LJNBPairs::CGPairs &group_pairs, const QSet<Index> &atoms0,
                                       const QSet<Index> &atoms1, IntraLJPotential::EnergyWorkspace &distmat,
                                       const IntraLJPotential::Parameter *params0_array,
                                       const IntraLJPotential::Parameter *params1_array, const quint32 nats0,
                                       const quint32 nats1, double &iljnrg) const
{
...
void IntraLJPotential::calculateEnergy(const IntraLJPotential::Molecule &mol, IntraLJPotential::Energy &energy,
                                       IntraLJPotential::EnergyWorkspace &distmat, double scale_energy) const
{
    ...
    for (quint32 igroup = 0; igroup < ngroups; ++igroup)
    {
        ...
        for (quint32 jgroup = igroup; jgroup < ngroups; ++jgroup)
        {
            ...
            const LJNBPairs::CGPairs &group_pairs = nbpairs(cgidx_igroup, cgidx_jgroup);
            ...
            calculateEnergy(group_pairs, distmat, params0_array, params1_array, nats0, nats1, iljnrg);
...
void IntraLJPotential::calculateEnergy(const IntraLJPotential::Molecule &mol,
                                       const IntraLJPotential::Molecule &rest_of_mol, IntraLJPotential::Energy &energy,
                                       IntraLJPotential::EnergyWorkspace &distmat, double scale_energy) const
{
    ...
    for (quint32 igroup = 0; igroup < ngroups0; ++igroup)
    {
        ...
        for (quint32 jgroup = 0; jgroup < ngroups1; ++jgroup)
        {
            ...
            if (cgidx_igroup == cgidx_jgroup or mol.molecule().selection().selected(cgidx_jgroup))
            {
                ...
                calculateEnergy(group_pairs, atoms0, atoms1, distmat, params0_array, params1_array, nats0, nats1,
                                iljnrg);
            }
            else
            {
...
void IntraLJPotential::calculateLJForce(const LJNBPairs::CGPairs &group_pairs, const CoordGroup &group0,
                ...
                if (param0.ljid != 0)
                {
                    ...
                    for (quint32 j = 0; j < nats1; ++j)
                    {
                        ...
                        if (ljscl.lj() != 0 and param1.ljid != 0)
                        {
                            ...
                            // calculate the energy
                            const double ljnrg = ljscl.lj() * 4 * ljpair.epsilon() * (sig_over_dist12 - sig_over_dist6);
                ...
                if (param0.ljid != 0)
                {
                    ...
                    for (quint32 j = 0; j < nats1; ++j)
                    {
                        ...
                        if (ljscl.lj() != 0 and param1.ljid != 0)
                        {
                            ...
                            const Vector force =
                                (ljscl.lj() * 4 * ljpair.epsilon() * (6.0 * sig_over_dist6 - 12.0 * sig_over_dist12)) *
                                distmat[j].direction();
...
void IntraLJPotential::calculateLJForce(const LJNBPairs::CGPairs &group_pairs, const QSet<Index> &atoms0,
                                        const QSet<Index> &atoms1, const CoordGroup &group0, const CoordGroup &group1,
                                        const double mindist, IntraLJPotential::ForceWorkspace &distmat,
                                        const IntraLJPotential::Parameter *params0_array,
                                        const IntraLJPotential::Parameter *params1_array, Vector *group_forces0_array,
                                        const double scale_force) const
{
    if (atoms0.isEmpty() or atoms1.isEmpty())
        return;
...
/** Calculate the LJ forces between the atoms in the molecule 'mol'
    ...
    the passed workspace to perform the calculation */
void IntraLJPotential::calculateLJForce(const IntraLJPotential::Molecule &mol, MolForceTable &forces,
                                        IntraLJPotential::ForceWorkspace &distmat, double scale_force) const
{
...
/** Calculate the LJ forces between the atoms in the molecule 'mol'
    and add these forces onto 'forces'. This uses
    the passed workspace to perform the calculation */
void IntraLJPotential::calculateForce(const IntraLJPotential::Molecule &mol, MolForceTable &forces,
                                      IntraLJPotential::ForceWorkspace &distmat, double scale_force) const
{
...
void IntraLJPotential::calculateLJForce(const IntraLJPotential::Molecule &mol,
                                        const IntraLJPotential::Molecule &rest_of_mol, MolForceTable &forces,
                                        IntraLJPotential::ForceWorkspace &distmat, double scale_force) const
{
...
void IntraLJPotential::calculateField(const IntraLJPotential::Molecule &mol, const LJProbe &probe,
                                      MolFieldTable &fields, IntraLJPotential::FieldWorkspace &workspace,
                                      double scale_field) const
{
    throw SireError::incomplete_code(QObject::tr("The code to calculate intramolecular LJ fields "
...
void IntraLJPotential::calculateField(const IntraLJPotential::Molecule &mol, const LJProbe &probe,
                                      ...
                                      IntraLJPotential::FieldWorkspace &workspace, double scale_field) const
{
    throw SireError::incomplete_code(QObject::tr("The code to calculate intramolecular LJ fields "
                                                 "has yet to be written..."),
                                     CODELOC);
...
void IntraLJPotential::calculateField(const IntraLJPotential::Molecule &mol0, const IntraLJPotential::Molecule &mol1,
                                      const LJProbe &probe, MolFieldTable &forces0,
                                      IntraLJPotential::FieldWorkspace &workspace, double scale_field) const
{
    throw SireError::incomplete_code(QObject::tr("The code to calculate intramolecular LJ fields "
                                                 "has yet to be written..."),
...
void IntraLJPotential::calculateField(const IntraLJPotential::Molecule &mol0, const IntraLJPotential::Molecule &mol1,
                                      const LJProbe &probe, MolFieldTable &forces0, const Symbol &symbol,
                                      const Components &components, IntraLJPotential::FieldWorkspace &workspace,
                                      double scale_field) const
{
    throw SireError::incomplete_code(QObject::tr("The code to calculate intramolecular LJ fields "
                                                 "has yet to be written..."),
...
void IntraLJPotential::calculateField(const IntraLJPotential::Molecule &mol0, const LJProbe &probe,
                                      GridFieldTable &fields, IntraLJPotential::FieldWorkspace &workspace,
                                      double scale_field) const
{
    throw SireError::incomplete_code(QObject::tr("The code to calculate intramolecular LJ fields "
                                                 "has yet to be written..."),
...
void IntraLJPotential::calculateLJField(const IntraLJPotential::Molecule &mol0, const IntraLJPotential::Molecule &mol1,
                                        const LJProbe &probe, MolFieldTable &fields0,
                                        IntraLJPotential::ForceWorkspace &workspace, double scale_field) const
{
    throw SireError::incomplete_code(QObject::tr("The code to calculate intramolecular LJ fields "
                                                 "has yet to be written..."),
                                     CODELOC);
...
void IntraLJPotential::calculateLJField(const IntraLJPotential::Molecule &mol0, const LJProbe &probe,
                                        GridFieldTable &fields, IntraLJPotential::ForceWorkspace &workspace,
                                        double scale_field) const
{
    throw SireError::incomplete_code(QObject::tr("The code to calculate intramolecular LJ fields "
                                                 "has yet to be written..."),
...
void IntraLJPotential::calculatePotential(const IntraLJPotential::Molecule &mol, const LJProbe &probe,
                                          MolPotentialTable &potentials,
                                          IntraLJPotential::PotentialWorkspace &workspace, double scale_potential) const
{
    throw SireError::incomplete_code(QObject::tr("The code to calculate intramolecular LJ potentials "
                                                 "has yet to be written..."),
                                     CODELOC);
}
...
void IntraLJPotential::calculatePotential(const IntraLJPotential::Molecule &mol, const LJProbe &probe,
                                          ...
                                          const Components &components, IntraLJPotential::PotentialWorkspace &workspace,
                                          double scale_potential) const
{
    throw SireError::incomplete_code(QObject::tr("The code to calculate intramolecular LJ potentials "
                                                 "has yet to be written..."),
...
void IntraLJPotential::calculatePotential(const IntraLJPotential::Molecule &mol0,
                                          const IntraLJPotential::Molecule &mol1, const LJProbe &probe,
                                          MolPotentialTable &pots0, IntraLJPotential::PotentialWorkspace &workspace,
                                          double scale_potential) const
{
    throw SireError::incomplete_code(QObject::tr("The code to calculate intramolecular LJ potentials "
                                                 "has yet to be written..."),
...
void IntraLJPotential::calculatePotential(const IntraLJPotential::Molecule &mol0,
                                          const IntraLJPotential::Molecule &mol1, const LJProbe &probe,
                                          MolPotentialTable &pots0, const Symbol &symbol, const Components &components,
                                          IntraLJPotential::PotentialWorkspace &workspace, double scale_potential) const
{
    throw SireError::incomplete_code(QObject::tr("The code to calculate intramolecular LJ potentials "
                                                 "has yet to be written..."),
...
void IntraLJPotential::calculatePotential(const IntraLJPotential::Molecule &mol0, const LJProbe &probe,
                                          GridPotentialTable &pots, IntraLJPotential::PotentialWorkspace &workspace,
                                          double scale_potential) const
{
    throw SireError::incomplete_code(QObject::tr("The code to calculate intramolecular LJ potentials "
                                                 "has yet to be written..."),
...
void IntraLJPotential::calculateLJPotential(const IntraLJPotential::Molecule &mol0, const LJProbe &probe,
                                            GridPotentialTable &pots, IntraLJPotential::PotentialWorkspace &workspace,
                                            double scale_potential) const
{
    throw SireError::incomplete_code(QObject::tr("The code to calculate intramolecular LJ potentials "

...
MemoryMonitor::MemoryMonitor(int time_ms) : QThread(), ms(time_ms)
{
}

MemoryMonitor::MemoryMonitor(const QString &file, int time_ms) : QThread(), filename(file), ms(time_ms)
{
}

...
*/
void SharedPolyPointerBase::save(QDataStream &ds, const char *objname, const void *data)
{
    ...
    if (not QMetaType::save(ds, id, data))
        throw SireError::program_bug(
            QObject::tr("There was an error saving the object of type \"%1\". "
...
void *SharedPolyPointerBase::read(QDataStream &ds, void *ptr, const char *objname)
{
    ...
    else
    {
        ...
        if (id == 0 or not QMetaType::isRegistered(id))
            throw SireError::unknown_type(QObject::tr("Cannot deserialise an object of type \"%1\". "
        ...
        if (not QMetaType::load(ds, id, ptr))
            throw SireError::program_bug(
                QObject::tr("There was an error loading the object of type \"%1\"").arg(type_name), CODELOC);

        return ptr;
    }
}

void SharedPolyPointerBase::throwInvalidCast(const QString &oldtype, const QString &newtype)
{
    throw SireError::invalid_cast(QObject::tr("Cannot cast from a SharedPolyPointer of type \"%1\""

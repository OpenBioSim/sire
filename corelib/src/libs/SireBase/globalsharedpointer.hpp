...
namespace SireBase
{
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE T *GlobalSharedPointerBase::registerObject(const T *obj_ptr)
    {
        if (not obj_ptr)
        ...
        QSet<const void *> &registry = GlobalSharedPointerBase::getRegistry(SharedPolyPointerHelper<T>::typeName());

        for (typename QSet<const void *>::const_iterator it = registry.constBegin(); it != registry.constEnd(); ++it)
        {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void GlobalSharedPointerBase::unregisterObject(const T *obj_ptr)
    {
        if (not obj_ptr)
            return;
    ...
    */
    template <class T>
    class SIREBASE_EXPORT GlobalSharedPointer : private SharedPolyPointer<T>, private GlobalSharedPointerBase
    {
    ...
    /** Null constructor */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE GlobalSharedPointer<T>::GlobalSharedPointer()
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void GlobalSharedPointer<T>::registerGlobalPointer(bool auto_detach)
    {
        if (this->constData())
        {
            if (auto_detach)
            ...
            SharedPolyPointer<T>::operator=(GlobalSharedPointerBase::registerObject<T>(this->constData()));
        }
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE GlobalSharedPointer<T>::GlobalSharedPointer(T *data)
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE GlobalSharedPointer<T>::GlobalSharedPointer(const T &obj)
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE GlobalSharedPointer<T>::GlobalSharedPointer(const SharedPolyPointer<T> &o)
    ...
    /** Copy constructor */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE GlobalSharedPointer<T>::GlobalSharedPointer(const GlobalSharedPointer<T> &o)
        : SharedPolyPointer<T>(static_cast<const SharedPolyPointer<T> &>(o)), GlobalSharedPointerBase()
    {
    ...
    template <class T>
    template <class S>
    SIRE_OUTOFLINE_TEMPLATE GlobalSharedPointer<T>::GlobalSharedPointer(const GlobalSharedPointer<S> &o)
        : SharedPolyPointer<T>(o), GlobalSharedPointerBase()
    {
        this->registerGlobalPointer();
    }
    ...
    template <class T>
    template <class S>
    SIRE_OUTOFLINE_TEMPLATE GlobalSharedPointer<T>::GlobalSharedPointer(S *data)
        : SharedPolyPointer<T>(data), GlobalSharedPointerBase()
    {
        this->registerGlobalPointer();
    }
    ...
    template <class T>
    template <class S>
    SIRE_OUTOFLINE_TEMPLATE GlobalSharedPointer<T>::GlobalSharedPointer(const S &obj)
        : SharedPolyPointer<T>(obj), GlobalSharedPointerBase()
    {
        this->registerGlobalPointer();
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE GlobalSharedPointer<T> &GlobalSharedPointer<T>::operator=(T *o)
    {
        if (SharedPolyPointer<T>::unique())
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE GlobalSharedPointer<T> &GlobalSharedPointer<T>::operator=(const T &obj)
    {
        if (SharedPolyPointer<T>::unique())
            GlobalSharedPointerBase::unregisterObject(this->constData());
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE GlobalSharedPointer<T> &GlobalSharedPointer<T>::operator=(const GlobalSharedPointer<T> &o)
    {
        if (SharedPolyPointer<T>::unique())
            GlobalSharedPointerBase::unregisterObject(this->constData());
    ...
    template <class T>
    template <class S>
    SIRE_OUTOFLINE_TEMPLATE GlobalSharedPointer<T> &GlobalSharedPointer<T>::operator=(const GlobalSharedPointer<S> &o)
    {
        if (SharedPolyPointer<T>::unique())
            GlobalSharedPointerBase::unregisterObject(this->constData());
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE GlobalSharedPointer<T> &GlobalSharedPointer<T>::operator=(int val)
    {
        if (SharedPolyPointer<T>::unique())
            GlobalSharedPointerBase::unregisterObject(this->constData());
    ...
    template <class T>
    template <class S>
    SIRE_OUTOFLINE_TEMPLATE GlobalSharedPointer<T> &GlobalSharedPointer<T>::operator=(const S &obj)
    {
        if (SharedPolyPointer<T>::unique())
            GlobalSharedPointerBase::unregisterObject(this->constData());
    ...
    template <class T>
    template <class S>
    SIRE_OUTOFLINE_TEMPLATE GlobalSharedPointer<T> &GlobalSharedPointer<T>::operator=(S *obj)
    {
        if (SharedPolyPointer<T>::unique())
            GlobalSharedPointerBase::unregisterObject(this->constData());
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE bool GlobalSharedPointer<T>::unique() const
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &GlobalSharedPointer<T>::operator*() const
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE GlobalSharedPointer<T>::operator const T *() const
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T *GlobalSharedPointer<T>::data() const
    {
        return SharedPolyPointer<T>::constData();
    }
    ...
    /** Return the raw pointer */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T *GlobalSharedPointer<T>::constData() const
    {
        return SharedPolyPointer<T>::constData();
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE bool GlobalSharedPointer<T>::operator!() const
    {
        return SharedPolyPointer<T>::operator!();
    }
    ...
    /** Comparison operator */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE bool GlobalSharedPointer<T>::operator==(const GlobalSharedPointer<T> &other) const
    {
    ...
    /** Comparison operator */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE bool GlobalSharedPointer<T>::operator==(const T *other_ptr) const
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const char *GlobalSharedPointer<T>::what() const
    {
    ...
    template <class T>
    template <class S>
    SIRE_OUTOFLINE_TEMPLATE bool GlobalSharedPointer<T>::isA() const
    {
    ...
    */
    template <class T>
    template <class S>
    SIRE_OUTOFLINE_TEMPLATE const S &GlobalSharedPointer<T>::asA() const
    {

...
namespace SireBase
{
    ...
    */
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE NullProp<T>::~NullProp()
    {
    }

    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const Sire::RegisterMetaType<NullProp<T>> NullProp<T>::r_null;
...
template <class T>
SIRE_OUTOFLINE_TEMPLATE QDataStream &operator<<(QDataStream &ds, const SireBase::NullProp<T> &)
{
...
template <class T>
SIRE_OUTOFLINE_TEMPLATE QDataStream &operator>>(QDataStream &ds, SireBase::NullProp<T> &)
{

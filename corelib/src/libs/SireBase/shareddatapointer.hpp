...
namespace SireBase
{
    ...
    */
    ...
    /** Null constructor */
    template <class T>
    Q_INLINE_TEMPLATE SharedDataPointer<T>::SharedDataPointer() : d(0)
    {
    }
    ...
    template <class T>
    Q_INLINE_TEMPLATE SharedDataPointer<T>::SharedDataPointer(const T &obj)
    {
    ...
    /** Copy constructor */
    template <class T>
    Q_INLINE_TEMPLATE SharedDataPointer<T>::SharedDataPointer(const SharedDataPointer<T> &other) : d(other.d)
    {
        if (d)
            d->ref.ref();
    }
    ...
    /** Move constructor */
    template <class T>
    Q_INLINE_TEMPLATE SharedDataPointer<T>::SharedDataPointer(SharedDataPointer<T> &&other) : d(other.d)
    {
        other.d = 0;
    }
    ...
    /** Destructor */
    template <class T>
    Q_INLINE_TEMPLATE SharedDataPointer<T>::~SharedDataPointer()
    {
        if (d && !d->ref.deref())
            delete d;
        d = 0;
    ...
    template <class T>
    Q_INLINE_TEMPLATE SharedDataPointer<T> &SharedDataPointer<T>::operator=(int)
    {
    ...
    template <class T>
    Q_INLINE_TEMPLATE SharedDataPointer<T> &SharedDataPointer<T>::operator=(T *ptr)
    {
        if (ptr != d)
        {
            if (ptr)
    ...
    template <class T>
    Q_INLINE_TEMPLATE SharedDataPointer<T> &SharedDataPointer<T>::operator=(const T &obj)
    {
        if (d != &obj)
        {
            T *obj_ptr = const_cast<T *>(&obj);
    ...
    template <class T>
    Q_INLINE_TEMPLATE SharedDataPointer<T> &SharedDataPointer<T>::operator=(const SharedDataPointer<T> &other)
    {
        if (other.d != d)
        {
            if (other.d)
    ...
    template <class T>
    Q_INLINE_TEMPLATE SharedDataPointer<T> &SharedDataPointer<T>::operator=(SharedDataPointer<T> &&other)
    {
        qSwap(d, other.d);
        return *this;
    }
    ...
    template <class T>
    Q_INLINE_TEMPLATE void SharedDataPointer<T>::detach()
    {
    ...
    template <class T>
    Q_INLINE_TEMPLATE T &SharedDataPointer<T>::operator*()
    {
        detach();
        return *d;
    }
    ...
    /** Dereference this pointer */
    template <class T>
    Q_INLINE_TEMPLATE const T &SharedDataPointer<T>::operator*() const
    {
        return *d;
    }
    ...
    template <class T>
    Q_INLINE_TEMPLATE const T &SharedDataPointer<T>::read() const
    {
        return *d;
    }
    ...
    template <class T>
    Q_INLINE_TEMPLATE T &SharedDataPointer<T>::write()
    {
        detach();
        return *d;
    }
    ...
    template <class T>
    Q_INLINE_TEMPLATE SharedDataPointer<T>::operator T *()
    {
        detach();
        return d;
    }
    ...
    /** Cast back to a normal pointer */
    template <class T>
    Q_INLINE_TEMPLATE SharedDataPointer<T>::operator const T *() const
    {
        return d;
    }
    ...
    template <class T>
    Q_INLINE_TEMPLATE T *SharedDataPointer<T>::data()
    {
        detach();
        return d;
    }
    ...
    /** Return the pointer held by this shared pointer */
    template <class T>
    Q_INLINE_TEMPLATE const T *SharedDataPointer<T>::data() const
    {
        return d;
    }
    ...
    /** Return the pointer held by this shared pointer */
    template <class T>
    Q_INLINE_TEMPLATE const T *SharedDataPointer<T>::constData() const
    {
        return d;
    }
    ...
    template <class T>
    Q_INLINE_TEMPLATE bool SharedDataPointer<T>::operator!() const
    {
        return !d;
    }
    ...
    /** Comparison operator */
    template <class T>
    Q_INLINE_TEMPLATE bool SharedDataPointer<T>::operator==(const SharedDataPointer<T> &other) const
    {
        return d == other.d;
    }
    ...
    /** Comparison operator */
    template <class T>
    Q_INLINE_TEMPLATE bool SharedDataPointer<T>::operator==(const T *other_ptr) const
    {
        return d == other_ptr;
    }

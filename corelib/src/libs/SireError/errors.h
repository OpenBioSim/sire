...
namespace SireError
{
    ...
    */
    ...
    public:
        ...
        assertation_failed(QString err, QString place = QString()) : exception(err, place)
        {
        }
    ...
    public:
        ...
        file_error(const QString &err, const QString &place = QString()) : exception(err, place)
        {
        }

        file_error(const QFile &file, QString place = QString()) : exception(fileError(file), place)
        {
        }
    ...
    public:
        ...
        process_error(const QString &err, const QString place = QString()) : exception(err, place)
        {
        }

        process_error(const QString &executable, const QProcess &process, QString place = QString())
    ...
    public:
        ...
        unavailable_resource(QString err, QString place = QString()) : exception(err, place)
        {
        }
    ...
    public:
        ...
        io_error(QString err, QString place = QString()) : exception(err, place)
        {
        }
    ...
    */
    ...
    public:
        ...
        id_error(QString err, QString place = QString()) : exception(err, place)
        {
        }

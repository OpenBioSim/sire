...
namespace SireMol
{
    ...
    */
    ...
    public:
        ...
        virtual void addIfUnique(const MoleculeView &molview, const MGID &mgid) = 0;
        virtual void addIfUnique(const ViewsOfMol &molviews, const MGID &mgid) = 0;
        virtual void addIfUnique(const Molecules &molecules, const MGID &mgid) = 0;
        virtual void addIfUnique(const MoleculeGroup &molgroup, const MGID &mgid) = 0;
        ...
        virtual void loadFrame(int frame, const SireBase::LazyEvaluator &evaluator);
    ...
    protected:
        ...
        void changeNameIndex(MGNum mgnum, const MGName &old_name, const MGName &new_name);
    ...
    /** This class holds a collection of MoleculeGroup objects. This
        ...
        @author Christopher Woods
    */
    class SIREMOL_EXPORT MoleculeGroups : public ConcreteProperty<MoleculeGroups, MolGroupsBase>
    {

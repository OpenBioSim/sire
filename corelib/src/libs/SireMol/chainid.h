...
namespace SireMol
{
    ...
    */
    ...
    public:
        ...
        virtual QList<ChainIdx> map(const MoleculeView &molview, const PropertyMap &map = PropertyMap()) const;

        virtual Chain selectFrom(const MoleculeView &molview, const PropertyMap &map = PropertyMap()) const;

        virtual Selector<Chain> selectAllFrom(const MoleculeView &molview, const PropertyMap &map = PropertyMap()) const;

        virtual Chain selectFrom(const Molecules &molecules, const PropertyMap &map = PropertyMap()) const;

        virtual QHash<MolNum, Selector<Chain>> selectAllFrom(const Molecules &molecules,
                                                             const PropertyMap &map = PropertyMap()) const;

        virtual Chain selectFrom(const MoleculeGroup &molgroup, const PropertyMap &map = PropertyMap()) const;

        virtual QHash<MolNum, Selector<Chain>> selectAllFrom(const MoleculeGroup &molgroup,
                                                             const PropertyMap &map = PropertyMap()) const;

        virtual Chain selectFrom(const MolGroupsBase &molgroups, const PropertyMap &map = PropertyMap()) const;
        virtual QHash<MolNum, Selector<Chain>> selectAllFrom(const MolGroupsBase &molgroups,
                                                             const PropertyMap &map = PropertyMap()) const;

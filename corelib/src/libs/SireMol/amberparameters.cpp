...
QDataStream &operator<<(QDataStream &ds, const AmberParameters &amberparam)
{
    ...
    sds << amberparam.molinfo << amberparam.bonds << amberparam.angles << amberparam.dihedrals << amberparam.impropers
        << amberparam.nb14pairs << static_cast<const MoleculeProperty &>(amberparam);
...
QDataStream &operator>>(QDataStream &ds, AmberParameters &amberparam)
{
    ...
    else if (v == 2)
    {
        ...
        sds >> amberparam.molinfo >> amberparam.bonds >> amberparam.angles >> amberparam.dihedrals >>
...
AmberParameters::AmberParameters(const MoleculeData &molecule)
    : ConcreteProperty<AmberParameters, MoleculeProperty>(), molinfo(molecule.info())
{
}

/** Copy constructor */
AmberParameters::AmberParameters(const AmberParameters &other)
    : ConcreteProperty<AmberParameters, MoleculeProperty>(), molinfo(other.molinfo), bonds(other.bonds),
      angles(other.angles), dihedrals(other.dihedrals), impropers(other.impropers), nb14pairs(other.nb14pairs)
{
}
...
{
    return (molinfo == other.molinfo and bonds == other.bonds and angles == other.angles and
            dihedrals == other.dihedrals and impropers == other.impropers and nb14pairs == other.nb14pairs);
}

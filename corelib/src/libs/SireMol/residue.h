...
namespace SireMol
{
    ...
    */
    ...
    public:
        ...
        SelectorM<Residue> operator+(const SelectorM<Residue> &residues) const;
        SelectorM<Residue> operator+(const Selector<Residue> &residues) const;
        SelectorM<Residue> operator+(const Residue &other) const;
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &Residue::property(const PropertyName &key) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &Residue::metadata(const PropertyName &metakey) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &Residue::metadata(const PropertyName &key, const PropertyName &metakey) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void Residue::setProperty(const QString &key, const T &value)
    {
        MoleculeView::setProperty<ResIdx, ResProperty<T>, T>(*d, key, this->index(), value);
    }
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void Residue::setMetadata(const QString &metakey, const T &value)
    {
        MoleculeView::setMetadata<ResIdx, ResProperty<T>, T>(*d, metakey, this->index(), value);
    }
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void Residue::setMetadata(const QString &key, const QString &metakey, const T &value)
    {
        MoleculeView::setMetadata<ResIdx, ResProperty<T>, T>(*d, key, metakey, this->index(), value);
    }
    ...
    namespace detail
    {
        ...
        template <>
        SIRE_ALWAYS_INLINE QList<ResIdx> getAll<Residue>(const MolInfo &molinfo, const AtomSelection &selected_atoms)
        {
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE QList<V> get_property(Residue *, const MoleculeData &moldata, const QList<Residue::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE QList<V> get_metadata(Residue *, const MoleculeData &moldata, const QList<Residue::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_property(Residue *ptr, MoleculeData &moldata, const QList<Residue::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_metadata(Residue *ptr, MoleculeData &moldata, const QList<Residue::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_property(Residue *, MoleculeData &moldata, const QList<Residue::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_metadata(Residue *, MoleculeData &moldata, const QList<Residue::Index> &idxs,

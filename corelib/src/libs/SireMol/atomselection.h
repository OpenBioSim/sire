...
namespace SireMol
{
    ...
    */
    class SIREMOL_EXPORT AtomSelection : public ConcreteProperty<AtomSelection, MoleculeProperty>
    {
...
SIRE_ALWAYS_INLINE SireMol::AtomSelection operator+(const SireMol::AtomSelection &a, const SireMol::AtomSelection &b)
{

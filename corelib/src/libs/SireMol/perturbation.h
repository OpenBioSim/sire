...
namespace SireMol
{
    ...
    */
    ...
    public:
        ...
        virtual PerturbationPtr recreate(const SireCAS::Expression &mapping_function, const PropertyMap &map) const;

        virtual PerturbationPtr substitute(const Symbol &old_symbol, const Symbol &new_symbol) const;
    ...
    class SIREMOL_EXPORT NullPerturbation : public SireBase::ConcreteProperty<NullPerturbation, Perturbation>
    {
    ...
    /** This class holds a collection of perturbations that can
        ...
        @author Christopher Woods
    */
    class SIREMOL_EXPORT Perturbations : public SireBase::ConcreteProperty<Perturbations, Perturbation>
    {

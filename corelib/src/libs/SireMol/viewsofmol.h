...
namespace SireMol
{
    ...
    */
    class SIREMOL_EXPORT ViewsOfMol : public SireBase::ConcreteProperty<ViewsOfMol, MoleculeView>
    {
    ...
    public:
        ...
        ViewsOfMol(const MoleculeData &moldata, const AtomSelection &selected_atoms);

        ViewsOfMol(const MoleculeData &moldata, const QList<AtomSelection> &views);

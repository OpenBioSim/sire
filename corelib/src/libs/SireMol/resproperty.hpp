...
namespace SireMol
{
    ...
    */
    template <class T>
    class SIREMOL_EXPORT ResProperty : public SireBase::ConcreteProperty<ResProperty<T>, ResProp>
    {
    ...
    /** Null constructor */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ResProperty<T>::ResProperty() : SireBase::ConcreteProperty<ResProperty<T>, ResProp>()
    {
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ResProperty<T>::ResProperty(const MoleculeInfoData &molinfo)
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ResProperty<T>::ResProperty(const QVector<T> &values)
        : SireBase::ConcreteProperty<ResProperty<T>, ResProp>()
    {
        props = values;
        props.squeeze();
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void ResProperty<T>::assertCanConvert(const QVariant &value) const
    {
    ...
    /** Copy constructor */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ResProperty<T>::ResProperty(const ResProperty<T> &other)
        : SireBase::ConcreteProperty<ResProperty<T>, ResProp>(other), props(other.props)
    {
    }

    /** Destructor */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ResProperty<T>::~ResProperty()
    {
    }

    /** Copy assignment operator */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ResProperty<T> &ResProperty<T>::operator=(const ResProperty<T> &other)
    {
    ...
    /** Comparison operator */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE bool ResProperty<T>::operator==(const ResProperty<T> &other) const
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &ResProperty<T>::operator[](int i) const
    {
        return props.constData()[SireID::Index(i).map(props.count())];
    }

    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &ResProperty<T>::at(int i) const
    {
        return this->operator[](i);
    }

    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &ResProperty<T>::get(int i) const
    {
        return this->operator[](i);
    }

    template <class T>
    SIRE_OUTOFLINE_TEMPLATE QList<T> ResProperty<T>::operator[](const QList<qint64> &idxs) const
    {
        QList<T> ret;
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE QList<T> ResProperty<T>::operator[](const SireBase::Slice &slice) const
    {
        QList<T> ret;
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &ResProperty<T>::operator[](const ResIdx &residx) const
    {
        return props.constData()[residx.map(props.count())];
    }

    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const char *ResProperty<T>::typeName()
    {
        return QMetaType::typeName(qMetaTypeId<ResProperty<T>>());
    }

    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ResProperty<T> *ResProperty<T>::clone() const
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const QVector<T> &ResProperty<T>::array() const
    {
        return props;
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE QString ResProperty<T>::toString() const
    {
        if (this->isEmpty())
        {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE bool ResProperty<T>::canConvert(const QVariant &value) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void ResProperty<T>::assignFrom(const ResProperty<QVariant> &variant)
    {
        if (variant.count() == 0)
        {
            props.clear();
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ResProperty<QVariant> ResProperty<T>::toVariant() const
    {
        if (props.isEmpty())
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &ResProperty<T>::at(const ResIdx &residx) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &ResProperty<T>::get(const ResIdx &residx) const
    {
        return this->operator[](residx);
    }
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE QVariant ResProperty<T>::getAsVariant(const ResIdx &residx) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE SireBase::PropertyPtr ResProperty<T>::getAsProperty(const ResIdx &residx) const
    {
    ...
    /** Set the value of the property for the residue at
        index 'residx' */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ResProperty<T> &ResProperty<T>::set(ResIdx residx, const T &value)
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T *ResProperty<T>::data() const
    {
    ...
    /** Return a raw pointer to the array of property values */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T *ResProperty<T>::constData() const
    {
        return props.constData();
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE bool ResProperty<T>::isEmpty() const
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE int ResProperty<T>::size() const
    {
        return props.count();
    }
    ...
    /** Return the number of residues */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE int ResProperty<T>::count() const
    {
        return props.count();
    }
    ...
    /** Return the number of residues */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE int ResProperty<T>::nResidues() const
    {
        return props.count();
    }
    ...
    /** Is this property compatible with the molecule that is represented
        by 'molinfo' */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE bool ResProperty<T>::isCompatibleWith(const MoleculeInfoData &molinfo) const
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE SireBase::PropertyList ResProperty<T>::merge(const MolViewProperty &other,
                                                                         const AtomIdxMapping &mapping,
                                                                         const QString &ghost,
                                                                         const SireBase::PropertyMap &map) const
    {
        if (not other.isA<ResProperty<T>>())
        {
...
template <class T>
SIRE_OUTOFLINE_TEMPLATE QDataStream &operator<<(QDataStream &ds, const SireMol::ResProperty<T> &prop)
{
...
template <class T>
SIRE_OUTOFLINE_TEMPLATE QDataStream &operator>>(QDataStream &ds, SireMol::ResProperty<T> &prop)
{

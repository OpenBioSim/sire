...
namespace SireMol
{
    ...
    typedef ChainProperty<SireBase::PropertyPtr> ChainPropertyProperty;
    ...
    */
    template <class T>
    class SIREMOL_EXPORT ChainProperty : public SireBase::ConcreteProperty<ChainProperty<T>, ChainProp>
    {
    ...
    /** Null constructor */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ChainProperty<T>::ChainProperty() : SireBase::ConcreteProperty<ChainProperty<T>, ChainProp>()
    {
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ChainProperty<T>::ChainProperty(const MoleculeInfoData &molinfo)
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ChainProperty<T>::ChainProperty(const QVector<T> &values)
        : SireBase::ConcreteProperty<ChainProperty<T>, ChainProp>()
    {
        props = values;
        props.squeeze();
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void ChainProperty<T>::assertCanConvert(const QVariant &value) const
    {
    ...
    /** Copy constructor */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ChainProperty<T>::ChainProperty(const ChainProperty<T> &other)
        : SireBase::ConcreteProperty<ChainProperty<T>, ChainProp>(other), props(other.props)
    {
    }

    /** Destructor */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ChainProperty<T>::~ChainProperty()
    {
    }

    /** Copy assignment operator */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ChainProperty<T> &ChainProperty<T>::operator=(const ChainProperty<T> &other)
    {
    ...
    /** Comparison operator */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE bool ChainProperty<T>::operator==(const ChainProperty<T> &other) const
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &ChainProperty<T>::operator[](int i) const
    {
        return props.constData()[SireID::Index(i).map(props.count())];
    }

    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &ChainProperty<T>::at(int i) const
    {
        return this->operator[](i);
    }

    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &ChainProperty<T>::get(int i) const
    {
        return this->operator[](i);
    }

    template <class T>
    SIRE_OUTOFLINE_TEMPLATE QList<T> ChainProperty<T>::operator[](const QList<qint64> &idxs) const
    {
        QList<T> ret;
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE QList<T> ChainProperty<T>::operator[](const SireBase::Slice &slice) const
    {
        QList<T> ret;
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &ChainProperty<T>::operator[](const ChainIdx &chainidx) const
    {
        return props.constData()[chainidx.map(props.count())];
    }

    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const char *ChainProperty<T>::typeName()
    {
        return QMetaType::typeName(qMetaTypeId<ChainProperty<T>>());
    }

    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ChainProperty<T> *ChainProperty<T>::clone() const
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const QVector<T> &ChainProperty<T>::array() const
    {
        return props;
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE QString ChainProperty<T>::toString() const
    {
        if (this->isEmpty())
        {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE bool ChainProperty<T>::canConvert(const QVariant &value) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void ChainProperty<T>::assignFrom(const ChainProperty<QVariant> &variant)
    {
        if (variant.count() == 0)
        {
            props.clear();
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ChainProperty<QVariant> ChainProperty<T>::toVariant() const
    {
        if (props.isEmpty())
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &ChainProperty<T>::at(const ChainIdx &chainidx) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &ChainProperty<T>::get(const ChainIdx &chainidx) const
    {
        return this->operator[](chainidx);
    }
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE QVariant ChainProperty<T>::getAsVariant(const ChainIdx &chainidx) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE SireBase::PropertyPtr ChainProperty<T>::getAsProperty(const ChainIdx &chainidx) const
    {
    ...
    /** Set the value of the property for the chain at
        index 'chainidx' */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE ChainProperty<T> &ChainProperty<T>::set(ChainIdx chainidx, const T &value)
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T *ChainProperty<T>::data() const
    {
    ...
    /** Return a raw pointer to the array of property values */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T *ChainProperty<T>::constData() const
    {
        return props.constData();
    }
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE bool ChainProperty<T>::isEmpty() const
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE int ChainProperty<T>::size() const
    {
        return props.count();
    }
    ...
    /** Return the number of chains */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE int ChainProperty<T>::count() const
    {
        return props.count();
    }
    ...
    /** Return the number of chains */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE int ChainProperty<T>::nChains() const
    {
        return props.count();
    }
    ...
    /** Is this property compatible with the molecule that is represented
        by 'molinfo' */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE bool ChainProperty<T>::isCompatibleWith(const MoleculeInfoData &molinfo) const
    {
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE SireBase::PropertyList ChainProperty<T>::merge(const MolViewProperty &other,
                                                                           const AtomIdxMapping &mapping,
                                                                           const QString &ghost,
                                                                           const SireBase::PropertyMap &map) const
    {
        if (not other.isA<ChainProperty<T>>())
        {
...
template <class T>
SIRE_OUTOFLINE_TEMPLATE QDataStream &operator<<(QDataStream &ds, const SireMol::ChainProperty<T> &prop)
{
...
template <class T>
SIRE_OUTOFLINE_TEMPLATE QDataStream &operator>>(QDataStream &ds, SireMol::ChainProperty<T> &prop)
{
...
Q_DECLARE_METATYPE(SireMol::ChainPropertyProperty);
...
SIRE_EXPOSE_CHAIN_PROPERTY(SireBase::PropertyPtr, SireMol::ChainPropertyProperty)
...
template class SireMol::ChainProperty<SireBase::PropertyPtr>;
#endif

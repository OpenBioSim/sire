...
namespace SireMol
{
    ...
    */
    ...
    protected:
        ...
        template <class T>
        T _pvt_getMetadata(const QString &key, const QString &metakey, const QVariant &value) const;
        ...
        const QVariant &getAtomMetadata(quint32 uid, const QString &metakey) const;
        const QVariant &getResMetadata(quint32 uid, const QString &metakey) const;
        const QVariant &getCGMetadata(quint32 uid, const QString &metakey) const;
        const QVariant &getChainMetadata(quint32 uid, const QString &metakey) const;
        const QVariant &getSegMetadata(quint32 uid, const QString &metakey) const;

        const QVariant &getAtomMetadata(quint32 uid, const QString &key, const QString &metakey) const;
        const QVariant &getResMetadata(quint32 uid, const QString &key, const QString &metakey) const;
        const QVariant &getCGMetadata(quint32 uid, const QString &key, const QString &metakey) const;
        const QVariant &getChainMetadata(quint32 uid, const QString &key, const QString &metakey) const;
        const QVariant &getSegMetadata(quint32 uid, const QString &key, const QString &metakey) const;
        ...
        template <class T>
        void _pvt_createSpaceForMetadata(const QString &key, const QString &metakey);

        void _pvt_setAtomProperty(quint32 uid, const QString &key, const QVariant &value);

        void _pvt_setAtomMetadata(quint32 uid, const QString &metakey, const QVariant &value);

        void _pvt_setAtomMetadata(quint32 uid, const QString &key, const QString &metakey, const QVariant &value);

        void _pvt_setResProperty(quint32 uid, const QString &key, const QVariant &value);

        void _pvt_setResMetadata(quint32 uid, const QString &metakey, const QVariant &value);

        void _pvt_setResMetadata(quint32 uid, const QString &key, const QString &metakey, const QVariant &value);

        void _pvt_setCGProperty(quint32 uid, const QString &key, const QVariant &value);

        void _pvt_setCGMetadata(quint32 uid, const QString &metakey, const QVariant &value);

        void _pvt_setCGMetadata(quint32 uid, const QString &key, const QString &metakey, const QVariant &value);

        void _pvt_setChainProperty(quint32 uid, const QString &key, const QVariant &value);

        void _pvt_setChainMetadata(quint32 uid, const QString &metakey, const QVariant &value);

        void _pvt_setChainMetadata(quint32 uid, const QString &key, const QString &metakey, const QVariant &value);

        void _pvt_setSegProperty(quint32 uid, const QString &key, const QVariant &value);

        void _pvt_setSegMetadata(quint32 uid, const QString &metakey, const QVariant &value);

        void _pvt_setSegMetadata(quint32 uid, const QString &key, const QString &metakey, const QVariant &value);
    ...
    private:
        ...
        static void _pvt_invalidPropertyCast(const QString &key, const QString &current_type, const QString &required_type);

        static void _pvt_invalidMetadataCast(const QString &metakey, const QString &current_type,
                                             const QString &required_type);

        static void _pvt_invalidMetadataCast(const QString &key, const QString &metakey, const QString &current_type,
                                             const QString &required_type);
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE T StructureEditor::_pvt_getProperty(const QString &key, const QVariant &value) const
    {
        if (value.isValid())
        {
            if (not value.canConvert<T>())
                StructureEditor::_pvt_invalidPropertyCast(key, value.typeName(), T::typeName());
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE T StructureEditor::_pvt_getMetadata(const QString &metakey, const QVariant &value) const
    {
        if (value.isValid())
        {
            if (not value.canConvert<T>())
                StructureEditor::_pvt_invalidMetadataCast(metakey, value.typeName(), T::typeName());
    ...
    /** Protected template function used by the metadata() functions */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE T StructureEditor::_pvt_getMetadata(const QString &key, const QString &metakey,
                                                                const QVariant &value) const
    {
        if (value.isValid())
        {
            if (not value.canConvert<T>())
                StructureEditor::_pvt_invalidMetadataCast(key, metakey, value.typeName(), T::typeName());
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void StructureEditor::_pvt_createSpaceForProperty(const QString &key)
    {
        ...
        if (it != props.constEnd())
        {
            ...
            if (dynamic_cast<const T *>(it->constData()) == 0)
                StructureEditor::_pvt_invalidPropertyCast(key, it.value()->what(), T::typeName());
        }
        else
    ...
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void StructureEditor::_pvt_createSpaceForMetadata(const QString &metakey)
    {
        Properties &props = this->_pvt_properties();
        ...
        if (props.hasMetadata(metakey))
        {
            ...
            if (dynamic_cast<const T *>(&metadata) == 0)
                StructureEditor::_pvt_invalidMetadataCast(metakey, metadata.what(), T::typeName());
        }
        else
    ...
    /** Protected template function used by the setMetadata functions */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void StructureEditor::_pvt_createSpaceForMetadata(const QString &key, const QString &metakey)
    {
        Properties &props = this->_pvt_properties();
        ...
        if (props.hasMetadata(key, metakey))
        {
            ...
            // it is of the correct type!
            if (dynamic_cast<const T *>(&metadata) == 0)
                StructureEditor::_pvt_invalidMetadataCast(key, metakey, metadata.what(), T::typeName());
        }
        else
            // create some metadata of this type as a placeholder
            //(necessary for casting reasons)

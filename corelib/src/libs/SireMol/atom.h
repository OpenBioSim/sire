...
namespace SireMol
{
    ...
    */
    ...
    public:
        ...
        SelectorM<Atom> operator+(const Atom &other) const;
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &Atom::property(const PropertyName &key) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &Atom::metadata(const PropertyName &metakey) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &Atom::metadata(const PropertyName &key, const PropertyName &metakey) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void Atom::setProperty(const QString &key, const T &value)
    {
        MoleculeView::setProperty<CGAtomIdx, AtomProperty<T>, T>(*d, key, this->cgAtomIdx(), value);
    }

    /** Set the metadata at metakey 'metakey' for this atom */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void Atom::setMetadata(const QString &metakey, const T &value)
    {
        MoleculeView::setMetadata<CGAtomIdx, AtomProperty<T>, T>(*d, metakey, this->cgAtomIdx(), value);
    }

    /** Set the metadata at metakey 'metakey' for the property at
        key 'key' for this atom */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void Atom::setMetadata(const QString &key, const QString &metakey, const T &value)
    {
        MoleculeView::setMetadata<CGAtomIdx, AtomProperty<T>, T>(*d, key, metakey, this->cgAtomIdx(), value);
    }
    ...
    namespace detail
    {
        ...
        template <>
        SIRE_ALWAYS_INLINE QList<AtomIdx> getAll<Atom>(const MolInfo &molinfo, const AtomSelection &selected_atoms)
        {
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE QList<V> get_property(Atom *, const MoleculeData &moldata, const QList<Atom::Index> &idxs,
                                                      const PropertyName &key)
        {
            ...
            for (QList<Atom::Index>::const_iterator it = idxs.constBegin(); it != idxs.constEnd(); ++it)
            {
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE QList<V> get_metadata(Atom *, const MoleculeData &moldata, const QList<Atom::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_property(Atom *ptr, MoleculeData &moldata, const QList<Atom::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_metadata(Atom *ptr, MoleculeData &moldata, const QList<Atom::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_property(Atom *, MoleculeData &moldata, const QList<Atom::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_metadata(Atom *, MoleculeData &moldata, const QList<Atom::Index> &idxs,

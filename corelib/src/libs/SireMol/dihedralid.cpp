...
QDataStream &operator<<(QDataStream &ds, const DihedralID &dihedralid)
{
    writeHeader(ds, r_dihedralid, 1);

    SharedDataStream sds(ds);

    sds << dihedralid.atm0 << dihedralid.atm1 << dihedralid.atm2 << dihedralid.atm3;

    return ds;
}

/** Extract from a binary datastream */
QDataStream &operator>>(QDataStream &ds, DihedralID &dihedralid)
{
...
/** Construct a dihedral between the two specified atoms. The order
    ...
    molecules */
DihedralID::DihedralID(const AtomID &atom0, const AtomID &atom1, const AtomID &atom2, const AtomID &atom3)
...
*/
tuple<AtomIdx, AtomIdx, AtomIdx, AtomIdx> DihedralID::map(const MoleculeInfoData &molinfo) const
{
...
/** Return the indicies of the four atoms of this dihedral, between the
    ...
    \throw SireError::invalid_index
*/
tuple<AtomIdx, AtomIdx, AtomIdx, AtomIdx> DihedralID::map(const MoleculeInfoData &mol0info,
...
/** Return the geometric torsion formed by the four atoms
    ...
    \throw SireError::invalid_index
*/
Torsion DihedralID::torsion(const MoleculeData &moldata, const PropertyMap &map) const
{
...
/** Return the geometric torsion formed by the four atoms,
    ...
    \throw SireError::invalid_index
*/
Torsion DihedralID::torsion(const MoleculeData &mol0data, const PropertyMap &map0, const MoleculeData &mol1data,
...
/** Return the geometric torsion formed by the four atoms,
    ...
    \throw SireError::invalid_index
*/
Torsion DihedralID::torsion(const MoleculeData &mol0data, const MoleculeData &mol1data, const MoleculeData &mol2data,
...
/** Return the size of this dihedral in the molecule whose data
    ...
    \throw SireError::invalid_index
*/
Angle DihedralID::size(const MoleculeData &moldata, const PropertyMap &map) const
{
...
/** Return the size of the dihedral between atom0() in the
    ...
    \throw SireError::invalid_index
*/
Angle DihedralID::size(const MoleculeData &mol0data, const PropertyMap &map0, const MoleculeData &mol1data,
                       const PropertyMap &map1, const MoleculeData &mol2data, const PropertyMap &map2,
                       const MoleculeData &mol3data, const PropertyMap &map3) const
{
    return this->torsion(mol0data, map0, mol1data, map1, mol2data, map2, mol3data, map3).angle();
}
...
/** Return the size of the dihedral between atom0() in the
    ...
    \throw SireError::invalid_index
*/
Angle DihedralID::size(const MoleculeData &mol0data, const MoleculeData &mol1data, const MoleculeData &mol2data,
                       const MoleculeData &mol3data, const PropertyMap &map) const
{
    return this->torsion(mol0data, mol1data, mol2data, mol3data, map).angle();
}

...
namespace SireMol
{
    ...
    */
    ...
    public:
        ...
        Bead();
        Bead(const MoleculeData &moldata, const BeadIdx &bead, const PropertyMap &map = PropertyMap());
    ...
    protected:
        ...
        friend class Beads;
        Bead(const MoleculeData &moldata, BeadIdx beadidx, const Beading &beading, const PropertyName &beading_property);
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &Bead::property(const PropertyName &key) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &Bead::metadata(const PropertyName &metakey) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &Bead::metadata(const PropertyName &key, const PropertyName &metakey) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void Bead::setProperty(const QString &key, const T &value)
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void Bead::setMetadata(const QString &metakey, const T &value)
    {
        BeadProperty<T> props;
        MoleculeData &data = *d;
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void Bead::setMetadata(const QString &key, const QString &metakey, const T &value)
    {
        BeadProperty<T> props;
        MoleculeData &data = *d;
    ...
    namespace detail
    {
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE QList<V> get_property(Bead *, const MoleculeData &moldata, const QList<Bead::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE QList<V> get_metadata(Bead *, const MoleculeData &moldata, const QList<Bead::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_property(Bead *ptr, MoleculeData &moldata, const QList<Bead::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_metadata(Bead *ptr, MoleculeData &moldata, const QList<Bead::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_property(Bead *, MoleculeData &moldata, const QList<Bead::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_metadata(Bead *, MoleculeData &moldata, const QList<Bead::Index> &idxs,
        ...
        SIREMOL_EXPORT bool has_property(const Bead *, const MoleculeData &moldata, const PropertyName &key);

        SIREMOL_EXPORT bool has_metadata(const Bead *, const MoleculeData &moldata, const PropertyName &metakey);

        SIREMOL_EXPORT bool has_metadata(const Bead *, const MoleculeData &moldata, const PropertyName &key,
                                         const PropertyName &metakey);

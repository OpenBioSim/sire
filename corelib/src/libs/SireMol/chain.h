...
namespace SireMol
{
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &Chain::property(const PropertyName &key) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &Chain::metadata(const PropertyName &key) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &Chain::metadata(const PropertyName &key, const PropertyName &metakey) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void Chain::setProperty(const QString &key, const T &value)
    {
        MoleculeView::setProperty<ChainIdx, ChainProperty<T>, T>(*d, key, this->index(), value);
    }
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void Chain::setMetadata(const QString &metakey, const T &value)
    {
        MoleculeView::setMetadata<ChainIdx, ChainProperty<T>, T>(*d, metakey, this->index(), value);
    }
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void Chain::setMetadata(const QString &key, const QString &metakey, const T &value)
    {
        MoleculeView::setMetadata<ChainIdx, ChainProperty<T>, T>(*d, key, metakey, this->index(), value);
    }
    ...
    namespace detail
    {
        ...
        template <>
        SIRE_ALWAYS_INLINE QList<ChainIdx> getAll<Chain>(const MolInfo &molinfo, const AtomSelection &selected_atoms)
        {
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE QList<V> get_property(Chain *, const MoleculeData &moldata, const QList<Chain::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE QList<V> get_metadata(Chain *, const MoleculeData &moldata, const QList<Chain::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_property(Chain *ptr, MoleculeData &moldata, const QList<Chain::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_metadata(Chain *ptr, MoleculeData &moldata, const QList<Chain::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_property(Chain *, MoleculeData &moldata, const QList<Chain::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_metadata(Chain *, MoleculeData &moldata, const QList<Chain::Index> &idxs,

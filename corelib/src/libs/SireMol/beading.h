...
namespace SireMol
{
    ...
    */
    ...
    protected:
        ...
        virtual BeadNum beadNum(const MoleculeInfoData &moldata, const BeadIdx &bead) const;

        virtual AtomIdx atomIdx(const MoleculeInfoData &moldata, const BeadIdx &bead, int i) const = 0;
        ...
        virtual AtomSelection selection(const MoleculeInfoData &moldata, const BeadIdx &bead) const = 0;

        virtual QList<AtomIdx> atomIdxs(const MoleculeInfoData &moldata) const = 0;
        virtual QList<AtomIdx> atomIdxs(const MoleculeInfoData &moldata, const BeadIdx &bead) const = 0;
    ...
    /** MoleculeBeading is used to create a single bead that contains
        ...
        @author Christopher Woods
    */
    class SIREMOL_EXPORT MoleculeBeading : public SireBase::ConcreteProperty<MoleculeBeading, Beading>
    {
    ...
    protected:
        ...
        AtomIdx atomIdx(const MoleculeInfoData &moldata, const BeadIdx &bead, int i) const;

        SireBase::PropertyPtr atomProperty(const MoleculeData &moldata, const SireBase::PropertyName &key) const;

        AtomSelection selection(const MoleculeInfoData &moldata) const;

        AtomSelection selection(const MoleculeInfoData &moldata, const BeadIdx &bead) const;

        QList<AtomIdx> atomIdxs(const MoleculeInfoData &moldata) const;
        QList<AtomIdx> atomIdxs(const MoleculeInfoData &moldata, const BeadIdx &bead) const;
    };
    ...
    /** This is a beading function that breaks a molecule into beads
        ...
        @author Christopher Woods
    */
    class SIREMOL_EXPORT ResidueBeading : public SireBase::ConcreteProperty<ResidueBeading, Beading>
    {
    ...
    protected:
        ...
        BeadNum beadNum(const MoleculeInfoData &moldata, const BeadIdx &bead) const;
    ...
    /** This is a beading function that divides a molecule into
        ...
        @author Christopher Woods
    */
    class SIREMOL_EXPORT UserBeading : public SireBase::ConcreteProperty<UserBeading, Beading>
    {
    ...
    class SIREMOL_EXPORT NullBeading : public SireBase::ConcreteProperty<NullBeading, Beading>
    {

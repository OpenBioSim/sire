...
SIREMOL_EXPORT QDataStream &operator<<(QDataStream &, const SireMol::MoleculeData &);
SIREMOL_EXPORT QDataStream &operator>>(QDataStream &, SireMol::MoleculeData &);
...
namespace SireMol
{
    ...
    */
    ...
    public:
        ...
        MoleculeData(const QString &molname, const MoleculeInfo &molinfo);
    ...
    /** Return whether or not this molecule has a property called 'key'
        that is of type 'T' */
    template <class T>
    SIRE_INLINE_TEMPLATE bool MoleculeData::hasPropertyOfType(const PropertyName &key) const
    {
    ...
    template <class T>
    SIRE_INLINE_TEMPLATE bool MoleculeData::hasMetadataOfType(const PropertyName &metakey) const
    {
    ...
    */
    template <class T>
    SIRE_INLINE_TEMPLATE bool MoleculeData::hasMetadataOfType(const PropertyName &key, const PropertyName &metakey) const
    {

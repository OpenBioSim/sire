...
namespace SireMol
{
    ...
    */
    ...
    public:
        ...
        VolumeMap(const Length &grid_spacing, FillType fill_type, MapType map_type, bool skip_light_atoms = false);
        ...
        void add(const MoleculeView &mol0, const MoleculeView &mol1, const PropertyMap &map = PropertyMap());
        ...
        void add(const Molecules &mols0, const Molecules &mols1, const PropertyMap &map = PropertyMap());
        ...
        void add(const MoleculeGroup &mols0, const MoleculeGroup &mols1, const PropertyMap &map = PropertyMap());
        ...
        void setMaskWithinDistance(Length dist, const Vector &point, bool clear_points = true);

        void setMaskWithinDistance(Length dist, const MoleculeView &molecule, const PropertyMap &map = PropertyMap());

        void setMaskWithinDistance(Length dist, const MoleculeView &molecule, bool clear_points,

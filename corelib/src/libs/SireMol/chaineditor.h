...
namespace SireMol
{
    ...
    */
    class SIREMOL_EXPORT ChainEditor : public SireBase::ConcreteProperty<ChainEditor, Editor<ChainEditor, Chain>>
    {
    ...
    */
    ...
    public:
        ...
        template <class T>
        ChainStructureEditor &setMetadata(const QString &key, const QString &metakey, const T &value);
    ...
    */
    template <class T>
    T ChainStructureEditor::metadata(const QString &key, const QString &metakey) const
    {
    ...
    */
    template <class T>
    ChainStructureEditor &ChainStructureEditor::setProperty(const QString &key, const T &value)
    {
    ...
    */
    template <class T>
    ChainStructureEditor &ChainStructureEditor::setMetadata(const QString &metakey, const T &value)
    {
        this->assertValidChain(uid);
    ...
    */
    template <class T>
    ChainStructureEditor &ChainStructureEditor::setMetadata(const QString &key, const QString &metakey, const T &value)
    {
        this->assertValidChain(uid);
...
SIRE_EXPOSE_ALIAS((SireMol::Editor<SireMol::ChainEditor, SireMol::Chain>), SireMol::ChainEditorBase)

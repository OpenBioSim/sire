...
namespace SireMol
{
    ...
    */
    ...
    public:
        ...
        parse_error(QString err, QString place = QString()) : siremol_error(err, place)
        {
        }
    ...
    namespace parser
    {
        ...
        */
        ...
        public:
            ...
            virtual bool matches(const MoleculeView &molecule, const PropertyMap &map) const;

            virtual bool matchesAll(const MoleculeView &molecule, const PropertyMap &map) const;

            SelectResult operator()(const SelectResult &result, const PropertyMap &map = PropertyMap()) const;

            SelectResult operator()(const MolGroupsBase &molgroups, const PropertyMap &map = PropertyMap()) const;

            SelectResult operator()(const MoleculeGroup &molgroup, const PropertyMap &map = PropertyMap()) const;

            SelectResult operator()(const Molecules &molecules, const PropertyMap &map = PropertyMap()) const;

            SelectResult operator()(const MoleculeView &molecule, const PropertyMap &map = PropertyMap()) const;
    ...
    */
    ...
    /** This class holds the result of a Select
        ...
        @author Christopher Woods
    */
    class SIREMOL_EXPORT SelectResult : public SireBase::ConcreteProperty<SelectResult, SireBase::Property>
    {
    ...
    /** This class provides a simple "move" interface to move all
        ...
        @author Christopher Woods
    */
    class SIREMOL_EXPORT SelectResultMover : public SireBase::ConcreteProperty<SelectResultMover, SireBase::Property>
    {
    public:
        SelectResultMover();

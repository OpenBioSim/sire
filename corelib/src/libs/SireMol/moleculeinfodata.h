...
namespace SireMol
{
    ...
    */
    ...
    public:
        ...
        MoleculeInfoData(const QString &resname, qint64 resnum,
        ...
        MoleculeInfoData renumber(const QHash<AtomNum, AtomNum> &atomnums, const QHash<ResNum, ResNum> &resnums) const;
        ...
        QList<AtomIdx> getAtomsIn(const ResID &resid, const AtomName &atomname) const;

        QList<AtomIdx> getAtomsIn(ChainIdx chainidx) const;
        QList<AtomIdx> getAtomsIn(const ChainID &chainid) const;
        QList<AtomIdx> getAtomsIn(ChainIdx chainidx, const AtomName &atomname) const;
        QList<AtomIdx> getAtomsIn(const ChainID &chainid, const AtomName &atomname) const;
    ...
    private:
        ...
        QList<AtomIdx> _pvt_getAtomsIn(const QList<ResIdx> &residxs, const AtomName &name) const;

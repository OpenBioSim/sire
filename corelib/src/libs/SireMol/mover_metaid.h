...
SIRE_EXPOSE_ALIAS(SireMol::Mover<SireMol::Selector<SireMol::Segment>>, SireMol::Mover_Selector_Segment_)

SIRE_EXPOSE_ALIAS(SireMol::Mover<SireMol::Selector<SireMol::Residue>>, SireMol::Mover_Selector_Residue_)

SIRE_EXPOSE_ALIAS(SireMol::Mover<SireMol::Selector<SireMol::CutGroup>>, SireMol::Mover_Selector_CutGroup_)

SIRE_EXPOSE_ALIAS(SireMol::Mover<SireMol::Selector<SireMol::Chain>>, SireMol::Mover_Selector_Chain_)

SIRE_EXPOSE_ALIAS(SireMol::Mover<SireMol::Selector<SireMol::Atom>>, SireMol::Mover_Selector_Atom_)

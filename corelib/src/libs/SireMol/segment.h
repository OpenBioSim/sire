...
namespace SireMol
{
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &Segment::property(const PropertyName &key) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &Segment::metadata(const PropertyName &metakey) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE const T &Segment::metadata(const PropertyName &key, const PropertyName &metakey) const
    {
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void Segment::setProperty(const QString &key, const T &value)
    {
        MoleculeView::setProperty<SegIdx, SegProperty<T>, T>(*d, key, this->index(), value);
    }
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void Segment::setMetadata(const QString &metakey, const T &value)
    {
        MoleculeView::setMetadata<SegIdx, SegProperty<T>, T>(*d, metakey, this->index(), value);
    }
    ...
    */
    template <class T>
    SIRE_OUTOFLINE_TEMPLATE void Segment::setMetadata(const QString &key, const QString &metakey, const T &value)
    {
        MoleculeView::setMetadata<SegIdx, SegProperty<T>, T>(*d, key, metakey, this->index(), value);
    }
    ...
    namespace detail
    {
        ...
        template <>
        SIRE_ALWAYS_INLINE QList<SegIdx> getAll<Segment>(const MolInfo &molinfo, const AtomSelection &selected_atoms)
        {
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE QList<V> get_property(Segment *, const MoleculeData &moldata, const QList<Segment::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE QList<V> get_metadata(Segment *, const MoleculeData &moldata, const QList<Segment::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_property(Segment *ptr, MoleculeData &moldata, const QList<Segment::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_metadata(Segment *ptr, MoleculeData &moldata, const QList<Segment::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_property(Segment *, MoleculeData &moldata, const QList<Segment::Index> &idxs,
        ...
        template <class V>
        SIRE_OUTOFLINE_TEMPLATE void set_metadata(Segment *, MoleculeData &moldata, const QList<Segment::Index> &idxs,

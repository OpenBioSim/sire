...
double ArcCos::evaluate(const Values &values) const
{
    ...
    if (not val.isReal())
        throw SireMaths::domain_error(
            QObject::tr("arccos(%1) is complex (%2): %3").arg(x().evaluate(values)).arg(val.toString(), toString()),
            CODELOC);
...
double ArcSin::evaluate(const Values &values) const
{
    ...
    if (not val.isReal())
        throw SireMaths::domain_error(
            QObject::tr("arcsin(%1) is complex (%2): %3").arg(x().evaluate(values)).arg(val.toString(), toString()),
            CODELOC);
...
double ArcCsc::evaluate(const Values &values) const
{
    ...
    if (not val.isReal())
        throw SireMaths::domain_error(
            QObject::tr("arccsc(%1) is complex (%2): %3").arg(x().evaluate(values)).arg(val.toString(), toString()),
            CODELOC);
...
double ArcSec::evaluate(const Values &values) const
{
    ...
    if (not val.isReal())
        throw SireMaths::domain_error(
            QObject::tr("arcsec(%1) is complex (%2): %3").arg(x().evaluate(values)).arg(val.toString(), toString()),
            CODELOC);

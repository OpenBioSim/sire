...
namespace SireCAS
{
    ...
    public:
        ...
        sirecas_error(QString err, QString place = QString()) : exception(err, place)
        {
        }
    ...
    public:
        ...
        unavailable_differential(QString err, QString place = QString()) : sirecas_error(err, place)
        {
        }
    ...
    public:
        ...
        unavailable_integral(QString err, QString place = QString()) : sirecas_error(err, place)
        {
        }
    ...
    public:
        ...
        unregistered_expression(QString err, QString place = QString()) : sirecas_error(err, place)
        {
        }
    ...
    public:
        ...
        invalid_symbol(QString err, QString place = QString()) : sirecas_error(err, place)
        {
        }
    ...
    public:
        ...
        missing_symbol(QString err, QString place = QString()) : sirecas_error(err, place)
        {
        }
    ...
    public:
        ...
        rearrangement_error(QString err, QString place = QString()) : sirecas_error(err, place)
        {
        }

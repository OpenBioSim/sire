...
namespace SireCAS
{
    ...
    */
    ...
    public:
        ...
        Function(const QString &name, const Symbol &sym0);
        Function(const QString &name, const Symbol &sym0, const Symbol &sym1);
        Function(const QString &name, const Symbol &sym0, const Symbol &sym1, const Symbol &sym2);
        Function(const QString &name, const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3);
        Function(const QString &name, const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3,
                 const Symbol &sym4);
        Function(const QString &name, const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3,
        ...
        Function operator()(const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3) const;
        Function operator()(const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3,

...
static const RegisterMetaType<FunctionPvt> r_functionpvt(MAGIC_ONLY, NO_ROOT, "SireCAS::FunctionPvt");

/** Serialise to a binary datastream */
QDataStream &operator<<(QDataStream &ds, const FunctionPvt &f)
{
    writeHeader(ds, r_functionpvt, 1) << f.sig << f.syms << f.funcs;
...
/** Copy constructor */
FunctionPvt::FunctionPvt(const FunctionPvt &other) : sig(other.sig), syms(other.syms), funcs(other.funcs)
{
}
...
QString FunctionPvt::toString() const
{
    ...
    else
    {
        ...
        int i = 0;
        for (QHash<Symbol, int>::const_iterator it = syms.begin(); it != syms.end(); ++it)
        {
            if (i == 0)
...
/** Construct a function called 'f' that is a function of the passed
    symbols */
Function::Function(const QString &f, const Symbols &symbols) : Symbol(), d(f)
{
...
/** Construct a function called 'f' that is a function of the passed
    symbols */
Function::Function(const QString &f, const Symbol &sym0) : Symbol(), d(f)
{
...
/** Construct a function called 'f' that is a function of the passed
    symbols */
Function::Function(const QString &f, const Symbol &sym0, const Symbol &sym1) : Symbol(), d(f)
{
...
/** Construct a function called 'f' that is a function of the passed
    symbols */
Function::Function(const QString &f, const Symbol &sym0, const Symbol &sym1, const Symbol &sym2) : Symbol(), d(f)
{
...
/** Construct a function called 'f' that is a function of the passed
    symbols */
Function::Function(const QString &f, const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3)
    : Symbol(), d(f)
{
    *this = this->operator()(sym0, sym1, sym2, sym3);
}
...
Function::Function(const QString &f, const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3,
    ...
    : Symbol(), d(f)
{
    *this = this->operator()(sym0, sym1, sym2, sym3, sym4);
}

/** Construct a function called 'f' that is a function of the passed
    symbols */
Function::Function(const QString &f, const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3,
                   const Symbol &sym4, const Symbol &sym5)
    : Symbol(), d(f)
{
    *this = this->operator()(sym0, sym1, sym2, sym3, sym4, sym5);
}

/** Construct a function called 'f' that is a function of the passed
    symbols */
Function::Function(const QString &f, const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3,
                   const Symbol &sym4, const Symbol &sym5, const Symbol &sym6)
    : Symbol(), d(f)
{
    *this = this->operator()(sym0, sym1, sym2, sym3, sym4, sym5, sym6);
}

/** Construct a function called 'f' that is a function of the passed
    symbols */
Function::Function(const QString &f, const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3,
                   const Symbol &sym4, const Symbol &sym5, const Symbol &sym6, const Symbol &sym7)
    : Symbol(), d(f)
{
    *this = this->operator()(sym0, sym1, sym2, sym3, sym4, sym5, sym6, sym7);
}

/** Construct a function called 'f' that is a function of the passed
    symbols */
Function::Function(const QString &f, const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3,
                   const Symbol &sym4, const Symbol &sym5, const Symbol &sym6, const Symbol &sym7, const Symbol &sym8)
    : Symbol(), d(f)
{
    *this = this->operator()(sym0, sym1, sym2, sym3, sym4, sym5, sym6, sym7, sym8);
}
...
Function::Function(const QString &f, const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3,
    ...
    : Symbol(), d(f)
{
    *this = this->operator()(sym0, sym1, sym2, sym3, sym4, sym5, sym6, sym7, sym8, sym9);
}

/** Construct a new function from the data contained in the FunctionPvt object */
Function::Function(const FunctionPvt &data) : Symbol(data.toString()), d(data)
{
}

/** Copy constructor */
Function::Function(const Function &other) : Symbol(other), d(other.d)
{
}
...
bool Function::isFunction(const Symbol &symbol) const
{
    ...
    else if (symbol.isA<Function>())
    {
        ...
        for (QSet<Function>::const_iterator it = d.functions().begin(); it != d.functions().end(); ++it)
        {
...
Expression Function::match(const Function &func, const Expression &ex) const
{
    ...
    else
    {
        ...
        for (QHash<Symbol, int>::const_iterator it = fdata.symbols().begin(); it != fdata.symbols().end(); ++it)
        {
...
Symbols Function::symbols() const
{
    ...
    for (QHash<Symbol, int>::const_iterator it = d.symbols().begin(); it != d.symbols().end(); ++it)
    {
        syms.insert(it.key());
    }
...
/** Return this Function as a function of the passed symbols */
Function Function::operator()(const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3) const
{
    FunctionPvt newdata(d);
...
/** Return this Function as a function of the passed symbols */
Function Function::operator()(const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3,
                              const Symbol &sym4) const
{
    FunctionPvt newdata(d);
...
/** Return this Function as a function of the passed symbols */
Function Function::operator()(const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3,
                              const Symbol &sym4, const Symbol &sym5) const
{
    FunctionPvt newdata(d);
...
/** Return this Function as a function of the passed symbols */
Function Function::operator()(const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3,
                              const Symbol &sym4, const Symbol &sym5, const Symbol &sym6) const
{
    FunctionPvt newdata(d);
...
/** Return this Function as a function of the passed symbols */
Function Function::operator()(const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3,
                              const Symbol &sym4, const Symbol &sym5, const Symbol &sym6, const Symbol &sym7) const
{
    FunctionPvt newdata(d);
...
Function Function::operator()(const Symbol &sym0, const Symbol &sym1, const Symbol &sym2, const Symbol &sym3,
                              const Symbol &sym4, const Symbol &sym5, const Symbol &sym6, const Symbol &sym7,
                              const Symbol &sym8, const Symbol &sym9) const
{
    FunctionPvt newdata(d);

...
namespace SireCAS
{
    ...
    */
    ...
    public:
        ...
        ComplexValues(const SymbolComplex &symval0, const SymbolComplex &symval1, const SymbolComplex &symval2);
        ComplexValues(const SymbolComplex &symval0, const SymbolComplex &symval1, const SymbolComplex &symval2,
                      const SymbolComplex &symval3);
        ComplexValues(const SymbolComplex &symval0, const SymbolComplex &symval1, const SymbolComplex &symval2,
                      const SymbolComplex &symval3, const SymbolComplex &symval4);
        ComplexValues(const SymbolComplex &symval0, const SymbolComplex &symval1, const SymbolComplex &symval2,
                      const SymbolComplex &symval3, const SymbolComplex &symval4, const SymbolComplex &symval5);
        ComplexValues(const SymbolComplex &symval0, const SymbolComplex &symval1, const SymbolComplex &symval2,
                      const SymbolComplex &symval3, const SymbolComplex &symval4, const SymbolComplex &symval5,
        ...
        ComplexValues(const SymbolComplex &symval0, const SymbolComplex &symval1, const SymbolComplex &symval2,
                      const SymbolComplex &symval3, const SymbolComplex &symval4, const SymbolComplex &symval5,
                      const SymbolComplex &symval6, const SymbolComplex &symval7, const SymbolComplex &symval8);
        ComplexValues(const SymbolComplex &symval0, const SymbolComplex &symval1, const SymbolComplex &symval2,
                      const SymbolComplex &symval3, const SymbolComplex &symval4, const SymbolComplex &symval5,
                      const SymbolComplex &symval6, const SymbolComplex &symval7, const SymbolComplex &symval8,
                      const SymbolComplex &symval9);
        ...
        void add(const SymbolComplex &symval0, const SymbolComplex &symval1, const SymbolComplex &symval2);
        void add(const SymbolComplex &symval0, const SymbolComplex &symval1, const SymbolComplex &symval2,
                 const SymbolComplex &symval3);
        void add(const SymbolComplex &symval0, const SymbolComplex &symval1, const SymbolComplex &symval2,
                 const SymbolComplex &symval3, const SymbolComplex &symval4);

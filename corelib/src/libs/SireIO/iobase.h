...
namespace SireIO
{
    ...
    */
    ...
    public:
        ...
        Molecule readMolecule(const QString &filename, const PropertyMap &map = PropertyMap()) const;

        Molecule readMolecule(const char *filename, const PropertyMap &map = PropertyMap()) const;

        Molecule readMolecule(QIODevice &dev, const PropertyMap &map = PropertyMap()) const;

        Molecule readMolecule(const QByteArray &data, const PropertyMap &map = PropertyMap()) const;

        MoleculeGroup read(const QString &filename, const PropertyMap &map = PropertyMap()) const;

        MoleculeGroup read(const char *filename, const PropertyMap &map = PropertyMap()) const;

        MoleculeGroup read(QIODevice &dev, const PropertyMap &map = PropertyMap()) const;

        MoleculeGroup read(const QByteArray &data, const PropertyMap &map = PropertyMap()) const;

        void write(const MoleculeGroup &molecules, const QString &filename, const PropertyMap &map = PropertyMap()) const;

        void write(const Molecules &molecules, const QString &filename, const PropertyMap &map = PropertyMap()) const;

        void write(const MoleculeView &molecule, const QString &filename, const PropertyMap &map = PropertyMap()) const;

        void write(const MoleculeGroup &molecules, QIODevice &dev, const PropertyMap &map = PropertyMap()) const;

        void write(const Molecules &molecules, QIODevice &dev, const PropertyMap &map = PropertyMap()) const;

        void write(const MoleculeView &molecule, QIODevice &dev, const PropertyMap &map = PropertyMap()) const;

        QByteArray write(const MoleculeGroup &molecules, const PropertyMap &map = PropertyMap()) const;

        QByteArray write(const Molecules &molecules, const PropertyMap &map = PropertyMap()) const;

        QByteArray write(const MoleculeView &molecule, const PropertyMap &map = PropertyMap()) const;
    ...
    protected:
        ...
        virtual MoleculeGroup readMols(const QByteArray &data, const PropertyMap &map) const = 0;

        /** Write the Molecules to a QByteArray and return it */
        virtual QByteArray writeMols(const MoleculeGroup &molecules, const PropertyMap &map) const = 0;

        /** Write the Molecules to a QByteArray and return it */
        virtual QByteArray writeMols(const Molecules &molecules, const PropertyMap &map) const = 0;
    };

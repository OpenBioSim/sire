...
namespace SireIO
{
    ...
    */
    ...
    public:
        ...
        /** Constructor. */
        Mol2Atom(const SireMol::Atom &atom, const PropertyMap &map, QStringList &errors, bool is_idx = false);
    ...
    */
    ...
    public:
        ...
        Mol2Molecule(const QVector<QString> &lines, QStringList &errors, int &num_records, int imol = -1);

        /** Constructor (from a Sire Molecule). */
        Mol2Molecule(const SireMol::Molecule &mol, const PropertyMap &map, QStringList &errors, int imol = -1);
    ...
    */
    ...
    public:
        ...
        /** Constructor. */
        Mol2Substructure(const SireMol::Residue &res, const PropertyMap &map, QStringList &errors, bool is_idx = false);
    ...
    */
    ...
    public:
        Mol2();
        Mol2(const QString &filename, const PropertyMap &map = PropertyMap());

        Mol2(const QStringList &lines, const PropertyMap &map = PropertyMap());
        Mol2(const SireSystem::System &system, const PropertyMap &map = PropertyMap());

...
namespace SireUnits
{
    ...
    */
    ...
    /** 4 * pi * epsilon_0 */
    const Dimension::GeneralUnit four_pi_eps0(4.0 * SireMaths::pi * epsilon0);
    ...
    const Dimension::GeneralUnit k_boltz = gasr;
    ...
    const Dimension::GeneralUnit G_newton(6.67428e-11 * ((meter * meter * meter) / (kilogram * second * second)));

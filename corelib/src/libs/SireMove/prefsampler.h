...
namespace SireMove
{
    ...
    */
    class SIREMOVE_EXPORT PrefSampler : public SireBase::ConcreteProperty<PrefSampler, Sampler>
    {
    ...
    public:
        ...
        PrefSampler(const Vector &point, const SireCAS::Expression &f, SireUnits::Dimension::Area k);

        PrefSampler(const Vector &point, const MoleculeGroup &molgroup);
        PrefSampler(const Vector &point, const MoleculeGroup &molgroup, SireUnits::Dimension::Area k);
        PrefSampler(const Vector &point, const MoleculeGroup &molgroup, const SireCAS::Expression &f);
        PrefSampler(const Vector &point, const MoleculeGroup &molgroup, const SireCAS::Expression &f,
        ...
        PrefSampler(const MoleculeView &molview, const SireCAS::Expression &f, SireUnits::Dimension::Area k);

        PrefSampler(const MoleculeView &molview, const MoleculeGroup &molgroup);
        PrefSampler(const MoleculeView &molview, const MoleculeGroup &molgroup, SireUnits::Dimension::Area k);
        PrefSampler(const MoleculeView &molview, const MoleculeGroup &molgroup, const SireCAS::Expression &f);
        PrefSampler(const MoleculeView &molview, const MoleculeGroup &molgroup, const SireCAS::Expression &f,
                    SireUnits::Dimension::Area k);

...
namespace SireMove
{
    ...
    */
    class SIREMOVE_EXPORT InternalMoveSingle : public SireBase::ConcreteProperty<InternalMoveSingle, MonteCarlo>
    {
    ...
    public:
        ...
        InternalMoveSingle(const MoleculeGroup &molgroup, const PropertyMap &map = PropertyMap());

        InternalMoveSingle(const Sampler &sampler, const PropertyMap &map = PropertyMap());

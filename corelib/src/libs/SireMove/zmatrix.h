...
namespace SireMove
{
    ...
    */
    ...
    public:
        ZMatrixLine();
        ZMatrixLine(AtomIdx atom, AtomIdx bond, AtomIdx angle, AtomIdx dihedral);
    ...
    */
    ...
    public:
        ...
        ZMatrixCoordsLine(const ZMatrixLine &line, const Length &bond, const Angle &angle, const Angle &dihedral);
    ...
    /** This class holds the z-matrix of a molecule. A z-matrix
        ...
        @author Christopher Woods
    */
    class SIREMOVE_EXPORT ZMatrix : public SireBase::ConcreteProperty<ZMatrix, SireMol::MoleculeProperty>
    {
    ...
    public:
        ...
        int getIndex(const AtomID &atom, const AtomID &bond, const AtomID &angle) const;
        int getIndex(const AtomID &atom, const AtomID &bond, const AtomID &angle, const AtomID &dihedral) const;
        ...
        bool contains(const AtomID &atom, const AtomID &bond, const AtomID &angle) const;
        bool contains(const AtomID &atom, const AtomID &bond, const AtomID &angle, const AtomID &dihedral) const;
        ...
        void add(const AtomID &atom, const AtomID &bond, const AtomID &angle, const AtomID &dihedral);

        void add(const DihedralID &dihedral);

        void remove(const AtomID &atom);
        void remove(const AtomID &atom, const AtomID &bond, const AtomID &angle, const AtomID &dihedral);
        ...
        void setBondDelta(const AtomID &atom, const AtomID &bond, const Length &delta);

        void setAngleDelta(const AtomID &atom, const AtomID &bond, const AtomID &angle, const Angle &delta);

        void setDihedralDelta(const AtomID &atom, const AtomID &bond, const AtomID &angle, const AtomID &dihedral,
                              const Angle &delta);
        ...
        Angle angleDelta(const AtomID &atom, const AtomID &bond, const AtomID &angle) const;
    ...
    /** This class holds a z-matrix of a molecule, together with the
        ...
        @author Christopher Woods
    */
    class SIREMOVE_EXPORT ZMatrixCoords : public SireBase::ConcreteProperty<ZMatrixCoords, SireMol::MoleculeProperty>
    {
    ...
    public:
        ZMatrixCoords();
        ZMatrixCoords(const PartialMolecule &molecule, const PropertyMap &map = PropertyMap());

        ZMatrixCoords(const ZMatrix &zmatrix, const PartialMolecule &molecule, const PropertyMap &map = PropertyMap());
        ...
        void add(const AtomID &atom, const Length &bondlength, const AtomID &bond, const Angle &anglesize,
        ...
        void moveBond(const AtomID &atom0, const AtomID &atom1, const Length &delta);

        void moveAngle(const AtomID &atom0, const AtomID &atom1, const AtomID &atom2, const Angle &delta);

        void moveDihedral(const AtomID &atom0, const AtomID &atom1, const AtomID &atom2, const AtomID &atom3,
                          const Angle &delta);
        ...
        void setBond(const AtomID &atom0, const AtomID &atom1, const Length &length);

        void setAngle(const AtomID &atom0, const AtomID &atom1, const AtomID &atom2, const Angle &size);

        void setDihedral(const AtomID &atom0, const AtomID &atom1, const AtomID &atom2, const AtomID &atom3,
                         const Angle &size);
        ...
        Angle angleSize(const AtomID &atom, const AtomID &bond, const AtomID &angle) const;
        Angle dihedralSize(const AtomID &atom, const AtomID &bond, const AtomID &angle, const AtomID &dihedral) const;

...
namespace SireMove
{
    ...
    */
    class SIREMOVE_EXPORT RigidBodyMC : public SireBase::ConcreteProperty<RigidBodyMC, MonteCarlo>
    {
    ...
    public:
        ...
        RigidBodyMC(const MoleculeGroup &molgroup, const PropertyMap &map = PropertyMap());
        RigidBodyMC(const Sampler &sampler, const PropertyMap &map = PropertyMap());
        ...
        void setReflectionSphere(Vector sphere_center, SireUnits::Dimension::Length sphere_radius);

        bool usesReflectionMoves() const;
        Vector reflectionSphereCenter() const;
        SireUnits::Dimension::Length reflectionSphereRadius() const;

        void setReflectionSphere(MolNum molnum, Vector sphere_center, SireUnits::Dimension::Length sphere_radius);
        ...
        void setReflectionVolume(const QVector<SireMaths::Vector> &points, SireUnits::Dimension::Length radius);

        void setReflectionVolume(const MoleculeView &molecule, SireUnits::Dimension::Length radius, bool heavy_atoms_only,
                                 const PropertyMap &map = PropertyMap());

        void setReflectionVolume(const MoleculeView &molecule, SireUnits::Dimension::Length radius,
                                 const PropertyMap &map = PropertyMap());
    ...
    private:
        void performMove(System &system, double &old_bias, double &new_bias, const SireBase::PropertyMap &map);

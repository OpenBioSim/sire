...
namespace SireMove
{
    ...
    */
    ...
    public:
        ...
        IntegratorWorkspace(const MoleculeGroup &molgroup, const PropertyMap &map = PropertyMap());
    ...
    */
    ...
    public:
        ...
        AtomicVelocityWorkspace(const MoleculeGroup &molgroup, const PropertyMap &map = PropertyMap());

...
namespace SireMove
{
    ...
    */
    class SIREMOVE_EXPORT GibbsMove : public SireBase::ConcreteProperty<GibbsMove, MonteCarlo>
    {
    ...
    public:
        ...
        GibbsMove(const MGIDsAndMaps &group0, const MGIDsAndMaps &group1, const PropertyMap &map = PropertyMap());

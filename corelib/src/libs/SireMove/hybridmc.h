...
namespace SireMove
{
    ...
    */
    ...
    class SIREMOVE_EXPORT HMCGenerator : public SireBase::ConcreteProperty<HMCGenerator, HMCVelGen>
    {
    ...
    */
    ...
    public:
        ...
        HybridMC(const MoleculeGroup &molgroup, const PropertyMap &map = PropertyMap());

        HybridMC(const MoleculeGroup &molgroup, const Integrator &integrator, const PropertyMap &map = PropertyMap());

        HybridMC(const MoleculeGroup &molgroup, SireUnits::Dimension::Time timestep,
                 const PropertyMap &map = PropertyMap());

        HybridMC(const MoleculeGroup &molgroup, const Integrator &integrator, SireUnits::Dimension::Time timestep,
                 const PropertyMap &map = PropertyMap());

        HybridMC(const MoleculeGroup &molgroup, int nsteps, const PropertyMap &map = PropertyMap());

        HybridMC(const MoleculeGroup &molgroup, const Integrator &integrator, int nsteps,
                 const PropertyMap &map = PropertyMap());

        HybridMC(const MoleculeGroup &molgroup, SireUnits::Dimension::Time timestep, int nsteps,
                 const PropertyMap &map = PropertyMap());

        HybridMC(const MoleculeGroup &molgroup, const Integrator &integrator, SireUnits::Dimension::Time timestep,
                 int nsteps, const PropertyMap &map = PropertyMap());

...
namespace SireMove
{
    ...
    */
    ...
    /** This class holds a the list of bonds, angles and dihedrals of a molecule that
        ...
        @author Julien Michel
    */
    class SIREMOVE_EXPORT Flexibility : public SireBase::ConcreteProperty<Flexibility, SireMol::MoleculeProperty>
    {
    ...
    {
        return (dofid.atom0().value() << 24) | ((dofid.atom1().value() << 16) & 0x00FF0000) |
               ((dofid.atom2().value() << 8) & 0x0000FF00) | (dofid.atom3().value() & 0x000000FF);
    }

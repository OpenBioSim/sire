...
SIREMOVE_EXPORT QDataStream &operator<<(QDataStream &, const SireMove::SupraSubMoves &);
SIREMOVE_EXPORT QDataStream &operator>>(QDataStream &, SireMove::SupraSubMoves &);

SIREMOVE_EXPORT QDataStream &operator<<(QDataStream &, const SireMove::SameSupraSubMoves &);
SIREMOVE_EXPORT QDataStream &operator>>(QDataStream &, SireMove::SameSupraSubMoves &);
...
namespace SireMove
{
    ...
    */
    ...
    public:
        ...
        virtual void move(SupraSubSystem &system, int nsubmoves, int nsubmoves_per_block, bool record_substats) = 0;
    ...
    /** This is a simple SupraSubMoves class that just repeats the
        ...
        @author Christopher Woods
    */
    class SIREMOVE_EXPORT SameSupraSubMoves : public SireBase::ConcreteProperty<SameSupraSubMoves, SupraSubMoves>
    {
    ...
    public:
        ...
        void move(SupraSubSystem &system, int nsubmoves, int nsubmoves_per_block, bool record_substats);

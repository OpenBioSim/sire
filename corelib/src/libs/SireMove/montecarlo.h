...
namespace SireMove
{
    ...
    */
    ...
    protected:
        ...
        bool test(double new_energy, double old_energy, double new_bias, double old_bias);

        bool test(double new_energy, double old_energy, int nmolecules, const SireUnits::Dimension::Volume &new_volume,
                  const SireUnits::Dimension::Volume &old_volume);

        bool test(double new_energy, double old_energy, int nmolecules, const SireUnits::Dimension::Volume &new_volume,
                  const SireUnits::Dimension::Volume &old_volume, double new_bias, double old_bias);

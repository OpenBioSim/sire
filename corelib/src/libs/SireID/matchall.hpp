...
namespace SireID
{
    ...
    */
    ...
    /** Null constructor */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE MatchAll<ID>::MatchAll() : ID()
    {
    }

    /** Copy constructor */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE MatchAll<ID>::MatchAll(const MatchAll<ID> &other) : ID(other)
    {
    }

    /** Destructor */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE MatchAll<ID>::~MatchAll()
    {
    }

    /** Copy assignment operator */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE MatchAll<ID> &MatchAll<ID>::operator=(const MatchAll<ID> &other)
    {
        if (&other != this)
        {
            ID::operator=(other);
    ...
    /** Comparison operator */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE bool MatchAll<ID>::operator==(const MatchAll<ID> &other) const
    {
        return true;
    }
    ...
    /** Comparison operator */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE bool MatchAll<ID>::operator==(const SireID::ID &other) const
    {
    ...
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE QString MatchAll<ID>::toString() const
    {
    ...
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE QList<typename ID::Index> MatchAll<ID>::map(const typename ID::SearchObject &obj) const
    {
    ...
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE const char *MatchAll<ID>::typeName()
    {
        return QMetaType::typeName(qMetaTypeId<MatchAll<ID>>());
    }

    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE const char *MatchAll<ID>::what() const
    {
        return MatchAll<ID>::typeName();
    }

    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE MatchAll<ID> *MatchAll<ID>::clone() const
    {
    ...
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE uint MatchAll<ID>::hash() const
    {
        return 1;
    }

    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE bool MatchAll<ID>::isNull() const
    {
        return false;
    }
...
template <class ID>
SIRE_OUTOFLINE_TEMPLATE QDataStream &operator<<(QDataStream &ds, const SireID::MatchAll<ID> &id)
{
    return ds;
}
...
template <class ID>
SIRE_OUTOFLINE_TEMPLATE QDataStream &operator>>(QDataStream &ds, SireID::MatchAll<ID> &id)
{
    return ds;
}

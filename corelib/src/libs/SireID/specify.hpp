...
namespace SireID
{
    ...
    */
    ...
    /** Null constructor */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE Specify<ID>::Specify() : ID()
    {
    }
    ...
    /** Construct using the passed ID and range */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE Specify<ID>::Specify(const ID &idobj, const SireBase::Range &range)
    ...
    /** Copy constructor */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE Specify<ID>::Specify(const Specify<ID> &other) : ID(other), id(other.id), idxs(other.idxs)
    {
    }

    /** Destructor */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE Specify<ID>::~Specify()
    {
    }

    /** Copy assignment operator */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE Specify<ID> &Specify<ID>::operator=(const Specify<ID> &other)
    {
        if (&other != this)
        {
            ID::operator=(other);
    ...
    /** Comparison operator */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE bool Specify<ID>::operator==(const Specify<ID> &other) const
    {
        return idxs == other.idxs and id == other.id;
    }

    /** Comparison operator */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE bool Specify<ID>::operator==(const SireID::ID &other) const
    {
    ...
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE QString Specify<ID>::toString() const
    {
    ...
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE QList<typename ID::Index> Specify<ID>::map(const typename ID::SearchObject &obj) const
    {
    ...
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE const char *Specify<ID>::typeName()
    {
        return QMetaType::typeName(qMetaTypeId<Specify<ID>>());
    }

    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE const char *Specify<ID>::what() const
    {
        return Specify<ID>::typeName();
    }

    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE Specify<ID> *Specify<ID>::clone() const
    {
    ...
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE Specify<ID> Specify<ID>::operator[](qint64 i) const
    {
    ...
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE Specify<ID> Specify<ID>::operator[](const SireBase::Range &range) const
    {
    ...
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE Specify<ID> Specify<ID>::operator()(qint64 start, qint64 end) const
    {
    ...
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE Specify<ID> Specify<ID>::operator()(qint64 start, qint64 end, qint64 increment) const
    {
    ...
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE uint Specify<ID>::hash() const
    {
        return id.hash() + 5;
    }

    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE bool Specify<ID>::isNull() const
    {
        return id.isNull();
    }
...
template <class ID>
SIRE_OUTOFLINE_TEMPLATE QDataStream &operator<<(QDataStream &ds, const SireID::Specify<ID> &id)
{
    ds << id.id << id.idxs;
    return ds;
}
...
template <class ID>
SIRE_OUTOFLINE_TEMPLATE QDataStream &operator>>(QDataStream &ds, SireID::Specify<ID> &id)
{
    ds >> id.id >> id.idxs;
    return ds;
}

...
namespace SireID
{
    ...
    */
    ...
    /** Null constructor */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE InvertMatch<ID>::InvertMatch() : ID()
    {
    }

    /** Construct, using the passed ID */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE InvertMatch<ID>::InvertMatch(const ID &idobj) : ID(), id(idobj)
    {
    }

    /** Copy constructor */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE InvertMatch<ID>::InvertMatch(const InvertMatch<ID> &other) : ID(other), id(other.id)
    {
    }

    /** Destructor */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE InvertMatch<ID>::~InvertMatch()
    {
    }

    /** Copy assignment operator */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE InvertMatch<ID> &InvertMatch<ID>::operator=(const InvertMatch<ID> &other)
    {
        if (&other != this)
        {
            ID::operator=(other);
    ...
    /** Comparison operator */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE bool InvertMatch<ID>::operator==(const InvertMatch<ID> &other) const
    {
        return id == other.id;
    }
    ...
    /** Comparison operator */
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE bool InvertMatch<ID>::operator==(const SireID::ID &other) const
    {
    ...
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE QString InvertMatch<ID>::toString() const
    {
    ...
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE QList<typename ID::Index> InvertMatch<ID>::map(const typename ID::SearchObject &obj) const
    {
    ...
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE const char *InvertMatch<ID>::typeName()
    {
        return QMetaType::typeName(qMetaTypeId<InvertMatch<ID>>());
    }

    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE const char *InvertMatch<ID>::what() const
    {
        return InvertMatch<ID>::typeName();
    }

    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE InvertMatch<ID> *InvertMatch<ID>::clone() const
    {
    ...
    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE uint InvertMatch<ID>::hash() const
    {
        return id.hash() + 1;
    }

    template <class ID>
    SIRE_OUTOFLINE_TEMPLATE bool InvertMatch<ID>::isNull() const
    {
        return id.isNull();
    }
...
template <class ID>
SIRE_OUTOFLINE_TEMPLATE QDataStream &operator<<(QDataStream &ds, const SireID::InvertMatch<ID> &id)
{
    ds << id.id;
    return ds;
}
...
template <class ID>
SIRE_OUTOFLINE_TEMPLATE QDataStream &operator>>(QDataStream &ds, SireID::InvertMatch<ID> &id)
{
    ds >> id.id;
    return ds;
}

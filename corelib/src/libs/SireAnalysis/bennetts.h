...
namespace SireAnalysis
{
    ...
    */
    class SIREANALYSIS_EXPORT BennettsRatios : public SireBase::ConcreteProperty<BennettsRatios, SireBase::Property>
    {
    ...
    public:
        BennettsRatios();
        BennettsRatios(const QList<double> &windows, const QMap<double, BennettsFreeEnergyAverage> &forwards_ratios,
    ...
    */
    ...
    public:
        ...
        Bennetts(const QList<double> &windows, const QMap<double, BennettsFreeEnergyAverage> &forwards_ratios,
                 const QMap<double, BennettsFreeEnergyAverage> &backwards_ratios);
        ...
        void add(const QList<double> &windows, const QMap<double, BennettsFreeEnergyAverage> &forwards_ratios,
                 const QMap<double, BennettsFreeEnergyAverage> &backwards_ratios);
        ...
        void set(int i, const QList<double> &windows, const QMap<double, BennettsFreeEnergyAverage> &forwards_ratios,
                 const QMap<double, BennettsFreeEnergyAverage> &backwards_ratios);

...
namespace SireAnalysis
{
    ...
    */
    class SIREANALYSIS_EXPORT ComponentGradients : public SireBase::ConcreteProperty<ComponentGradients, SireBase::Property>
    {
    ...
    public:
        ComponentGradients();
        ComponentGradients(const QMap<double, FreeEnergyMonitor> &gradients, bool conserve_memory = true);
        ComponentGradients(const QList<FreeEnergyMonitor> &gradients, bool conserve_memory = true);
    ...
    /** This class is used to analyse the free energy components that are
        ...
        @author Christopher Woods
    */
    class SIREANALYSIS_EXPORT TIComponents : public SireBase::ConcreteProperty<TIComponents, SireBase::Property>
    {
    ...
    public:
        ...
        TIComponents(const QMap<double, FreeEnergyMonitor> &gradients, bool conserve_memory = true);
        TIComponents(const ComponentGradients &gradients, bool conserve_memory = true);

...
namespace SireAnalysis
{
    ...
    */
    ...
    public:
        ...
        DataPoint(double x, double y, double xerror, double yerror);
        DataPoint(double x, double y, double xminerror, double yminerror, double xmaxerror, double ymaxerror);
    ...
    */
    ...
    /** This class is used to hold the set of FEP deltas from a single
        ...
        @author Christopher Woods
    */
    class SIREANALYSIS_EXPORT FEPDeltas : public SireBase::ConcreteProperty<FEPDeltas, SireBase::Property>
    {
    ...
    public:
        ...
        FEPDeltas(const QList<double> &windows, const QMap<double, FreeEnergyAverage> &forwards_deltas,
    ...
    */
    ...
    public:
        ...
        FEP(const QList<double> &windows, const QMap<double, FreeEnergyAverage> &forwards_deltas,
            const QMap<double, FreeEnergyAverage> &backwards_deltas);
        ...
        void add(const QList<double> &windows, const QMap<double, FreeEnergyAverage> &deltas);

        void add(const QList<double> &windows, const QMap<double, FreeEnergyAverage> &forwards_deltas,
                 const QMap<double, FreeEnergyAverage> &backwards_deltas);
        ...
        void set(int i, const QList<double> &windows, const QMap<double, FreeEnergyAverage> &deltas);
        void set(int i, const QList<double> &windows, const QMap<double, FreeEnergyAverage> &forwards_deltas,
                 const QMap<double, FreeEnergyAverage> &backwards_deltas);
